 ...
 */
#include "mdc/xh265_recorder_logger.h"
#include <cstring>
#include <fstream>
#include <climits>
#include <sys/stat.h>
...
namespace mdc {
namespace xh265_recorder {

LogConfig Xh265RecorderLogger::logConfig_ = {"Xh265Recorder",
    "xh265_recorder context", "", ara::log::LogLevel::kInfo, ara::log::LogMode::kRemote};
std::map<ara::core::String, ara::core::String> Xh265RecorderLogger::ctxMap_;
std::map<ara::core::String, ara::log::Logger*> Xh265RecorderLogger::loggerCtxMap_;
std::mutex Xh265RecorderLogger::ctxMapMutex_;
std::mutex Xh265RecorderLogger::loggerCtxMapMutex_;

void Xh265RecorderLogger::SetLogConfig()
{
    logConfig_ = ParseLogConfig();
}

/* 此方法应在main函数调用 */
void Xh265RecorderLogger::InitAppLogging()
{
    SetLogConfig();
...
void Xh265RecorderLogger::InitLoggerCtx(const ara::core::String& ctxId = logConfig_.appId,
...
ara::log::Logger* Xh265RecorderLogger::GetLogCtxInstance(const ara::core::String& ctxId,
...
ara::core::String Xh265RecorderLogger::GetSpecifyLogConfig(const ara::core::String& logTraceName,
...
ara::core::Vector<ara::core::String> Xh265RecorderLogger::GetSpecifyLogMode(
...
ara::log::LogLevel Xh265RecorderLogger::GetLogLevel(const ara::core::String& level)
{
    if (level == "info") {
...
ara::log::LogMode Xh265RecorderLogger::GetLogMode(const ara::core::Vector<ara::core::String>& modeVec)
{
...
LogConfig Xh265RecorderLogger::ParseLogConfig()
{
    ara::core::String filePath {};
    ara::log::LogMode kLogMode = ara::log::LogMode::kRemote;
    LogConfig logConfig = { "SCFI", "xh265_recorder context",
...
bool Xh265RecorderLogger::DoesFileExist(const ara::core::String& filePath)
{
...
bool Xh265RecorderLogger::IsDirType(const mode_t& fileMode)
{
    if (S_ISDIR(fileMode)) {
        return true;
    }
