 ...
 */
#include "mdc/lidar_slam_base_logger.h"
#include <cstring>
#include <fstream>
#include <climits>
#include <sys/stat.h>
...
LogConfig LidarSlamBaseLogger::logConfig_ = {"LidarSlamBase",
    "lidar_slam_base context", "", ara::log::LogLevel::kInfo, ara::log::LogMode::kRemote};
std::map<ara::core::String, ara::core::String> LidarSlamBaseLogger::ctxMap_;
std::map<ara::core::String, ara::log::Logger*> LidarSlamBaseLogger::loggerCtxMap_;
std::mutex LidarSlamBaseLogger::ctxMapMutex_;
std::mutex LidarSlamBaseLogger::loggerCtxMapMutex_;

void LidarSlamBaseLogger::SetLogConfig()
{
    logConfig_ = ParseLogConfig();
}

/* 此方法应在main函数调用 */
void LidarSlamBaseLogger::InitAppLogging()
{
    SetLogConfig();
...
void LidarSlamBaseLogger::InitLoggerCtx(const ara::core::String& ctxId = logConfig_.appId,
...
ara::log::Logger* LidarSlamBaseLogger::GetLogCtxInstance(const ara::core::String& ctxId,
...
ara::core::String LidarSlamBaseLogger::GetSpecifyLogConfig(const ara::core::String& logTraceName,
...
ara::core::Vector<ara::core::String> LidarSlamBaseLogger::GetSpecifyLogMode(
...
ara::log::LogLevel LidarSlamBaseLogger::GetLogLevel(const ara::core::String& level)
{
    if (level == "info") {
...
ara::log::LogMode LidarSlamBaseLogger::GetLogMode(const ara::core::Vector<ara::core::String>& modeVec)
{
...
LogConfig LidarSlamBaseLogger::ParseLogConfig()
{
    ara::core::String filePath {};
    ara::log::LogMode kLogMode = ara::log::LogMode::kRemote;
    LogConfig logConfig = { "SCFI", "lidar_slam_base context",
...
bool LidarSlamBaseLogger::DoesFileExist(const ara::core::String& filePath)
{
...
bool LidarSlamBaseLogger::IsDirType(const mode_t& fileMode)
{
    if (S_ISDIR(fileMode)) {
        return true;
    }
