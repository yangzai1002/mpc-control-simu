 ...
 */
#ifndef ARA_SENSOR_VIUALIZE_BASE_SENSOR_VIUALIZE_BASE_LOGGER_H
#define ARA_SENSOR_VIUALIZE_BASE_SENSOR_VIUALIZE_BASE_LOGGER_H
#include <cstdint>
#include <string>
#include <map>
#include <mutex>
...
class SensorViualizeBaseLogger {
public:
    virtual ~SensorViualizeBaseLogger() = default;
     ...
     * ara::sensor_viualize_base::SensorViualizeBaseLogger::GetLoggerIns("PER")->LogError() << "*******";
...
private:
    SensorViualizeBaseLogger() = default;
...
#endif  /* ARA_SENSOR_VIUALIZE_BASE_SENSOR_VIUALIZE_BASE_LOGGER_H */