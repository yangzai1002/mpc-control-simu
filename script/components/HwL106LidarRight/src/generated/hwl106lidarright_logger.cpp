...
LogConfig Hwl106lidarrightLogger::logConfig_ = {"Hwl106lidarright",
    "HwL106LidarRight context", "", ara::log::LogLevel::kInfo, ara::log::LogMode::kRemote};
std::map<ara::core::String, ara::core::String> Hwl106lidarrightLogger::ctxMap_;
std::map<ara::core::String, ara::log::Logger*> Hwl106lidarrightLogger::loggerCtxMap_;
std::mutex Hwl106lidarrightLogger::ctxMapMutex_;
std::mutex Hwl106lidarrightLogger::loggerCtxMapMutex_;

void Hwl106lidarrightLogger::SetLogConfig()
{
    logConfig_ = ParseLogConfig();
}

/* 此方法应在main函数调用 */
void Hwl106lidarrightLogger::InitAppLogging()
{
    SetLogConfig();
...
void Hwl106lidarrightLogger::InitLoggerCtx(const ara::core::String& ctxId = logConfig_.appId,
...
ara::log::Logger* Hwl106lidarrightLogger::GetLogCtxInstance(const ara::core::String& ctxId,
...
ara::core::String Hwl106lidarrightLogger::GetSpecifyLogConfig(const ara::core::String& logTraceName,
...
ara::core::Vector<ara::core::String> Hwl106lidarrightLogger::GetSpecifyLogMode(
...
ara::log::LogLevel Hwl106lidarrightLogger::GetLogLevel(const ara::core::String& level)
{
    if (level == "info") {
...
ara::log::LogMode Hwl106lidarrightLogger::GetLogMode(const ara::core::Vector<ara::core::String>& modeVec)
{
...
LogConfig Hwl106lidarrightLogger::ParseLogConfig()
{
    ara::core::String filePath {};
    ara::log::LogMode kLogMode = ara::log::LogMode::kRemote;
    LogConfig logConfig = { "SCFI", "HwL106LidarRight context",
...
bool Hwl106lidarrightLogger::DoesFileExist(const ara::core::String& filePath)
{
...
bool Hwl106lidarrightLogger::IsDirType(const mode_t& fileMode)
{
    if (S_ISDIR(fileMode)) {
        return true;
    }
