 ...
 */
#ifndef ARA_HWL106LIDARRIGHT_HWL106LIDARRIGHT_LOGGER_H
#define ARA_HWL106LIDARRIGHT_HWL106LIDARRIGHT_LOGGER_H
#include <cstdint>
#include <string>
#include <map>
#include <mutex>
...
class Hwl106lidarrightLogger {
public:
    virtual ~Hwl106lidarrightLogger() = default;
     ...
     * ara::hwl106lidarright::Hwl106lidarrightLogger::GetLoggerIns("PER")->LogError() << "*******";
...
private:
    Hwl106lidarrightLogger() = default;
...
#endif  /* ARA_HWL106LIDARRIGHT_HWL106LIDARRIGHT_LOGGER_H */