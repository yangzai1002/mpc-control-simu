...
LogConfig XfaulthandlerLogger::logConfig_ = {"Xfaulthandler",
    "XFaultHandler context", "", ara::log::LogLevel::kInfo, ara::log::LogMode::kRemote};
std::map<ara::core::String, ara::core::String> XfaulthandlerLogger::ctxMap_;
std::map<ara::core::String, ara::log::Logger*> XfaulthandlerLogger::loggerCtxMap_;
std::mutex XfaulthandlerLogger::ctxMapMutex_;
std::mutex XfaulthandlerLogger::loggerCtxMapMutex_;

void XfaulthandlerLogger::SetLogConfig()
{
    logConfig_ = ParseLogConfig();
}

/* 此方法应在main函数调用 */
void XfaulthandlerLogger::InitAppLogging()
{
    SetLogConfig();
...
void XfaulthandlerLogger::InitLoggerCtx(const ara::core::String& ctxId = logConfig_.appId,
...
ara::log::Logger* XfaulthandlerLogger::GetLogCtxInstance(const ara::core::String& ctxId,
...
ara::core::String XfaulthandlerLogger::GetSpecifyLogConfig(const ara::core::String& logTraceName,
...
ara::core::Vector<ara::core::String> XfaulthandlerLogger::GetSpecifyLogMode(
...
ara::log::LogLevel XfaulthandlerLogger::GetLogLevel(const ara::core::String& level)
{
    if (level == "info") {
...
ara::log::LogMode XfaulthandlerLogger::GetLogMode(const ara::core::Vector<ara::core::String>& modeVec)
{
...
LogConfig XfaulthandlerLogger::ParseLogConfig()
{
    ara::core::String filePath {};
    ara::log::LogMode kLogMode = ara::log::LogMode::kRemote;
    LogConfig logConfig = { "SCFI", "XFaultHandler context",
...
bool XfaulthandlerLogger::DoesFileExist(const ara::core::String& filePath)
{
...
bool XfaulthandlerLogger::IsDirType(const mode_t& fileMode)
{
    if (S_ISDIR(fileMode)) {
        return true;
    }
