...
LogConfig Hwl106lidarfrontLogger::logConfig_ = {"Hwl106lidarfront",
    "HwL106LidarFront context", "", ara::log::LogLevel::kInfo, ara::log::LogMode::kRemote};
std::map<ara::core::String, ara::core::String> Hwl106lidarfrontLogger::ctxMap_;
std::map<ara::core::String, ara::log::Logger*> Hwl106lidarfrontLogger::loggerCtxMap_;
std::mutex Hwl106lidarfrontLogger::ctxMapMutex_;
std::mutex Hwl106lidarfrontLogger::loggerCtxMapMutex_;

void Hwl106lidarfrontLogger::SetLogConfig()
{
    logConfig_ = ParseLogConfig();
}

/* 此方法应在main函数调用 */
void Hwl106lidarfrontLogger::InitAppLogging()
{
    SetLogConfig();
...
void Hwl106lidarfrontLogger::InitLoggerCtx(const ara::core::String& ctxId = logConfig_.appId,
...
ara::log::Logger* Hwl106lidarfrontLogger::GetLogCtxInstance(const ara::core::String& ctxId,
...
ara::core::String Hwl106lidarfrontLogger::GetSpecifyLogConfig(const ara::core::String& logTraceName,
...
ara::core::Vector<ara::core::String> Hwl106lidarfrontLogger::GetSpecifyLogMode(
...
ara::log::LogLevel Hwl106lidarfrontLogger::GetLogLevel(const ara::core::String& level)
{
    if (level == "info") {
...
ara::log::LogMode Hwl106lidarfrontLogger::GetLogMode(const ara::core::Vector<ara::core::String>& modeVec)
{
...
LogConfig Hwl106lidarfrontLogger::ParseLogConfig()
{
    ara::core::String filePath {};
    ara::log::LogMode kLogMode = ara::log::LogMode::kRemote;
    LogConfig logConfig = { "SCFI", "HwL106LidarFront context",
...
bool Hwl106lidarfrontLogger::DoesFileExist(const ara::core::String& filePath)
{
...
bool Hwl106lidarfrontLogger::IsDirType(const mode_t& fileMode)
{
    if (S_ISDIR(fileMode)) {
        return true;
    }
