...
LogConfig PlanningLogger::logConfig_ = {"Planning",
    "Planning context", "", ara::log::LogLevel::kInfo, ara::log::LogMode::kRemote};
std::map<ara::core::String, ara::core::String> PlanningLogger::ctxMap_;
std::map<ara::core::String, ara::log::Logger*> PlanningLogger::loggerCtxMap_;
std::mutex PlanningLogger::ctxMapMutex_;
std::mutex PlanningLogger::loggerCtxMapMutex_;

void PlanningLogger::SetLogConfig()
{
    logConfig_ = ParseLogConfig();
}

/* 此方法应在main函数调用 */
void PlanningLogger::InitAppLogging()
{
    SetLogConfig();
...
void PlanningLogger::InitLoggerCtx(const ara::core::String& ctxId = logConfig_.appId,
...
ara::log::Logger* PlanningLogger::GetLogCtxInstance(const ara::core::String& ctxId,
...
ara::core::String PlanningLogger::GetSpecifyLogConfig(const ara::core::String& logTraceName,
...
ara::core::Vector<ara::core::String> PlanningLogger::GetSpecifyLogMode(
...
ara::log::LogLevel PlanningLogger::GetLogLevel(const ara::core::String& level)
{
    if (level == "info") {
...
ara::log::LogMode PlanningLogger::GetLogMode(const ara::core::Vector<ara::core::String>& modeVec)
{
...
LogConfig PlanningLogger::ParseLogConfig()
{
    ara::core::String filePath {};
    ara::log::LogMode kLogMode = ara::log::LogMode::kRemote;
    LogConfig logConfig = { "SCFI", "Planning context",
...
bool PlanningLogger::DoesFileExist(const ara::core::String& filePath)
{
...
bool PlanningLogger::IsDirType(const mode_t& fileMode)
{
    if (S_ISDIR(fileMode)) {
        return true;
    }
