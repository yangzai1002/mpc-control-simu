 ...
 */
#ifndef ARA_CONTROL_BASE_CONTROL_BASE_LOGGER_H
#define ARA_CONTROL_BASE_CONTROL_BASE_LOGGER_H
#include <cstdint>
#include <string>
#include <map>
#include <mutex>
...
class ControlBaseLogger {
public:
    virtual ~ControlBaseLogger() = default;
     ...
     * ara::control_base::ControlBaseLogger::GetLoggerIns("PER")->LogError() << "*******";
...
#endif  /* ARA_CONTROL_BASE_CONTROL_BASE_LOGGER_H */