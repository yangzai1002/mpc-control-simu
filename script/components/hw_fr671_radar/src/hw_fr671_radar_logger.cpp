...
LogConfig HwFr671RadarLogger::logConfig_ = {"HwFr671Radar",
    "hw_fr671_radar context", "", ara::log::LogLevel::kInfo, ara::log::LogMode::kRemote};
std::map<ara::core::String, ara::core::String> HwFr671RadarLogger::ctxMap_;
std::map<ara::core::String, ara::log::Logger*> HwFr671RadarLogger::loggerCtxMap_;
std::mutex HwFr671RadarLogger::ctxMapMutex_;
std::mutex HwFr671RadarLogger::loggerCtxMapMutex_;

void HwFr671RadarLogger::SetLogConfig()
{
    logConfig_ = ParseLogConfig();
}

/* 此方法应在main函数调用 */
void HwFr671RadarLogger::InitAppLogging()
{
    SetLogConfig();
...
void HwFr671RadarLogger::InitLoggerCtx(const ara::core::String& ctxId = logConfig_.appId,
...
ara::log::Logger* HwFr671RadarLogger::GetLogCtxInstance(const ara::core::String& ctxId,
...
ara::core::String HwFr671RadarLogger::GetSpecifyLogConfig(const ara::core::String& logTraceName,
...
ara::core::Vector<ara::core::String> HwFr671RadarLogger::GetSpecifyLogMode(
...
ara::log::LogLevel HwFr671RadarLogger::GetLogLevel(const ara::core::String& level)
{
    if (level == "info") {
...
ara::log::LogMode HwFr671RadarLogger::GetLogMode(const ara::core::Vector<ara::core::String>& modeVec)
{
...
LogConfig HwFr671RadarLogger::ParseLogConfig()
{
    ara::core::String filePath {};
    ara::log::LogMode kLogMode = ara::log::LogMode::kRemote;
    LogConfig logConfig = { "SCFI", "hw_fr671_radar context",
...
bool HwFr671RadarLogger::DoesFileExist(const ara::core::String& filePath)
{
...
bool HwFr671RadarLogger::IsDirType(const mode_t& fileMode)
{
    if (S_ISDIR(fileMode)) {
        return true;
    }
