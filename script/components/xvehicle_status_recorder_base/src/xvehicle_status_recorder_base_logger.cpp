...
LogConfig XvehicleStatusRecorderBaseLogger::logConfig_ = {"XvehicleStatusRecorderBase",
    "xvehicle_status_recorder_base context", "", ara::log::LogLevel::kInfo, ara::log::LogMode::kRemote};
std::map<ara::core::String, ara::core::String> XvehicleStatusRecorderBaseLogger::ctxMap_;
std::map<ara::core::String, ara::log::Logger*> XvehicleStatusRecorderBaseLogger::loggerCtxMap_;
std::mutex XvehicleStatusRecorderBaseLogger::ctxMapMutex_;
std::mutex XvehicleStatusRecorderBaseLogger::loggerCtxMapMutex_;

void XvehicleStatusRecorderBaseLogger::SetLogConfig()
{
    logConfig_ = ParseLogConfig();
}

/* 此方法应在main函数调用 */
void XvehicleStatusRecorderBaseLogger::InitAppLogging()
{
    SetLogConfig();
...
void XvehicleStatusRecorderBaseLogger::InitLoggerCtx(const ara::core::String& ctxId = logConfig_.appId,
...
ara::log::Logger* XvehicleStatusRecorderBaseLogger::GetLogCtxInstance(const ara::core::String& ctxId,
...
ara::core::String XvehicleStatusRecorderBaseLogger::GetSpecifyLogConfig(const ara::core::String& logTraceName,
...
ara::core::Vector<ara::core::String> XvehicleStatusRecorderBaseLogger::GetSpecifyLogMode(
...
ara::log::LogLevel XvehicleStatusRecorderBaseLogger::GetLogLevel(const ara::core::String& level)
{
    if (level == "info") {
...
ara::log::LogMode XvehicleStatusRecorderBaseLogger::GetLogMode(const ara::core::Vector<ara::core::String>& modeVec)
{
...
LogConfig XvehicleStatusRecorderBaseLogger::ParseLogConfig()
{
    ara::core::String filePath {};
    ara::log::LogMode kLogMode = ara::log::LogMode::kRemote;
    LogConfig logConfig = { "SCFI", "xvehicle_status_recorder_base context",
...
bool XvehicleStatusRecorderBaseLogger::DoesFileExist(const ara::core::String& filePath)
{
...
bool XvehicleStatusRecorderBaseLogger::IsDirType(const mode_t& fileMode)
{
    if (S_ISDIR(fileMode)) {
        return true;
    }
