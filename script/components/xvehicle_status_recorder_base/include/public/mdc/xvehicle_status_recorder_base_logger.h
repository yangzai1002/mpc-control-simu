 ...
 */
#ifndef ARA_XVEHICLE_STATUS_RECORDER_BASE_XVEHICLE_STATUS_RECORDER_BASE_LOGGER_H
#define ARA_XVEHICLE_STATUS_RECORDER_BASE_XVEHICLE_STATUS_RECORDER_BASE_LOGGER_H
#include <cstdint>
#include <string>
#include <map>
#include <mutex>
...
class XvehicleStatusRecorderBaseLogger {
public:
    virtual ~XvehicleStatusRecorderBaseLogger() = default;
     ...
     * ara::xvehicle_status_recorder_base::XvehicleStatusRecorderBaseLogger::GetLoggerIns("PER")->LogError() << "*******";
...
private:
    XvehicleStatusRecorderBaseLogger() = default;
...
#endif  /* ARA_XVEHICLE_STATUS_RECORDER_BASE_XVEHICLE_STATUS_RECORDER_BASE_LOGGER_H */