 ...
 */
#ifndef ARA_CONTROL_CONTROL_LOGGER_H
#define ARA_CONTROL_CONTROL_LOGGER_H
#include <cstdint>
#include <string>
#include <map>
#include <mutex>
...
public:
     ...
     * ara::control::ControlLogger::GetLoggerIns("PER")->LogError() << "*******";
...
#endif  /* ARA_CONTROL_CONTROL_LOGGER_H */