 ...
 */
#include "mdc/mid_track_chassis_send_logger.h"
#include <cstring>
#include <fstream>
#include <climits>
#include <sys/stat.h>
...
namespace mdc {
namespace mid_track_chassis_send {

LogConfig MidTrackChassisSendLogger::logConfig_ = {"MidTrackChassisSend",
    "mid_track_chassis_send context", "", ara::log::LogLevel::kInfo, ara::log::LogMode::kRemote};
std::map<ara::core::String, ara::core::String> MidTrackChassisSendLogger::ctxMap_;
std::map<ara::core::String, ara::log::Logger*> MidTrackChassisSendLogger::loggerCtxMap_;
std::mutex MidTrackChassisSendLogger::ctxMapMutex_;
std::mutex MidTrackChassisSendLogger::loggerCtxMapMutex_;

void MidTrackChassisSendLogger::SetLogConfig()
{
    logConfig_ = ParseLogConfig();
}

/* 此方法应在main函数调用 */
void MidTrackChassisSendLogger::InitAppLogging()
{
    SetLogConfig();
...
void MidTrackChassisSendLogger::InitLoggerCtx(const ara::core::String& ctxId = logConfig_.appId,
...
ara::log::Logger* MidTrackChassisSendLogger::GetLogCtxInstance(const ara::core::String& ctxId,
...
ara::core::String MidTrackChassisSendLogger::GetSpecifyLogConfig(const ara::core::String& logTraceName,
...
ara::core::Vector<ara::core::String> MidTrackChassisSendLogger::GetSpecifyLogMode(
...
ara::log::LogLevel MidTrackChassisSendLogger::GetLogLevel(const ara::core::String& level)
{
    if (level == "info") {
...
ara::log::LogMode MidTrackChassisSendLogger::GetLogMode(const ara::core::Vector<ara::core::String>& modeVec)
{
...
LogConfig MidTrackChassisSendLogger::ParseLogConfig()
{
    ara::core::String filePath {};
    ara::log::LogMode kLogMode = ara::log::LogMode::kRemote;
    LogConfig logConfig = { "SCFI", "mid_track_chassis_send context",
...
bool MidTrackChassisSendLogger::DoesFileExist(const ara::core::String& filePath)
{
...
bool MidTrackChassisSendLogger::IsDirType(const mode_t& fileMode)
{
    if (S_ISDIR(fileMode)) {
        return true;
    }
