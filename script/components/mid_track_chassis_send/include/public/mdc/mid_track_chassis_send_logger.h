 ...
 */
#ifndef ARA_MID_TRACK_CHASSIS_SEND_MID_TRACK_CHASSIS_SEND_LOGGER_H
#define ARA_MID_TRACK_CHASSIS_SEND_MID_TRACK_CHASSIS_SEND_LOGGER_H
#include <cstdint>
#include <string>
#include <map>
#include <mutex>
...
class MidTrackChassisSendLogger {
public:
    virtual ~MidTrackChassisSendLogger() = default;
     ...
     * ara::mid_track_chassis_send::MidTrackChassisSendLogger::GetLoggerIns("PER")->LogError() << "*******";
...
private:
    MidTrackChassisSendLogger() = default;
...
#endif  /* ARA_MID_TRACK_CHASSIS_SEND_MID_TRACK_CHASSIS_SEND_LOGGER_H */