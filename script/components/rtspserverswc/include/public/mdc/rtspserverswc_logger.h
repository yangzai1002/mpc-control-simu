 ...
 */
#ifndef ARA_RTSPSERVERSWC_RTSPSERVERSWC_LOGGER_H
#define ARA_RTSPSERVERSWC_RTSPSERVERSWC_LOGGER_H
#include <cstdint>
#include <string>
#include <map>
#include <mutex>
...
class RtspserverswcLogger {
public:
    virtual ~RtspserverswcLogger() = default;
     ...
     * ara::rtspserverswc::RtspserverswcLogger::GetLoggerIns("PER")->LogError() << "*******";
...
#endif  /* ARA_RTSPSERVERSWC_RTSPSERVERSWC_LOGGER_H */