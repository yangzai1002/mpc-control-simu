 ...
 */
#ifndef ARA_BD21_IMU_BD21_IMU_LOGGER_H
#define ARA_BD21_IMU_BD21_IMU_LOGGER_H
#include <cstdint>
#include <string>
#include <map>
#include <mutex>
...
public:
     ...
     * ara::bd21_imu::Bd21ImuLogger::GetLoggerIns("PER")->LogError() << "*******";
...
#endif  /* ARA_BD21_IMU_BD21_IMU_LOGGER_H */