...
LogConfig PlanningBaseLogger::logConfig_ = {"PlanningBase",
    "planning_base context", "", ara::log::LogLevel::kInfo, ara::log::LogMode::kRemote};
std::map<ara::core::String, ara::core::String> PlanningBaseLogger::ctxMap_;
std::map<ara::core::String, ara::log::Logger*> PlanningBaseLogger::loggerCtxMap_;
std::mutex PlanningBaseLogger::ctxMapMutex_;
std::mutex PlanningBaseLogger::loggerCtxMapMutex_;

void PlanningBaseLogger::SetLogConfig()
{
    logConfig_ = ParseLogConfig();
}

/* 此方法应在main函数调用 */
void PlanningBaseLogger::InitAppLogging()
{
    SetLogConfig();
...
void PlanningBaseLogger::InitLoggerCtx(const ara::core::String& ctxId = logConfig_.appId,
...
ara::log::Logger* PlanningBaseLogger::GetLogCtxInstance(const ara::core::String& ctxId,
...
ara::core::String PlanningBaseLogger::GetSpecifyLogConfig(const ara::core::String& logTraceName,
...
ara::core::Vector<ara::core::String> PlanningBaseLogger::GetSpecifyLogMode(
...
ara::log::LogLevel PlanningBaseLogger::GetLogLevel(const ara::core::String& level)
{
    if (level == "info") {
...
ara::log::LogMode PlanningBaseLogger::GetLogMode(const ara::core::Vector<ara::core::String>& modeVec)
{
...
LogConfig PlanningBaseLogger::ParseLogConfig()
{
    ara::core::String filePath {};
    ara::log::LogMode kLogMode = ara::log::LogMode::kRemote;
    LogConfig logConfig = { "SCFI", "planning_base context",
...
bool PlanningBaseLogger::DoesFileExist(const ara::core::String& filePath)
{
...
bool PlanningBaseLogger::IsDirType(const mode_t& fileMode)
{
    if (S_ISDIR(fileMode)) {
        return true;
    }
