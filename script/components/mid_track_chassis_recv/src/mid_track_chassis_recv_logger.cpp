...
LogConfig MidTrackChassisRecvLogger::logConfig_ = {"MidTrackChassisRecv",
    "mid_track_chassis_recv context", "", ara::log::LogLevel::kInfo, ara::log::LogMode::kRemote};
std::map<ara::core::String, ara::core::String> MidTrackChassisRecvLogger::ctxMap_;
std::map<ara::core::String, ara::log::Logger*> MidTrackChassisRecvLogger::loggerCtxMap_;
std::mutex MidTrackChassisRecvLogger::ctxMapMutex_;
std::mutex MidTrackChassisRecvLogger::loggerCtxMapMutex_;

void MidTrackChassisRecvLogger::SetLogConfig()
{
    logConfig_ = ParseLogConfig();
}

/* 此方法应在main函数调用 */
void MidTrackChassisRecvLogger::InitAppLogging()
{
    SetLogConfig();
...
void MidTrackChassisRecvLogger::InitLoggerCtx(const ara::core::String& ctxId = logConfig_.appId,
...
ara::log::Logger* MidTrackChassisRecvLogger::GetLogCtxInstance(const ara::core::String& ctxId,
...
ara::core::String MidTrackChassisRecvLogger::GetSpecifyLogConfig(const ara::core::String& logTraceName,
...
ara::core::Vector<ara::core::String> MidTrackChassisRecvLogger::GetSpecifyLogMode(
...
ara::log::LogLevel MidTrackChassisRecvLogger::GetLogLevel(const ara::core::String& level)
{
    if (level == "info") {
...
ara::log::LogMode MidTrackChassisRecvLogger::GetLogMode(const ara::core::Vector<ara::core::String>& modeVec)
{
...
LogConfig MidTrackChassisRecvLogger::ParseLogConfig()
{
    ara::core::String filePath {};
    ara::log::LogMode kLogMode = ara::log::LogMode::kRemote;
    LogConfig logConfig = { "SCFI", "mid_track_chassis_recv context",
...
bool MidTrackChassisRecvLogger::DoesFileExist(const ara::core::String& filePath)
{
...
bool MidTrackChassisRecvLogger::IsDirType(const mode_t& fileMode)
{
    if (S_ISDIR(fileMode)) {
        return true;
    }
