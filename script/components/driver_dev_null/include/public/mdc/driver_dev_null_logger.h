 ...
 */
#ifndef ARA_DRIVER_DEV_NULL_DRIVER_DEV_NULL_LOGGER_H
#define ARA_DRIVER_DEV_NULL_DRIVER_DEV_NULL_LOGGER_H
#include <cstdint>
#include <string>
#include <map>
#include <mutex>
...
class DriverDevNullLogger {
public:
    virtual ~DriverDevNullLogger() = default;
     ...
     * ara::driver_dev_null::DriverDevNullLogger::GetLoggerIns("PER")->LogError() << "*******";
...
#endif  /* ARA_DRIVER_DEV_NULL_DRIVER_DEV_NULL_LOGGER_H */