...
LogConfig FusionLocationBaseLogger::logConfig_ = {"FusionLocationBase",
    "fusion_location_base context", "", ara::log::LogLevel::kInfo, ara::log::LogMode::kRemote};
std::map<ara::core::String, ara::core::String> FusionLocationBaseLogger::ctxMap_;
std::map<ara::core::String, ara::log::Logger*> FusionLocationBaseLogger::loggerCtxMap_;
std::mutex FusionLocationBaseLogger::ctxMapMutex_;
std::mutex FusionLocationBaseLogger::loggerCtxMapMutex_;

void FusionLocationBaseLogger::SetLogConfig()
{
    logConfig_ = ParseLogConfig();
}

/* 此方法应在main函数调用 */
void FusionLocationBaseLogger::InitAppLogging()
{
    SetLogConfig();
...
void FusionLocationBaseLogger::InitLoggerCtx(const ara::core::String& ctxId = logConfig_.appId,
...
ara::log::Logger* FusionLocationBaseLogger::GetLogCtxInstance(const ara::core::String& ctxId,
...
ara::core::String FusionLocationBaseLogger::GetSpecifyLogConfig(const ara::core::String& logTraceName,
...
ara::core::Vector<ara::core::String> FusionLocationBaseLogger::GetSpecifyLogMode(
...
ara::log::LogLevel FusionLocationBaseLogger::GetLogLevel(const ara::core::String& level)
{
    if (level == "info") {
...
ara::log::LogMode FusionLocationBaseLogger::GetLogMode(const ara::core::Vector<ara::core::String>& modeVec)
{
...
LogConfig FusionLocationBaseLogger::ParseLogConfig()
{
    ara::core::String filePath {};
    ara::log::LogMode kLogMode = ara::log::LogMode::kRemote;
    LogConfig logConfig = { "SCFI", "fusion_location_base context",
...
bool FusionLocationBaseLogger::DoesFileExist(const ara::core::String& filePath)
{
...
bool FusionLocationBaseLogger::IsDirType(const mode_t& fileMode)
{
    if (S_ISDIR(fileMode)) {
        return true;
    }
