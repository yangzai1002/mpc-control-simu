 ...
 */
#ifndef ARA_FUSIONFOLLOW_FUSIONFOLLOW_LOGGER_H
#define ARA_FUSIONFOLLOW_FUSIONFOLLOW_LOGGER_H
#include <cstdint>
#include <string>
#include <map>
#include <mutex>
...
class FusionfollowLogger {
public:
    virtual ~FusionfollowLogger() = default;
     ...
     * ara::fusionfollow::FusionfollowLogger::GetLoggerIns("PER")->LogError() << "*******";
...
#endif  /* ARA_FUSIONFOLLOW_FUSIONFOLLOW_LOGGER_H */