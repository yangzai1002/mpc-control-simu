...
LogConfig LocationLogger::logConfig_ = {"Location",
    "Location context", "", ara::log::LogLevel::kInfo, ara::log::LogMode::kRemote};
std::map<ara::core::String, ara::core::String> LocationLogger::ctxMap_;
std::map<ara::core::String, ara::log::Logger*> LocationLogger::loggerCtxMap_;
std::mutex LocationLogger::ctxMapMutex_;
std::mutex LocationLogger::loggerCtxMapMutex_;

void LocationLogger::SetLogConfig()
{
    logConfig_ = ParseLogConfig();
}

/* 此方法应在main函数调用 */
void LocationLogger::InitAppLogging()
{
    SetLogConfig();
...
void LocationLogger::InitLoggerCtx(const ara::core::String& ctxId = logConfig_.appId,
...
ara::log::Logger* LocationLogger::GetLogCtxInstance(const ara::core::String& ctxId,
...
ara::core::String LocationLogger::GetSpecifyLogConfig(const ara::core::String& logTraceName,
...
ara::core::Vector<ara::core::String> LocationLogger::GetSpecifyLogMode(
...
ara::log::LogLevel LocationLogger::GetLogLevel(const ara::core::String& level)
{
    if (level == "info") {
...
ara::log::LogMode LocationLogger::GetLogMode(const ara::core::Vector<ara::core::String>& modeVec)
{
...
LogConfig LocationLogger::ParseLogConfig()
{
    ara::core::String filePath {};
    ara::log::LogMode kLogMode = ara::log::LogMode::kRemote;
    LogConfig logConfig = { "SCFI", "Location context",
...
bool LocationLogger::DoesFileExist(const ara::core::String& filePath)
{
...
bool LocationLogger::IsDirType(const mode_t& fileMode)
{
    if (S_ISDIR(fileMode)) {
        return true;
    }
