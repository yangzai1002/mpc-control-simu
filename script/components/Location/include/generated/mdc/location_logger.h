 ...
 */
#ifndef ARA_LOCATION_LOCATION_LOGGER_H
#define ARA_LOCATION_LOCATION_LOGGER_H
#include <cstdint>
#include <string>
#include <map>
#include <mutex>
...
public:
    virtual ~LocationLogger() = default;
     ...
     * ara::location::LocationLogger::GetLoggerIns("PER")->LogError() << "*******";
...
#endif  /* ARA_LOCATION_LOCATION_LOGGER_H */