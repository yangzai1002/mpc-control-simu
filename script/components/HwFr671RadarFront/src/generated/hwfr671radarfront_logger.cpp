...
LogConfig Hwfr671radarfrontLogger::logConfig_ = {"Hwfr671radarfront",
    "HwFr671RadarFront context", "", ara::log::LogLevel::kInfo, ara::log::LogMode::kRemote};
std::map<ara::core::String, ara::core::String> Hwfr671radarfrontLogger::ctxMap_;
std::map<ara::core::String, ara::log::Logger*> Hwfr671radarfrontLogger::loggerCtxMap_;
std::mutex Hwfr671radarfrontLogger::ctxMapMutex_;
std::mutex Hwfr671radarfrontLogger::loggerCtxMapMutex_;

void Hwfr671radarfrontLogger::SetLogConfig()
{
    logConfig_ = ParseLogConfig();
}

/* 此方法应在main函数调用 */
void Hwfr671radarfrontLogger::InitAppLogging()
{
    SetLogConfig();
...
void Hwfr671radarfrontLogger::InitLoggerCtx(const ara::core::String& ctxId = logConfig_.appId,
...
ara::log::Logger* Hwfr671radarfrontLogger::GetLogCtxInstance(const ara::core::String& ctxId,
...
ara::core::String Hwfr671radarfrontLogger::GetSpecifyLogConfig(const ara::core::String& logTraceName,
...
ara::core::Vector<ara::core::String> Hwfr671radarfrontLogger::GetSpecifyLogMode(
...
ara::log::LogLevel Hwfr671radarfrontLogger::GetLogLevel(const ara::core::String& level)
{
    if (level == "info") {
...
LogConfig Hwfr671radarfrontLogger::ParseLogConfig()
{
    ara::core::String filePath {};
    ara::log::LogMode kLogMode = ara::log::LogMode::kRemote;
    LogConfig logConfig = { "SCFI", "HwFr671RadarFront context",
...
bool Hwfr671radarfrontLogger::DoesFileExist(const ara::core::String& filePath)
{
...
bool Hwfr671radarfrontLogger::IsDirType(const mode_t& fileMode)
{
    if (S_ISDIR(fileMode)) {
        return true;
    }
