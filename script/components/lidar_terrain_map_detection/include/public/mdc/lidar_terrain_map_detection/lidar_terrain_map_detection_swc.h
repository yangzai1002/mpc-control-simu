...
#ifndef MDC_LIDARTERRAINMAPDETECTIONSWC_H
#define MDC_LIDARTERRAINMAPDETECTIONSWC_H
...
namespace ara {
namespace adsfi {
class PerceptionStaticEnvServiceInterfaceServer;
}
}
namespace ara {
namespace adsfi {
...
namespace {
using ara::adsfi::PerceptionStaticEnvServiceInterfaceServer;
...
class LidarTerrainMapDetectionSwC {
public:
    explicit LidarTerrainMapDetectionSwC();

    virtual ~LidarTerrainMapDetectionSwC();
    ...
    ara::core::Vector<std::string> GetPerceptionStaticEnvServiceInterfaceServerVec()
    {
        std::lock_guard<std::mutex> lck(perceptionStaticEnvServiceInterfaceServerPortVecMtx_);
        return perceptionStaticEnvServiceInterfaceServerPortVec_;
    }
    ...
    std::shared_ptr<PerceptionStaticEnvServiceInterfaceServer> GetPerceptionStaticEnvServiceInterfaceServer(const ara::core::String& portName);
...
private:
    ...
    /* server agent */
    ara::core::Vector<uint32_t> perceptionStaticEnvServiceInterfaceServerIdVec_;
    ara::core::Vector<std::string> perceptionStaticEnvServiceInterfaceServerPortVec_;
    std::mutex perceptionStaticEnvServiceInterfaceServerPortVecMtx_;
    ara::core::Map<std::string, uint32_t> perceptionStaticEnvServiceInterfaceServerIdMap_;
    ara::core::Map<std::string, std::shared_ptr<PerceptionStaticEnvServiceInterfaceServer>> perceptionStaticEnvServiceInterfaceServerInsMap_;
    std::mutex perceptionStaticEnvServiceInterfaceServerInsMapMtx_;
    /* client agent */
...
#endif  /* MDC_LIDARTERRAINMAPDETECTIONSWC_H */