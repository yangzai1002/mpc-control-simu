...
LogConfig Hwfr671radarrightLogger::logConfig_ = {"Hwfr671radarright",
    "HwFr671RadarRight context", "", ara::log::LogLevel::kInfo, ara::log::LogMode::kRemote};
std::map<ara::core::String, ara::core::String> Hwfr671radarrightLogger::ctxMap_;
std::map<ara::core::String, ara::log::Logger*> Hwfr671radarrightLogger::loggerCtxMap_;
std::mutex Hwfr671radarrightLogger::ctxMapMutex_;
std::mutex Hwfr671radarrightLogger::loggerCtxMapMutex_;

void Hwfr671radarrightLogger::SetLogConfig()
{
    logConfig_ = ParseLogConfig();
}

/* 此方法应在main函数调用 */
void Hwfr671radarrightLogger::InitAppLogging()
{
    SetLogConfig();
...
void Hwfr671radarrightLogger::InitLoggerCtx(const ara::core::String& ctxId = logConfig_.appId,
...
ara::log::Logger* Hwfr671radarrightLogger::GetLogCtxInstance(const ara::core::String& ctxId,
...
ara::core::String Hwfr671radarrightLogger::GetSpecifyLogConfig(const ara::core::String& logTraceName,
...
ara::core::Vector<ara::core::String> Hwfr671radarrightLogger::GetSpecifyLogMode(
...
ara::log::LogLevel Hwfr671radarrightLogger::GetLogLevel(const ara::core::String& level)
{
    if (level == "info") {
...
ara::log::LogMode Hwfr671radarrightLogger::GetLogMode(const ara::core::Vector<ara::core::String>& modeVec)
{
...
LogConfig Hwfr671radarrightLogger::ParseLogConfig()
{
    ara::core::String filePath {};
    ara::log::LogMode kLogMode = ara::log::LogMode::kRemote;
    LogConfig logConfig = { "SCFI", "HwFr671RadarRight context",
...
bool Hwfr671radarrightLogger::DoesFileExist(const ara::core::String& filePath)
{
...
bool Hwfr671radarrightLogger::IsDirType(const mode_t& fileMode)
{
    if (S_ISDIR(fileMode)) {
        return true;
    }
