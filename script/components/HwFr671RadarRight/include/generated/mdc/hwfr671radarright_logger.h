 ...
 */
#ifndef ARA_HWFR671RADARRIGHT_HWFR671RADARRIGHT_LOGGER_H
#define ARA_HWFR671RADARRIGHT_HWFR671RADARRIGHT_LOGGER_H
#include <cstdint>
#include <string>
#include <map>
#include <mutex>
...
class Hwfr671radarrightLogger {
public:
    virtual ~Hwfr671radarrightLogger() = default;
     ...
     * ara::hwfr671radarright::Hwfr671radarrightLogger::GetLoggerIns("PER")->LogError() << "*******";
...
private:
    Hwfr671radarrightLogger() = default;
...
#endif  /* ARA_HWFR671RADARRIGHT_HWFR671RADARRIGHT_LOGGER_H */