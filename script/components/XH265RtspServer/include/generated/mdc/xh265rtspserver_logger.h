 ...
 */
#ifndef ARA_XH265RTSPSERVER_XH265RTSPSERVER_LOGGER_H
#define ARA_XH265RTSPSERVER_XH265RTSPSERVER_LOGGER_H
#include <cstdint>
#include <string>
#include <map>
#include <mutex>
...
class Xh265rtspserverLogger {
public:
    virtual ~Xh265rtspserverLogger() = default;
     ...
     * ara::xh265rtspserver::Xh265rtspserverLogger::GetLoggerIns("PER")->LogError() << "*******";
...
#endif  /* ARA_XH265RTSPSERVER_XH265RTSPSERVER_LOGGER_H */