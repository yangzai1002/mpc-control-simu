...
LogConfig XdatatriggerrecorderLogger::logConfig_ = {"Xdatatriggerrecorder",
    "XDataTriggerRecorder context", "", ara::log::LogLevel::kInfo, ara::log::LogMode::kRemote};
std::map<ara::core::String, ara::core::String> XdatatriggerrecorderLogger::ctxMap_;
std::map<ara::core::String, ara::log::Logger*> XdatatriggerrecorderLogger::loggerCtxMap_;
std::mutex XdatatriggerrecorderLogger::ctxMapMutex_;
std::mutex XdatatriggerrecorderLogger::loggerCtxMapMutex_;

void XdatatriggerrecorderLogger::SetLogConfig()
{
    logConfig_ = ParseLogConfig();
}

/* 此方法应在main函数调用 */
void XdatatriggerrecorderLogger::InitAppLogging()
{
    SetLogConfig();
...
void XdatatriggerrecorderLogger::InitLoggerCtx(const ara::core::String& ctxId = logConfig_.appId,
...
ara::log::Logger* XdatatriggerrecorderLogger::GetLogCtxInstance(const ara::core::String& ctxId,
...
ara::core::String XdatatriggerrecorderLogger::GetSpecifyLogConfig(const ara::core::String& logTraceName,
...
ara::core::Vector<ara::core::String> XdatatriggerrecorderLogger::GetSpecifyLogMode(
...
ara::log::LogLevel XdatatriggerrecorderLogger::GetLogLevel(const ara::core::String& level)
{
    if (level == "info") {
...
ara::log::LogMode XdatatriggerrecorderLogger::GetLogMode(const ara::core::Vector<ara::core::String>& modeVec)
{
...
LogConfig XdatatriggerrecorderLogger::ParseLogConfig()
{
    ara::core::String filePath {};
    ara::log::LogMode kLogMode = ara::log::LogMode::kRemote;
    LogConfig logConfig = { "SCFI", "XDataTriggerRecorder context",
...
bool XdatatriggerrecorderLogger::DoesFileExist(const ara::core::String& filePath)
{
...
bool XdatatriggerrecorderLogger::IsDirType(const mode_t& fileMode)
{
    if (S_ISDIR(fileMode)) {
        return true;
    }
