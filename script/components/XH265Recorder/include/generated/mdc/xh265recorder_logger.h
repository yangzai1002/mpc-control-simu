 ...
 */
#ifndef ARA_XH265RECORDER_XH265RECORDER_LOGGER_H
#define ARA_XH265RECORDER_XH265RECORDER_LOGGER_H
#include <cstdint>
#include <string>
#include <map>
#include <mutex>
...
public:
     ...
     * ara::xh265recorder::Xh265recorderLogger::GetLoggerIns("PER")->LogError() << "*******";
...
#endif  /* ARA_XH265RECORDER_XH265RECORDER_LOGGER_H */