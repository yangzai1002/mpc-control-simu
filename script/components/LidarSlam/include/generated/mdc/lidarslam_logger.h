 ...
 */
#ifndef ARA_LIDARSLAM_LIDARSLAM_LOGGER_H
#define ARA_LIDARSLAM_LIDARSLAM_LOGGER_H
#include <cstdint>
#include <string>
#include <map>
#include <mutex>
...
class LidarslamLogger {
public:
    virtual ~LidarslamLogger() = default;
     ...
     * ara::lidarslam::LidarslamLogger::GetLoggerIns("PER")->LogError() << "*******";
...
#endif  /* ARA_LIDARSLAM_LIDARSLAM_LOGGER_H */