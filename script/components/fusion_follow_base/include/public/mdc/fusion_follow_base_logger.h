 ...
 */
#ifndef ARA_FUSION_FOLLOW_BASE_FUSION_FOLLOW_BASE_LOGGER_H
#define ARA_FUSION_FOLLOW_BASE_FUSION_FOLLOW_BASE_LOGGER_H
#include <cstdint>
#include <string>
#include <map>
#include <mutex>
...
class FusionFollowBaseLogger {
public:
    virtual ~FusionFollowBaseLogger() = default;
     ...
     * ara::fusion_follow_base::FusionFollowBaseLogger::GetLoggerIns("PER")->LogError() << "*******";
...
private:
    FusionFollowBaseLogger() = default;
...
#endif  /* ARA_FUSION_FOLLOW_BASE_FUSION_FOLLOW_BASE_LOGGER_H */