 ...
 */
#ifndef ARA_HWCAMERALIST_HWCAMERALIST_LOGGER_H
#define ARA_HWCAMERALIST_HWCAMERALIST_LOGGER_H
#include <cstdint>
#include <string>
#include <map>
#include <mutex>
...
class HwcameralistLogger {
public:
    virtual ~HwcameralistLogger() = default;
     ...
     * ara::hwcameralist::HwcameralistLogger::GetLoggerIns("PER")->LogError() << "*******";
...
#endif  /* ARA_HWCAMERALIST_HWCAMERALIST_LOGGER_H */