...
LogConfig LidardetectionLogger::logConfig_ = {"Lidardetection",
    "LidarDetection context", "", ara::log::LogLevel::kInfo, ara::log::LogMode::kRemote};
std::map<ara::core::String, ara::core::String> LidardetectionLogger::ctxMap_;
std::map<ara::core::String, ara::log::Logger*> LidardetectionLogger::loggerCtxMap_;
std::mutex LidardetectionLogger::ctxMapMutex_;
std::mutex LidardetectionLogger::loggerCtxMapMutex_;

void LidardetectionLogger::SetLogConfig()
{
    logConfig_ = ParseLogConfig();
}

/* 此方法应在main函数调用 */
void LidardetectionLogger::InitAppLogging()
{
    SetLogConfig();
...
void LidardetectionLogger::InitLoggerCtx(const ara::core::String& ctxId = logConfig_.appId,
...
ara::log::Logger* LidardetectionLogger::GetLogCtxInstance(const ara::core::String& ctxId,
...
ara::core::String LidardetectionLogger::GetSpecifyLogConfig(const ara::core::String& logTraceName,
...
ara::core::Vector<ara::core::String> LidardetectionLogger::GetSpecifyLogMode(
...
ara::log::LogLevel LidardetectionLogger::GetLogLevel(const ara::core::String& level)
{
    if (level == "info") {
...
ara::log::LogMode LidardetectionLogger::GetLogMode(const ara::core::Vector<ara::core::String>& modeVec)
{
...
LogConfig LidardetectionLogger::ParseLogConfig()
{
    ara::core::String filePath {};
    ara::log::LogMode kLogMode = ara::log::LogMode::kRemote;
    LogConfig logConfig = { "SCFI", "LidarDetection context",
...
bool LidardetectionLogger::DoesFileExist(const ara::core::String& filePath)
{
...
bool LidardetectionLogger::IsDirType(const mode_t& fileMode)
{
    if (S_ISDIR(fileMode)) {
        return true;
    }
