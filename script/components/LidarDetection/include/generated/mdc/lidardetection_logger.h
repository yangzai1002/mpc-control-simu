 ...
 */
#ifndef ARA_LIDARDETECTION_LIDARDETECTION_LOGGER_H
#define ARA_LIDARDETECTION_LIDARDETECTION_LOGGER_H
#include <cstdint>
#include <string>
#include <map>
#include <mutex>
...
class LidardetectionLogger {
public:
    virtual ~LidardetectionLogger() = default;
     ...
     * ara::lidardetection::LidardetectionLogger::GetLoggerIns("PER")->LogError() << "*******";
...
#endif  /* ARA_LIDARDETECTION_LIDARDETECTION_LOGGER_H */