 ...
 */
#ifndef ARA_VEHICLECHASSISRECV_VEHICLECHASSISRECV_LOGGER_H
#define ARA_VEHICLECHASSISRECV_VEHICLECHASSISRECV_LOGGER_H
#include <cstdint>
#include <string>
#include <map>
#include <mutex>
...
class VehiclechassisrecvLogger {
public:
    virtual ~VehiclechassisrecvLogger() = default;
     ...
     * ara::vehiclechassisrecv::VehiclechassisrecvLogger::GetLoggerIns("PER")->LogError() << "*******";
...
private:
    VehiclechassisrecvLogger() = default;
...
#endif  /* ARA_VEHICLECHASSISRECV_VEHICLECHASSISRECV_LOGGER_H */