 ...
 */
#ifndef ARA_XH265_ENCODER_XH265_ENCODER_LOGGER_H
#define ARA_XH265_ENCODER_XH265_ENCODER_LOGGER_H
#include <cstdint>
#include <string>
#include <map>
#include <mutex>
...
class Xh265EncoderLogger {
public:
    virtual ~Xh265EncoderLogger() = default;
     ...
     * ara::xh265_encoder::Xh265EncoderLogger::GetLoggerIns("PER")->LogError() << "*******";
...
#endif  /* ARA_XH265_ENCODER_XH265_ENCODER_LOGGER_H */