 ...
 */
#ifndef ARA_XZMQ_RC_XZMQ_RC_LOGGER_H
#define ARA_XZMQ_RC_XZMQ_RC_LOGGER_H
#include <cstdint>
#include <string>
#include <map>
#include <mutex>
...
public:
     ...
     * ara::xzmq_rc::XzmqRcLogger::GetLoggerIns("PER")->LogError() << "*******";
...
#endif  /* ARA_XZMQ_RC_XZMQ_RC_LOGGER_H */