 ...
 */
#ifndef ARA_XVEHICLESTATUSRECORDER_XVEHICLESTATUSRECORDER_LOGGER_H
#define ARA_XVEHICLESTATUSRECORDER_XVEHICLESTATUSRECORDER_LOGGER_H
#include <cstdint>
#include <string>
#include <map>
#include <mutex>
...
class XvehiclestatusrecorderLogger {
public:
    virtual ~XvehiclestatusrecorderLogger() = default;
     ...
     * ara::xvehiclestatusrecorder::XvehiclestatusrecorderLogger::GetLoggerIns("PER")->LogError() << "*******";
...
private:
    XvehiclestatusrecorderLogger() = default;
...
#endif  /* ARA_XVEHICLESTATUSRECORDER_XVEHICLESTATUSRECORDER_LOGGER_H */