 ...
 */
#ifndef ARA_SENSORVISUALIZE_SENSORVISUALIZE_LOGGER_H
#define ARA_SENSORVISUALIZE_SENSORVISUALIZE_LOGGER_H
#include <cstdint>
#include <string>
#include <map>
#include <mutex>
...
class SensorvisualizeLogger {
public:
    virtual ~SensorvisualizeLogger() = default;
     ...
     * ara::sensorvisualize::SensorvisualizeLogger::GetLoggerIns("PER")->LogError() << "*******";
...
#endif  /* ARA_SENSORVISUALIZE_SENSORVISUALIZE_LOGGER_H */