    ...
    void Init() {
        ...
        std::thread([&]() {
            ...
            if (socket_can_transmitter_ptr->get_sock_fd() < 0) {
                std::cout << "establish can_sock failed" << std::endl;
                ec_add("1011001", "establish can_sock failed");
                // exit(0);
            } else {
                ec_remove("1011001");
                ...
                while (true) {
                    ...
                    {
                        std::cout << "ReadCanFrame error" << std::endl;
			nedd_check_remove = ec_add("1011002", "ReadCanFrame error", 3);
        ...
        std::thread([&]() {
            ...
            if (socket_can_transmitter_ptr->get_sock_fd() < 0) {
                std::cout << "establish wheel_speed can_sock failed" << std::endl;
                ec_add("1011001", "establish wheel_speed can_sock failed");
                // exit(0);
            } else {
                ec_remove("1011001");
                static bool nedd_check_remove = false;
                ...
                while (true) {
                    ...
                    if (socket_can_transmitter_ptr->ReadCanFrame(can_frame_rev) == -1)
                    {
                        std::cout << "ReadCanFrame of wheel_speed error" << std::endl;
			nedd_check_remove = ec_add("1011002", "ReadCanFrame of wheel_speed error", 3);
                        must_check_remove_cnt = 0;
                    }
                    else
                    {
	    ...
	    static bool     nedd_check_remove_1011005 = false;
                    ...
                    switch (can_frame_prepare.id & CAN_EFF_MASK) {
                        case 0x02020001:
                            ...
                            if (gnss_parse_.status < 4) {
                                nedd_check_remove_1011005 = ec_add("1011005", "location status < 4", 3);
                        ...
                        case 0x02020003:
                            ...
                            {
				                nedd_check_remove_1011013 = ec_add("1011013", "not ins loction", 3);
                        ...
                        case 0x02020004:
                            ...
                            {
				                nedd_check_remove_1011015 = ec_add("1011015", "gyro_x error", 3);
                            ...
                            {
				                nedd_check_remove_1011016 = ec_add("1011016", "gyro_y error", 3);
                            ...
                            {
				                nedd_check_remove_1011017 = ec_add("1011017", "gyro_z error", 3);
                            ...
                            {
				                nedd_check_remove_1011018 = ec_add("1011018", "acc_x error", 3);
                            ...
                            {
				                nedd_check_remove_1011019 = ec_add("1011019", "acc_y error", 3);
                            ...
                            {
				                nedd_check_remove_1011020 = ec_add("1011020", "acc_z error", 3);
                            ...
                            {
				                nedd_check_remove_1011021 = ec_add("1011021", "can not recv gps heading data", 3);
                            ...
                            {
				                nedd_check_remove_1011022 = ec_add("1011022", "other imu error", 3);
                        ...
                        case 0x02020007:
                            ...
                            if(loc_fusion_parse_.lat<360 && loc_fusion_parse_.lon<360 && loc_fusion_parse_.v>-1)
                            {
                                ...
                                if(loc_fusion_parse_.v>0.01)
                                {
                                    ...
                                    {
                                        nedd_check_remove_1011006 = ec_add("1011006", "ins loc fluctuation", 3);
                        ...
                        case 0x02030003:
                            ...
                            {
                                nedd_check_remove_1011004 = ec_add("1011004", "ins_loc&gps_loc's differ too large");
		    ...
		    nedd_check_remove_1011003 = ec_add("1011003", "lost data exceed 3s");
...
public:
    bool ec_add(const std::string &ec, const std::string &extar_info, uint8_t threshold = 1) {
        static timeval tv = {};
        gettimeofday(&tv, nullptr);
