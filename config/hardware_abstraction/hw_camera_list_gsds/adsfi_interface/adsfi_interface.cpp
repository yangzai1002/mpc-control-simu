...
void AdsfiInterface::Init()  {
    ...
    std::cout << "================== n_out_1 is " << n_out_1 << " ==================" << std::endl;
    std::cout << "================== debug is " << debug << " ==================" << std::endl;
    std::cout << "================== format is " << format << " ==================" << std::endl;
    std::cout << "================== hw_fps is " << hw_fps << " ==================" << std::endl;
    std::cout << "[HZ] init START" << std::endl;
    std::cout << "channelId str is " << channelId << std::endl;
    ...
    printf("================== main_idx is %d  ==================\n", main_idx);
    printf("================== nv_cam_pos is %d  ==================\n", mdc_camera_interface_ptr->nv_cam_pos);
    printf("================== enable_nv_cam is %d  ==================\n", mdc_camera_interface_ptr->enable_nv_cam);
    printf("================== node_name is %s  ==================\n", mdc_camera_interface_ptr->node_name.c_str());
    printf("================== so_name is %s  ==================\n", so_name.c_str());
    mdc_camera_interface_ptr->so_path = project_config_path + "/config/" + so_name;
    printf("================== so_path is %s  ==================\n", mdc_camera_interface_ptr->so_path.c_str());
    AINFO << "=========================================== so_path: " << mdc_camera_interface_ptr->so_path
            << " ===========================================";
    ...
    printf("================== channel_en_ is %s, str_len is: %d, channel_en_mask_ is: %d ==================\n",
            mdc_camera_interface_ptr->channel_en_.c_str(), mdc_camera_interface_ptr->channel_en_.size(),
            mdc_camera_interface_ptr->channel_en_mask_);
    ...
    std::thread([&]() {
        ...
        while (true) {
            ...
            if (mdc_camera_interface_ptr->enable_nv_cam) {
                if (nv_cam_pos_read != mdc_camera_interface_ptr->nv_cam_pos) {
            ...
            if (main_idx_read != mdc_camera_interface_ptr->main_idx_) {
            ...
            if (channel_en_read != mdc_camera_interface_ptr->channel_en_) {
...
//             ptr->images[i].dataSize = compressed_camera_data_ptr->m_camera_data_list[mdc_camera_interface_ptr->data_idx_[i]].m_ptr_len;
//             ptr->images[i].frameData.resize(compressed_camera_data_ptr->m_camera_data_list[mdc_camera_interface_ptr->data_idx_[i]].m_ptr_len);
//             memcpy(ptr->images[i].frameData.data(), compressed_camera_data_ptr->m_camera_data_list[mdc_camera_interface_ptr->data_idx_[i]].m_ptr,
//                          compressed_camera_data_ptr->m_camera_data_list[mdc_camera_interface_ptr->data_idx_[i]].m_ptr_len;);
//             ptr->images[i].timestamp = SecondsToMsgHafTime(compressed_camera_data_ptr->m_camera_data_list[mdc_camera_interface_ptr->data_idx_[i]].m_fsyncTimeStamp);
//             ptr->images[i].seq = SecondsToMsgHafTime(mdc_camera_interface_ptr->channal_shm_buf_m[mdc_camera_interface_ptr->data_idx_[i]].write_seq.load());
//             if(mdc_camera_interface_ptr->main_idx_ == mdc_camera_interface_ptr->data_idx_[i])
//             {
//                 main_idx_in_vec = i;
//             }
//         }
//         ptr->header.timestamp = ptr->images[main_idx_in_vec].header.timestamp;
//     } else if (0 < n_out_1) {
//         if (compressed_seq % n_out_1 == 0) {
//             for (int i = 0; i < mdc_camera_interface_ptr->data_idx_.size(); i++) {
//                 if (debug & 16) {
...
//         printf(
//             "============================= MdcCameraList func loop once, seq: %d, ts: %.3f "
//             "=============================\n\n",
//             seq, cur_ts);
//     }
// }
