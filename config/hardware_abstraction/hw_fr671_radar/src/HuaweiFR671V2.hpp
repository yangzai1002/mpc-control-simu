    ...
    void Init(int sensor_id, int interval_ms) {
        while (true)
        {
            ...
            if (false == ret)
            {
                ...
                ec_add("1072024", "ping radar failed", 20);
            }
            else
            {
        ...
        std::thread([&]() {
            while (true) {
                ...
                if (false == ret) {
                    ...
                    ec_add("1072024", "ping radar failed", 3);
                } else {
                    ec_remove("1072024", 3);
                }
                usleep(1000 * 1000);
        ...
        std::thread([&]()
        {
            ...
            if (ret < 0)
            {
                ...
                ec_add("1072003", "hear_beat_client Init failed");
                // exit(0);
            }
            else
            {
        ...
        std::thread([&]()
        {
            ...
            if (ret < 0)
            {
                ...
                ec_add("1072003", "vehicle_client Init failed");
                // exit(0);
            }
            else
            {
        ...
        std::thread([&]()
        {
            ...
            if (multicase_udp.Init(data_config) != 0)
            {
                ...
                ec_add("1072003", "multicase_udp Init failed");
                // exit(-1);
            ...
            else
            {
                ...
                while (true)
                {
                    ...
                    {
                        ec_add("1072004", "recv udp data failed", 5);
                    }
        ...
        std::thread([&]()
		{
            ...
            if (multicase_udp.Init(data_config) != 0)
            {
                ...
                ec_add("1072003", "err_code multicase_udp Init failed");
                // exit(-1);
                printf("err_code multicase_udp Init failed\n");
            }
            else
            {
                ec_remove("1072003");
                ...
                while (true)
                {
                    ...
                    {
                        ec_add("1072012", "nvmErrorSt check failed", 3);
                    }
                    else
                    {
                        ec_remove("1072012", 3);
                    ...
                    {
                        ec_add("1072013", "fatalErrorSt check failed", 3);
                    }
                    else
                    {
                        ec_remove("1072013", 3);
                    ...
                    {
                        ec_add("1072014", "generalErrorSt check failed", 3);
                    }
                    else
                    {
                        ec_remove("1072014", 3);
                    ...
                    if(err_code->tempAlarmSt)
                    {
                        ...
                        ec_add("1072015", "tempAlarmSt check failed, level "+err_info, 3);
                    }
                    else
                    {
                        ec_remove("1072015", 3);
                    ...
                    if(err_code->voltageAlarmSt)
                    {
                        ...
                        ec_add("1072016", "voltageAlarmSt check failed, level "+err_info, 3);
                    }
                    else
                    {
                        ec_remove("1072016", 3);
                    ...
                    {
                        ec_add("1072017", "interferenceSt check failed", 3);
                    }
                    else
                    {
                        ec_remove("1072017", 3);
                    ...
                    if(err_code->blockAlarmSt)
                    {
                        ...
                        ec_add("1072018", "blockAlarmSt check failed, level "+err_info, 3);
                    }
                    else
                    {
                        ec_remove("1072018", 3);
                    ...
                    {
                        ec_add("1072019", "velInfoSt check failed", 3);
                    }
                    else
                    {
                        ec_remove("1072019", 3);
                    ...
                    if(err_code->eleAxisErrSt)
                    {
                        ...
                        ec_add("1072020", "eleAxisErrSt check failed, level "+err_info, 3);
                    }
                    else
                    {
                        ec_remove("1072020", 3);
                    ...
                    {
                        ec_add("1072021", "cfgAbnormalSt check failed", 3);
                    }
                    else
                    {
                        ec_remove("1072021", 3);
                    ...
                    {
                        ec_add("1072022", "unCalAlarm check failed", 3);
                    }
                    else
                    {
                        ec_remove("1072022", 3);
                    ...
                    {
                        ec_add("1072023", "TsnSynSt check failed", 3);
                    }
                    else
                    {
                        ec_remove("1072023", 3);
