...
private:
    ...
    void ConstructSkeleton(const ara::com::MethodCallProcessingMode mode)
    {
        ...
        const ara::core::Result<void> resultTrajetoryPredictionEvent = TrajetoryPredictionEvent.Initialize();
...
public:
    ...
    public:
        explicit ConstructionToken(const ara::com::InstanceIdentifier& instanceId,
            ...
            : processMode(mode),
              ptr(std::make_unique<ara::com::internal::skeleton::SkeletonAdapter>(::mdc::adsfi::TrajetoryPredictionInterface::ServiceIdentifier, instanceId, mode)),
              TrajetoryPredictionEvent(ptr->GetSkeleton(), events::TrajetoryPredictionInterfaceTrajetoryPredictionEventId, ::mdc::adsfi::TrajetoryPredictionInterface::ServiceIdentifier, instanceId){
        }

        explicit ConstructionToken(const ara::core::InstanceSpecifier& instanceSpec,
            const ara::com::MethodCallProcessingMode mode = ara::com::MethodCallProcessingMode::kEvent)
            : processMode(mode),
              ptr(std::make_unique<ara::com::internal::skeleton::SkeletonAdapter>(::mdc::adsfi::TrajetoryPredictionInterface::ServiceIdentifier, instanceSpec, mode)),
              TrajetoryPredictionEvent(ptr->GetSkeleton(), events::TrajetoryPredictionInterfaceTrajetoryPredictionEventId, ::mdc::adsfi::TrajetoryPredictionInterface::ServiceIdentifier, instanceSpec){
        }

        explicit ConstructionToken(const ara::com::InstanceIdentifierContainer instanceContainer,
            const ara::com::MethodCallProcessingMode mode = ara::com::MethodCallProcessingMode::kEvent)
            : processMode(mode),
              ptr(std::make_unique<ara::com::internal::skeleton::SkeletonAdapter>(::mdc::adsfi::TrajetoryPredictionInterface::ServiceIdentifier, instanceContainer, mode)),
              TrajetoryPredictionEvent(ptr->GetSkeleton(), events::TrajetoryPredictionInterfaceTrajetoryPredictionEventId, ::mdc::adsfi::TrajetoryPredictionInterface::ServiceIdentifier, instanceContainer){
        }

        ConstructionToken(ConstructionToken&& other)
            : processMode(std::move(other.processMode)),
              ptr(std::move(other.ptr)),
              TrajetoryPredictionEvent(std::move(other.TrajetoryPredictionEvent)){
        }
        ...
        events::TrajetoryPredictionEvent GetTrajetoryPredictionEvent()
        {
            return std::move(TrajetoryPredictionEvent);
        }
        ara::core::Result<void> Initialize()
        {
            ...
            do {
                ...
                initResult = TrajetoryPredictionEvent.Initialize();
    ...
    explicit TrajetoryPredictionInterfaceSkeleton(const ara::com::InstanceIdentifier& instanceId,
        ...
        : skeletonAdapter(std::make_unique<ara::com::internal::skeleton::SkeletonAdapter>(::mdc::adsfi::TrajetoryPredictionInterface::ServiceIdentifier, instanceId, mode)),
          TrajetoryPredictionEvent(skeletonAdapter->GetSkeleton(), events::TrajetoryPredictionInterfaceTrajetoryPredictionEventId, ::mdc::adsfi::TrajetoryPredictionInterface::ServiceIdentifier, instanceId){
    ...
    explicit TrajetoryPredictionInterfaceSkeleton(const ara::core::InstanceSpecifier& instanceSpec,
        ...
        :skeletonAdapter(std::make_unique<ara::com::internal::skeleton::SkeletonAdapter>(::mdc::adsfi::TrajetoryPredictionInterface::ServiceIdentifier, instanceSpec, mode)),
          TrajetoryPredictionEvent(skeletonAdapter->GetSkeleton(), events::TrajetoryPredictionInterfaceTrajetoryPredictionEventId, ::mdc::adsfi::TrajetoryPredictionInterface::ServiceIdentifier, instanceSpec){
        ConstructSkeleton(mode);
    }
    ...
    explicit TrajetoryPredictionInterfaceSkeleton(const ara::com::InstanceIdentifierContainer instanceContainer,
        ...
        :skeletonAdapter(std::make_unique<ara::com::internal::skeleton::SkeletonAdapter>(::mdc::adsfi::TrajetoryPredictionInterface::ServiceIdentifier, instanceContainer, mode)),
          TrajetoryPredictionEvent(skeletonAdapter->GetSkeleton(), events::TrajetoryPredictionInterfaceTrajetoryPredictionEventId, ::mdc::adsfi::TrajetoryPredictionInterface::ServiceIdentifier, instanceContainer){
        ConstructSkeleton(mode);
    }
