...
public:
    ...
    McuReportFault(const std::shared_ptr<rtf::cm::vcc::Proxy>& proxy, const ara::com::internal::EntityId entityId, const rtf::cm::type::ServiceInterfaceInfo& serviceInterfaceInfo)
...
public:
    ...
    public:
        explicit ConstructionToken(const std::shared_ptr<ara::com::internal::proxy::ProxyAdapter> & proxy)
            : proxyAdapter(proxy),
              McuReportFault(proxyAdapter->GetProxy(), methods::FmMcuReportFaultServiceMcuReportFaultId, proxyAdapter->GetServiceInterfaceInfo()){
        }
        ...
        ara::core::Result<void> InitializeAll()
        {
            ...
            initResult = McuReportFault.GetMethodAdapter()->Initialize();
        ...
        methods::McuReportFault GetMcuReportFault() noexcept { return std::move(McuReportFault); }
    private:
        std::shared_ptr<ara::com::internal::proxy::ProxyAdapter> proxyAdapter;
    ...
    explicit FmMcuReportFaultServiceProxy(const HandleType &handle)
        : proxyAdapter(std::make_shared<ara::com::internal::proxy::ProxyAdapter>(::mdc::fm::FmMcuReportFaultService::ServiceIdentifier, handle)),
          McuReportFault(proxyAdapter->GetProxy(), methods::FmMcuReportFaultServiceMcuReportFaultId, proxyAdapter->GetServiceInterfaceInfo()){
            ara::core::Result<void> resultMcuReportFault = McuReportFault.GetMethodAdapter()->Initialize();
    ...
    FmMcuReportFaultServiceProxy(ConstructionToken&& token) noexcept
        : proxyAdapter(token.GetProxyAdapter()),
          McuReportFault(token.GetMcuReportFault()){
        ...
        const ara::com::HandleType &handle)
    {
        ...
        if (initResult.HasValue()) {
            ...
            ara::core::Result<FmMcuReportFaultServiceProxy::ConstructionToken> preResult{errorcode};
            return preResult;
        }
    }
