...
public:
    ...
    public:
        explicit ConstructionToken(const std::shared_ptr<ara::com::internal::proxy::ProxyAdapter> & proxy)
            : proxyAdapter(proxy),
              Data(proxyAdapter->GetProxy(), events::DiagComNotifierDataId, proxyAdapter->GetHandle(), proxyAdapter->GetServiceInterfaceInfo()){
        }
        ...
        events::Data GetData() noexcept { return std::move(Data); }
    private:
        std::shared_ptr<ara::com::internal::proxy::ProxyAdapter> proxyAdapter;
        events::Data Data;
    };
    ...
    explicit DiagComNotifierProxy(const HandleType &handle)
        : proxyAdapter(std::make_shared<ara::com::internal::proxy::ProxyAdapter>(::ara::diag::DiagComNotifier::ServiceIdentifier, handle)),
          Data(proxyAdapter->GetProxy(), events::DiagComNotifierDataId, proxyAdapter->GetHandle(), proxyAdapter->GetServiceInterfaceInfo()){
        }
        ...
        const ara::com::HandleType &handle)
    {
        ...
        if (initResult.HasValue()) {
            ...
            ara::core::Result<DiagComNotifierProxy::ConstructionToken> preResult{errorcode};
            return preResult;
        }
    }
