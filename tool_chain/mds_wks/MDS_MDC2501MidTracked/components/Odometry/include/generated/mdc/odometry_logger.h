 ...
 */
#ifndef ARA_ODOMETRY_ODOMETRY_LOGGER_H
#define ARA_ODOMETRY_ODOMETRY_LOGGER_H
#include <cstdint>
#include <string>
#include <map>
#include <mutex>
...
public:
    virtual ~OdometryLogger() = default;
     ...
     * ara::odometry::OdometryLogger::GetLoggerIns("PER")->LogError() << "*******";
...
#endif  /* ARA_ODOMETRY_ODOMETRY_LOGGER_H */