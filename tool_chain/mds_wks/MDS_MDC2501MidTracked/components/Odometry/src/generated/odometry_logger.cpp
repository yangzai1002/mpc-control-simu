...
LogConfig OdometryLogger::logConfig_ = {"Odometry",
    "Odometry context", "", ara::log::LogLevel::kInfo, ara::log::LogMode::kRemote};
std::map<ara::core::String, ara::core::String> OdometryLogger::ctxMap_;
std::map<ara::core::String, ara::log::Logger*> OdometryLogger::loggerCtxMap_;
std::mutex OdometryLogger::ctxMapMutex_;
std::mutex OdometryLogger::loggerCtxMapMutex_;

void OdometryLogger::SetLogConfig()
{
    logConfig_ = ParseLogConfig();
}

/* 此方法应在main函数调用 */
void OdometryLogger::InitAppLogging()
{
    SetLogConfig();
...
void OdometryLogger::InitLoggerCtx(const ara::core::String& ctxId = logConfig_.appId,
...
ara::log::Logger* OdometryLogger::GetLogCtxInstance(const ara::core::String& ctxId,
...
ara::core::String OdometryLogger::GetSpecifyLogConfig(const ara::core::String& logTraceName,
...
ara::core::Vector<ara::core::String> OdometryLogger::GetSpecifyLogMode(
...
ara::log::LogLevel OdometryLogger::GetLogLevel(const ara::core::String& level)
{
    if (level == "info") {
...
ara::log::LogMode OdometryLogger::GetLogMode(const ara::core::Vector<ara::core::String>& modeVec)
{
...
LogConfig OdometryLogger::ParseLogConfig()
{
    ara::core::String filePath {};
    ara::log::LogMode kLogMode = ara::log::LogMode::kRemote;
    LogConfig logConfig = { "SCFI", "Odometry context",
...
bool OdometryLogger::DoesFileExist(const ara::core::String& filePath)
{
...
bool OdometryLogger::IsDirType(const mode_t& fileMode)
{
    if (S_ISDIR(fileMode)) {
        return true;
    }
