...
namespace mdc {
namespace rtspserverswc {

LogConfig RtspserverswcLogger::logConfig_ = {"Rtspserverswc",
    "rtspserverswc context", "", ara::log::LogLevel::kInfo, ara::log::LogMode::kRemote};
std::map<ara::core::String, ara::core::String> RtspserverswcLogger::ctxMap_;
std::map<ara::core::String, ara::log::Logger*> RtspserverswcLogger::loggerCtxMap_;
std::mutex RtspserverswcLogger::ctxMapMutex_;
std::mutex RtspserverswcLogger::loggerCtxMapMutex_;

void RtspserverswcLogger::SetLogConfig()
{
    logConfig_ = ParseLogConfig();
}

/* 此方法应在main函数调用 */
void RtspserverswcLogger::InitAppLogging()
{
    SetLogConfig();
...
void RtspserverswcLogger::InitLoggerCtx(const ara::core::String& ctxId = logConfig_.appId,
...
ara::log::Logger* RtspserverswcLogger::GetLogCtxInstance(const ara::core::String& ctxId,
...
ara::core::String RtspserverswcLogger::GetSpecifyLogConfig(const ara::core::String& logTraceName,
...
ara::core::Vector<ara::core::String> RtspserverswcLogger::GetSpecifyLogMode(
...
ara::log::LogLevel RtspserverswcLogger::GetLogLevel(const ara::core::String& level)
{
    if (level == "info") {
...
ara::log::LogMode RtspserverswcLogger::GetLogMode(const ara::core::Vector<ara::core::String>& modeVec)
{
...
LogConfig RtspserverswcLogger::ParseLogConfig()
{
    ara::core::String filePath {};
    ara::log::LogMode kLogMode = ara::log::LogMode::kRemote;
    LogConfig logConfig = { "SCFI", "rtspserverswc context",
...
bool RtspserverswcLogger::DoesFileExist(const ara::core::String& filePath)
{
...
bool RtspserverswcLogger::IsDirType(const mode_t& fileMode)
{
    if (S_ISDIR(fileMode)) {
        return true;
    }
