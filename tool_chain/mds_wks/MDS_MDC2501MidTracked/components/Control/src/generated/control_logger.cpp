...
LogConfig ControlLogger::logConfig_ = {"Control",
    "Control context", "", ara::log::LogLevel::kInfo, ara::log::LogMode::kRemote};
std::map<ara::core::String, ara::core::String> ControlLogger::ctxMap_;
std::map<ara::core::String, ara::log::Logger*> ControlLogger::loggerCtxMap_;
std::mutex ControlLogger::ctxMapMutex_;
std::mutex ControlLogger::loggerCtxMapMutex_;

void ControlLogger::SetLogConfig()
{
    logConfig_ = ParseLogConfig();
}

/* 此方法应在main函数调用 */
void ControlLogger::InitAppLogging()
{
    SetLogConfig();
...
void ControlLogger::InitLoggerCtx(const ara::core::String& ctxId = logConfig_.appId,
...
ara::log::Logger* ControlLogger::GetLogCtxInstance(const ara::core::String& ctxId,
...
ara::core::String ControlLogger::GetSpecifyLogConfig(const ara::core::String& logTraceName,
...
ara::core::Vector<ara::core::String> ControlLogger::GetSpecifyLogMode(
...
ara::log::LogLevel ControlLogger::GetLogLevel(const ara::core::String& level)
{
    if (level == "info") {
...
ara::log::LogMode ControlLogger::GetLogMode(const ara::core::Vector<ara::core::String>& modeVec)
{
...
LogConfig ControlLogger::ParseLogConfig()
{
    ara::core::String filePath {};
    ara::log::LogMode kLogMode = ara::log::LogMode::kRemote;
    LogConfig logConfig = { "SCFI", "Control context",
...
bool ControlLogger::DoesFileExist(const ara::core::String& filePath)
{
...
bool ControlLogger::IsDirType(const mode_t& fileMode)
{
    if (S_ISDIR(fileMode)) {
        return true;
    }
