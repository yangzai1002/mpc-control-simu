...
LogConfig SensorvisualizeLogger::logConfig_ = {"Sensorvisualize",
    "SensorVisualize context", "", ara::log::LogLevel::kInfo, ara::log::LogMode::kRemote};
std::map<ara::core::String, ara::core::String> SensorvisualizeLogger::ctxMap_;
std::map<ara::core::String, ara::log::Logger*> SensorvisualizeLogger::loggerCtxMap_;
std::mutex SensorvisualizeLogger::ctxMapMutex_;
std::mutex SensorvisualizeLogger::loggerCtxMapMutex_;

void SensorvisualizeLogger::SetLogConfig()
{
    logConfig_ = ParseLogConfig();
}

/* 此方法应在main函数调用 */
void SensorvisualizeLogger::InitAppLogging()
{
    SetLogConfig();
...
void SensorvisualizeLogger::InitLoggerCtx(const ara::core::String& ctxId = logConfig_.appId,
...
ara::log::Logger* SensorvisualizeLogger::GetLogCtxInstance(const ara::core::String& ctxId,
...
ara::core::String SensorvisualizeLogger::GetSpecifyLogConfig(const ara::core::String& logTraceName,
...
ara::core::Vector<ara::core::String> SensorvisualizeLogger::GetSpecifyLogMode(
...
ara::log::LogLevel SensorvisualizeLogger::GetLogLevel(const ara::core::String& level)
{
    if (level == "info") {
...
ara::log::LogMode SensorvisualizeLogger::GetLogMode(const ara::core::Vector<ara::core::String>& modeVec)
{
...
LogConfig SensorvisualizeLogger::ParseLogConfig()
{
    ara::core::String filePath {};
    ara::log::LogMode kLogMode = ara::log::LogMode::kRemote;
    LogConfig logConfig = { "SCFI", "SensorVisualize context",
...
bool SensorvisualizeLogger::DoesFileExist(const ara::core::String& filePath)
{
...
bool SensorvisualizeLogger::IsDirType(const mode_t& fileMode)
{
    if (S_ISDIR(fileMode)) {
        return true;
    }
