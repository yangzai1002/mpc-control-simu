 ...
 */
#ifndef ARA_HW_FR671_RADAR_HW_FR671_RADAR_LOGGER_H
#define ARA_HW_FR671_RADAR_HW_FR671_RADAR_LOGGER_H
#include <cstdint>
#include <string>
#include <map>
#include <mutex>
...
class HwFr671RadarLogger {
public:
    virtual ~HwFr671RadarLogger() = default;
     ...
     * ara::hw_fr671_radar::HwFr671RadarLogger::GetLoggerIns("PER")->LogError() << "*******";
...
#endif  /* ARA_HW_FR671_RADAR_HW_FR671_RADAR_LOGGER_H */