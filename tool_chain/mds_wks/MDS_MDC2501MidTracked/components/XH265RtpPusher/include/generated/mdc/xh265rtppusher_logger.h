 ...
 */
#ifndef ARA_XH265RTPPUSHER_XH265RTPPUSHER_LOGGER_H
#define ARA_XH265RTPPUSHER_XH265RTPPUSHER_LOGGER_H
#include <cstdint>
#include <string>
#include <map>
#include <mutex>
...
public:
     ...
     * ara::xh265rtppusher::Xh265rtppusherLogger::GetLoggerIns("PER")->LogError() << "*******";
...
#endif  /* ARA_XH265RTPPUSHER_XH265RTPPUSHER_LOGGER_H */