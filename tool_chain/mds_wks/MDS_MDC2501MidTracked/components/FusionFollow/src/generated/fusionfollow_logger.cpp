...
LogConfig FusionfollowLogger::logConfig_ = {"Fusionfollow",
    "FusionFollow context", "", ara::log::LogLevel::kInfo, ara::log::LogMode::kRemote};
std::map<ara::core::String, ara::core::String> FusionfollowLogger::ctxMap_;
std::map<ara::core::String, ara::log::Logger*> FusionfollowLogger::loggerCtxMap_;
std::mutex FusionfollowLogger::ctxMapMutex_;
std::mutex FusionfollowLogger::loggerCtxMapMutex_;

void FusionfollowLogger::SetLogConfig()
{
    logConfig_ = ParseLogConfig();
}

/* 此方法应在main函数调用 */
void FusionfollowLogger::InitAppLogging()
{
    SetLogConfig();
...
void FusionfollowLogger::InitLoggerCtx(const ara::core::String& ctxId = logConfig_.appId,
...
ara::log::Logger* FusionfollowLogger::GetLogCtxInstance(const ara::core::String& ctxId,
...
ara::core::String FusionfollowLogger::GetSpecifyLogConfig(const ara::core::String& logTraceName,
...
ara::core::Vector<ara::core::String> FusionfollowLogger::GetSpecifyLogMode(
...
ara::log::LogLevel FusionfollowLogger::GetLogLevel(const ara::core::String& level)
{
    if (level == "info") {
...
ara::log::LogMode FusionfollowLogger::GetLogMode(const ara::core::Vector<ara::core::String>& modeVec)
{
...
LogConfig FusionfollowLogger::ParseLogConfig()
{
    ara::core::String filePath {};
    ara::log::LogMode kLogMode = ara::log::LogMode::kRemote;
    LogConfig logConfig = { "SCFI", "FusionFollow context",
...
bool FusionfollowLogger::DoesFileExist(const ara::core::String& filePath)
{
...
bool FusionfollowLogger::IsDirType(const mode_t& fileMode)
{
    if (S_ISDIR(fileMode)) {
        return true;
    }
