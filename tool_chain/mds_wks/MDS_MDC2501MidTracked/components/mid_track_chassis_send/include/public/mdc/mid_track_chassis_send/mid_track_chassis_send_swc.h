...
#ifndef MDC_MIDTRACKCHASSISSENDSWC_H
#define MDC_MIDTRACKCHASSISSENDSWC_H
...
class MidTrackChassisSendSwC {
public:
    explicit MidTrackChassisSendSwC();

    virtual ~MidTrackChassisSendSwC();
...
#endif  /* MDC_MIDTRACKCHASSISSENDSWC_H */