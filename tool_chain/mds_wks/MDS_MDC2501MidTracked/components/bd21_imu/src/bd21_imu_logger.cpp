...
LogConfig Bd21ImuLogger::logConfig_ = {"Bd21Imu",
    "bd21_imu context", "", ara::log::LogLevel::kInfo, ara::log::LogMode::kRemote};
std::map<ara::core::String, ara::core::String> Bd21ImuLogger::ctxMap_;
std::map<ara::core::String, ara::log::Logger*> Bd21ImuLogger::loggerCtxMap_;
std::mutex Bd21ImuLogger::ctxMapMutex_;
std::mutex Bd21ImuLogger::loggerCtxMapMutex_;

void Bd21ImuLogger::SetLogConfig()
{
    logConfig_ = ParseLogConfig();
}

/* 此方法应在main函数调用 */
void Bd21ImuLogger::InitAppLogging()
{
    SetLogConfig();
...
void Bd21ImuLogger::InitLoggerCtx(const ara::core::String& ctxId = logConfig_.appId,
...
ara::log::Logger* Bd21ImuLogger::GetLogCtxInstance(const ara::core::String& ctxId,
...
ara::core::String Bd21ImuLogger::GetSpecifyLogConfig(const ara::core::String& logTraceName,
...
ara::core::Vector<ara::core::String> Bd21ImuLogger::GetSpecifyLogMode(
...
ara::log::LogLevel Bd21ImuLogger::GetLogLevel(const ara::core::String& level)
{
    if (level == "info") {
...
ara::log::LogMode Bd21ImuLogger::GetLogMode(const ara::core::Vector<ara::core::String>& modeVec)
{
...
LogConfig Bd21ImuLogger::ParseLogConfig()
{
    ara::core::String filePath {};
    ara::log::LogMode kLogMode = ara::log::LogMode::kRemote;
    LogConfig logConfig = { "SCFI", "bd21_imu context",
...
bool Bd21ImuLogger::DoesFileExist(const ara::core::String& filePath)
{
...
bool Bd21ImuLogger::IsDirType(const mode_t& fileMode)
{
    if (S_ISDIR(fileMode)) {
        return true;
    }
