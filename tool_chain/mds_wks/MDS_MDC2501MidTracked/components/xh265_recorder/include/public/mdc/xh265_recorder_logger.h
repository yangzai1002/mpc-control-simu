 ...
 */
#ifndef ARA_XH265_RECORDER_XH265_RECORDER_LOGGER_H
#define ARA_XH265_RECORDER_XH265_RECORDER_LOGGER_H
#include <cstdint>
#include <string>
#include <map>
#include <mutex>
...
class Xh265RecorderLogger {
public:
    virtual ~Xh265RecorderLogger() = default;
     ...
     * ara::xh265_recorder::Xh265RecorderLogger::GetLoggerIns("PER")->LogError() << "*******";
...
#endif  /* ARA_XH265_RECORDER_XH265_RECORDER_LOGGER_H */