 ...
 */
#ifndef ARA_DRIVERDEVNULL_DRIVERDEVNULL_LOGGER_H
#define ARA_DRIVERDEVNULL_DRIVERDEVNULL_LOGGER_H
#include <cstdint>
#include <string>
#include <map>
#include <mutex>
...
public:
     ...
     * ara::driverdevnull::DriverdevnullLogger::GetLoggerIns("PER")->LogError() << "*******";
...
#endif  /* ARA_DRIVERDEVNULL_DRIVERDEVNULL_LOGGER_H */