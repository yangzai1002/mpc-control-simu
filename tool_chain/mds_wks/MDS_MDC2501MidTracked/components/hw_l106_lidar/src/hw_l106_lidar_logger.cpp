...
LogConfig HwL106LidarLogger::logConfig_ = {"HwL106Lidar",
    "hw_l106_lidar context", "", ara::log::LogLevel::kInfo, ara::log::LogMode::kRemote};
std::map<ara::core::String, ara::core::String> HwL106LidarLogger::ctxMap_;
std::map<ara::core::String, ara::log::Logger*> HwL106LidarLogger::loggerCtxMap_;
std::mutex HwL106LidarLogger::ctxMapMutex_;
std::mutex HwL106LidarLogger::loggerCtxMapMutex_;

void HwL106LidarLogger::SetLogConfig()
{
    logConfig_ = ParseLogConfig();
}

/* 此方法应在main函数调用 */
void HwL106LidarLogger::InitAppLogging()
{
    SetLogConfig();
...
void HwL106LidarLogger::InitLoggerCtx(const ara::core::String& ctxId = logConfig_.appId,
...
ara::log::Logger* HwL106LidarLogger::GetLogCtxInstance(const ara::core::String& ctxId,
...
ara::core::String HwL106LidarLogger::GetSpecifyLogConfig(const ara::core::String& logTraceName,
...
ara::core::Vector<ara::core::String> HwL106LidarLogger::GetSpecifyLogMode(
...
ara::log::LogLevel HwL106LidarLogger::GetLogLevel(const ara::core::String& level)
{
    if (level == "info") {
...
ara::log::LogMode HwL106LidarLogger::GetLogMode(const ara::core::Vector<ara::core::String>& modeVec)
{
...
LogConfig HwL106LidarLogger::ParseLogConfig()
{
    ara::core::String filePath {};
    ara::log::LogMode kLogMode = ara::log::LogMode::kRemote;
    LogConfig logConfig = { "SCFI", "hw_l106_lidar context",
...
bool HwL106LidarLogger::DoesFileExist(const ara::core::String& filePath)
{
...
bool HwL106LidarLogger::IsDirType(const mode_t& fileMode)
{
    if (S_ISDIR(fileMode)) {
        return true;
    }
