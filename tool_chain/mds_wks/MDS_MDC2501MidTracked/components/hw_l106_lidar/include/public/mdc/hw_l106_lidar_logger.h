 ...
 */
#ifndef ARA_HW_L106_LIDAR_HW_L106_LIDAR_LOGGER_H
#define ARA_HW_L106_LIDAR_HW_L106_LIDAR_LOGGER_H
#include <cstdint>
#include <string>
#include <map>
#include <mutex>
...
class HwL106LidarLogger {
public:
    virtual ~HwL106LidarLogger() = default;
     ...
     * ara::hw_l106_lidar::HwL106LidarLogger::GetLoggerIns("PER")->LogError() << "*******";
...
#endif  /* ARA_HW_L106_LIDAR_HW_L106_LIDAR_LOGGER_H */