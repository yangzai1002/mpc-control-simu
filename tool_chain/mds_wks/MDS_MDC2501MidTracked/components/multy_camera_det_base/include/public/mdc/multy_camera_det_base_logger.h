 ...
 */
#ifndef ARA_MULTY_CAMERA_DET_BASE_MULTY_CAMERA_DET_BASE_LOGGER_H
#define ARA_MULTY_CAMERA_DET_BASE_MULTY_CAMERA_DET_BASE_LOGGER_H
#include <cstdint>
#include <string>
#include <map>
#include <mutex>
...
class MultyCameraDetBaseLogger {
public:
    virtual ~MultyCameraDetBaseLogger() = default;
     ...
     * ara::multy_camera_det_base::MultyCameraDetBaseLogger::GetLoggerIns("PER")->LogError() << "*******";
...
private:
    MultyCameraDetBaseLogger() = default;
...
#endif  /* ARA_MULTY_CAMERA_DET_BASE_MULTY_CAMERA_DET_BASE_LOGGER_H */