...
LogConfig MultyCameraDetBaseLogger::logConfig_ = {"MultyCameraDetBase",
    "multy_camera_det_base context", "", ara::log::LogLevel::kInfo, ara::log::LogMode::kRemote};
std::map<ara::core::String, ara::core::String> MultyCameraDetBaseLogger::ctxMap_;
std::map<ara::core::String, ara::log::Logger*> MultyCameraDetBaseLogger::loggerCtxMap_;
std::mutex MultyCameraDetBaseLogger::ctxMapMutex_;
std::mutex MultyCameraDetBaseLogger::loggerCtxMapMutex_;

void MultyCameraDetBaseLogger::SetLogConfig()
{
    logConfig_ = ParseLogConfig();
}

/* 此方法应在main函数调用 */
void MultyCameraDetBaseLogger::InitAppLogging()
{
    SetLogConfig();
...
void MultyCameraDetBaseLogger::InitLoggerCtx(const ara::core::String& ctxId = logConfig_.appId,
...
ara::log::Logger* MultyCameraDetBaseLogger::GetLogCtxInstance(const ara::core::String& ctxId,
...
ara::core::String MultyCameraDetBaseLogger::GetSpecifyLogConfig(const ara::core::String& logTraceName,
...
ara::core::Vector<ara::core::String> MultyCameraDetBaseLogger::GetSpecifyLogMode(
...
ara::log::LogLevel MultyCameraDetBaseLogger::GetLogLevel(const ara::core::String& level)
{
    if (level == "info") {
...
ara::log::LogMode MultyCameraDetBaseLogger::GetLogMode(const ara::core::Vector<ara::core::String>& modeVec)
{
...
LogConfig MultyCameraDetBaseLogger::ParseLogConfig()
{
    ara::core::String filePath {};
    ara::log::LogMode kLogMode = ara::log::LogMode::kRemote;
    LogConfig logConfig = { "SCFI", "multy_camera_det_base context",
...
bool MultyCameraDetBaseLogger::DoesFileExist(const ara::core::String& filePath)
{
...
bool MultyCameraDetBaseLogger::IsDirType(const mode_t& fileMode)
{
    if (S_ISDIR(fileMode)) {
        return true;
    }
