 ...
 */
#ifndef ARA_HWL106LIDARFRONT_HWL106LIDARFRONT_LOGGER_H
#define ARA_HWL106LIDARFRONT_HWL106LIDARFRONT_LOGGER_H
#include <cstdint>
#include <string>
#include <map>
#include <mutex>
...
class Hwl106lidarfrontLogger {
public:
    virtual ~Hwl106lidarfrontLogger() = default;
     ...
     * ara::hwl106lidarfront::Hwl106lidarfrontLogger::GetLoggerIns("PER")->LogError() << "*******";
...
private:
    Hwl106lidarfrontLogger() = default;
...
#endif  /* ARA_HWL106LIDARFRONT_HWL106LIDARFRONT_LOGGER_H */