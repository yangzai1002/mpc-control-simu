...
namespace mdc {
namespace xh265_encoder {

LogConfig Xh265EncoderLogger::logConfig_ = {"Xh265Encoder",
    "xh265_encoder context", "", ara::log::LogLevel::kInfo, ara::log::LogMode::kRemote};
std::map<ara::core::String, ara::core::String> Xh265EncoderLogger::ctxMap_;
std::map<ara::core::String, ara::log::Logger*> Xh265EncoderLogger::loggerCtxMap_;
std::mutex Xh265EncoderLogger::ctxMapMutex_;
std::mutex Xh265EncoderLogger::loggerCtxMapMutex_;

void Xh265EncoderLogger::SetLogConfig()
{
    logConfig_ = ParseLogConfig();
}

/* 此方法应在main函数调用 */
void Xh265EncoderLogger::InitAppLogging()
{
    SetLogConfig();
...
void Xh265EncoderLogger::InitLoggerCtx(const ara::core::String& ctxId = logConfig_.appId,
...
ara::log::Logger* Xh265EncoderLogger::GetLogCtxInstance(const ara::core::String& ctxId,
...
ara::core::String Xh265EncoderLogger::GetSpecifyLogConfig(const ara::core::String& logTraceName,
...
ara::core::Vector<ara::core::String> Xh265EncoderLogger::GetSpecifyLogMode(
...
ara::log::LogLevel Xh265EncoderLogger::GetLogLevel(const ara::core::String& level)
{
    if (level == "info") {
...
ara::log::LogMode Xh265EncoderLogger::GetLogMode(const ara::core::Vector<ara::core::String>& modeVec)
{
...
LogConfig Xh265EncoderLogger::ParseLogConfig()
{
    ara::core::String filePath {};
    ara::log::LogMode kLogMode = ara::log::LogMode::kRemote;
    LogConfig logConfig = { "SCFI", "xh265_encoder context",
...
bool Xh265EncoderLogger::DoesFileExist(const ara::core::String& filePath)
{
...
bool Xh265EncoderLogger::IsDirType(const mode_t& fileMode)
{
    if (S_ISDIR(fileMode)) {
        return true;
    }
