...
LogConfig XdataTriggerRecorderBaseLogger::logConfig_ = {"XdataTriggerRecorderBase",
    "xdata_trigger_recorder_base context", "", ara::log::LogLevel::kInfo, ara::log::LogMode::kRemote};
std::map<ara::core::String, ara::core::String> XdataTriggerRecorderBaseLogger::ctxMap_;
std::map<ara::core::String, ara::log::Logger*> XdataTriggerRecorderBaseLogger::loggerCtxMap_;
std::mutex XdataTriggerRecorderBaseLogger::ctxMapMutex_;
std::mutex XdataTriggerRecorderBaseLogger::loggerCtxMapMutex_;

void XdataTriggerRecorderBaseLogger::SetLogConfig()
{
    logConfig_ = ParseLogConfig();
}

/* 此方法应在main函数调用 */
void XdataTriggerRecorderBaseLogger::InitAppLogging()
{
    SetLogConfig();
...
void XdataTriggerRecorderBaseLogger::InitLoggerCtx(const ara::core::String& ctxId = logConfig_.appId,
...
ara::log::Logger* XdataTriggerRecorderBaseLogger::GetLogCtxInstance(const ara::core::String& ctxId,
...
ara::core::String XdataTriggerRecorderBaseLogger::GetSpecifyLogConfig(const ara::core::String& logTraceName,
...
ara::core::Vector<ara::core::String> XdataTriggerRecorderBaseLogger::GetSpecifyLogMode(
...
ara::log::LogLevel XdataTriggerRecorderBaseLogger::GetLogLevel(const ara::core::String& level)
{
    if (level == "info") {
...
ara::log::LogMode XdataTriggerRecorderBaseLogger::GetLogMode(const ara::core::Vector<ara::core::String>& modeVec)
{
...
LogConfig XdataTriggerRecorderBaseLogger::ParseLogConfig()
{
    ara::core::String filePath {};
    ara::log::LogMode kLogMode = ara::log::LogMode::kRemote;
    LogConfig logConfig = { "SCFI", "xdata_trigger_recorder_base context",
...
bool XdataTriggerRecorderBaseLogger::DoesFileExist(const ara::core::String& filePath)
{
...
bool XdataTriggerRecorderBaseLogger::IsDirType(const mode_t& fileMode)
{
    if (S_ISDIR(fileMode)) {
        return true;
    }
