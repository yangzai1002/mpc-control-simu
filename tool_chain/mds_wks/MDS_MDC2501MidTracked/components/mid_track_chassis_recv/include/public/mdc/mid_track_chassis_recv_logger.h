 ...
 */
#ifndef ARA_MID_TRACK_CHASSIS_RECV_MID_TRACK_CHASSIS_RECV_LOGGER_H
#define ARA_MID_TRACK_CHASSIS_RECV_MID_TRACK_CHASSIS_RECV_LOGGER_H
#include <cstdint>
#include <string>
#include <map>
#include <mutex>
...
class MidTrackChassisRecvLogger {
public:
    virtual ~MidTrackChassisRecvLogger() = default;
     ...
     * ara::mid_track_chassis_recv::MidTrackChassisRecvLogger::GetLoggerIns("PER")->LogError() << "*******";
...
private:
    MidTrackChassisRecvLogger() = default;
...
#endif  /* ARA_MID_TRACK_CHASSIS_RECV_MID_TRACK_CHASSIS_RECV_LOGGER_H */