 ...
 */
#include "mdc/fusion_semantic_map_base_logger.h"
#include <cstring>
#include <fstream>
#include <climits>
#include <sys/stat.h>
...
LogConfig FusionSemanticMapBaseLogger::logConfig_ = {"FusionSemanticMapBase",
    "fusion_semantic_map_base context", "", ara::log::LogLevel::kInfo, ara::log::LogMode::kRemote};
std::map<ara::core::String, ara::core::String> FusionSemanticMapBaseLogger::ctxMap_;
std::map<ara::core::String, ara::log::Logger*> FusionSemanticMapBaseLogger::loggerCtxMap_;
std::mutex FusionSemanticMapBaseLogger::ctxMapMutex_;
std::mutex FusionSemanticMapBaseLogger::loggerCtxMapMutex_;

void FusionSemanticMapBaseLogger::SetLogConfig()
{
    logConfig_ = ParseLogConfig();
}

/* 此方法应在main函数调用 */
void FusionSemanticMapBaseLogger::InitAppLogging()
{
    SetLogConfig();
...
void FusionSemanticMapBaseLogger::InitLoggerCtx(const ara::core::String& ctxId = logConfig_.appId,
...
ara::log::Logger* FusionSemanticMapBaseLogger::GetLogCtxInstance(const ara::core::String& ctxId,
...
ara::core::String FusionSemanticMapBaseLogger::GetSpecifyLogConfig(const ara::core::String& logTraceName,
...
ara::core::Vector<ara::core::String> FusionSemanticMapBaseLogger::GetSpecifyLogMode(
...
ara::log::LogLevel FusionSemanticMapBaseLogger::GetLogLevel(const ara::core::String& level)
{
    if (level == "info") {
...
ara::log::LogMode FusionSemanticMapBaseLogger::GetLogMode(const ara::core::Vector<ara::core::String>& modeVec)
{
...
LogConfig FusionSemanticMapBaseLogger::ParseLogConfig()
{
    ara::core::String filePath {};
    ara::log::LogMode kLogMode = ara::log::LogMode::kRemote;
    LogConfig logConfig = { "SCFI", "fusion_semantic_map_base context",
...
bool FusionSemanticMapBaseLogger::DoesFileExist(const ara::core::String& filePath)
{
...
bool FusionSemanticMapBaseLogger::IsDirType(const mode_t& fileMode)
{
    if (S_ISDIR(fileMode)) {
        return true;
    }
