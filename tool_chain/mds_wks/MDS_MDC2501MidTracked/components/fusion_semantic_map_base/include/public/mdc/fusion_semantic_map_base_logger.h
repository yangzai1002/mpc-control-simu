 ...
 */
#ifndef ARA_FUSION_SEMANTIC_MAP_BASE_FUSION_SEMANTIC_MAP_BASE_LOGGER_H
#define ARA_FUSION_SEMANTIC_MAP_BASE_FUSION_SEMANTIC_MAP_BASE_LOGGER_H
#include <cstdint>
#include <string>
#include <map>
#include <mutex>
...
class FusionSemanticMapBaseLogger {
public:
    virtual ~FusionSemanticMapBaseLogger() = default;
     ...
     * ara::fusion_semantic_map_base::FusionSemanticMapBaseLogger::GetLoggerIns("PER")->LogError() << "*******";
...
private:
    FusionSemanticMapBaseLogger() = default;
...
#endif  /* ARA_FUSION_SEMANTIC_MAP_BASE_FUSION_SEMANTIC_MAP_BASE_LOGGER_H */