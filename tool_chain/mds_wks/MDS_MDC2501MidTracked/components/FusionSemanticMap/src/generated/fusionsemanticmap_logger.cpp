...
namespace mdc {
namespace fusionsemanticmap {

LogConfig FusionsemanticmapLogger::logConfig_ = {"Fusionsemanticmap",
    "FusionSemanticMap context", "", ara::log::LogLevel::kInfo, ara::log::LogMode::kRemote};
std::map<ara::core::String, ara::core::String> FusionsemanticmapLogger::ctxMap_;
std::map<ara::core::String, ara::log::Logger*> FusionsemanticmapLogger::loggerCtxMap_;
std::mutex FusionsemanticmapLogger::ctxMapMutex_;
std::mutex FusionsemanticmapLogger::loggerCtxMapMutex_;

void FusionsemanticmapLogger::SetLogConfig()
{
    logConfig_ = ParseLogConfig();
}

/* 此方法应在main函数调用 */
void FusionsemanticmapLogger::InitAppLogging()
{
    SetLogConfig();
...
void FusionsemanticmapLogger::InitLoggerCtx(const ara::core::String& ctxId = logConfig_.appId,
...
ara::log::Logger* FusionsemanticmapLogger::GetLogCtxInstance(const ara::core::String& ctxId,
...
ara::core::String FusionsemanticmapLogger::GetSpecifyLogConfig(const ara::core::String& logTraceName,
...
ara::core::Vector<ara::core::String> FusionsemanticmapLogger::GetSpecifyLogMode(
...
ara::log::LogLevel FusionsemanticmapLogger::GetLogLevel(const ara::core::String& level)
{
    if (level == "info") {
...
ara::log::LogMode FusionsemanticmapLogger::GetLogMode(const ara::core::Vector<ara::core::String>& modeVec)
{
...
LogConfig FusionsemanticmapLogger::ParseLogConfig()
{
    ara::core::String filePath {};
    ara::log::LogMode kLogMode = ara::log::LogMode::kRemote;
    LogConfig logConfig = { "SCFI", "FusionSemanticMap context",
...
bool FusionsemanticmapLogger::DoesFileExist(const ara::core::String& filePath)
{
...
bool FusionsemanticmapLogger::IsDirType(const mode_t& fileMode)
{
    if (S_ISDIR(fileMode)) {
        return true;
    }
