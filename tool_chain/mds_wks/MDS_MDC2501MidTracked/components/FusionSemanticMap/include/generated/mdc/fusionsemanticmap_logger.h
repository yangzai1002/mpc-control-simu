 ...
 */
#ifndef ARA_FUSIONSEMANTICMAP_FUSIONSEMANTICMAP_LOGGER_H
#define ARA_FUSIONSEMANTICMAP_FUSIONSEMANTICMAP_LOGGER_H
#include <cstdint>
#include <string>
#include <map>
#include <mutex>
...
class FusionsemanticmapLogger {
public:
    virtual ~FusionsemanticmapLogger() = default;
     ...
     * ara::fusionsemanticmap::FusionsemanticmapLogger::GetLoggerIns("PER")->LogError() << "*******";
...
private:
    FusionsemanticmapLogger() = default;
...
#endif  /* ARA_FUSIONSEMANTICMAP_FUSIONSEMANTICMAP_LOGGER_H */