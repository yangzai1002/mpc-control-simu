...
LogConfig XzmqRcLogger::logConfig_ = {"XzmqRc",
    "xzmq_rc context", "", ara::log::LogLevel::kInfo, ara::log::LogMode::kRemote};
std::map<ara::core::String, ara::core::String> XzmqRcLogger::ctxMap_;
std::map<ara::core::String, ara::log::Logger*> XzmqRcLogger::loggerCtxMap_;
std::mutex XzmqRcLogger::ctxMapMutex_;
std::mutex XzmqRcLogger::loggerCtxMapMutex_;

void XzmqRcLogger::SetLogConfig()
{
    logConfig_ = ParseLogConfig();
}

/* 此方法应在main函数调用 */
void XzmqRcLogger::InitAppLogging()
{
    SetLogConfig();
...
void XzmqRcLogger::InitLoggerCtx(const ara::core::String& ctxId = logConfig_.appId,
...
ara::log::Logger* XzmqRcLogger::GetLogCtxInstance(const ara::core::String& ctxId,
...
ara::core::String XzmqRcLogger::GetSpecifyLogConfig(const ara::core::String& logTraceName,
...
ara::core::Vector<ara::core::String> XzmqRcLogger::GetSpecifyLogMode(
...
ara::log::LogLevel XzmqRcLogger::GetLogLevel(const ara::core::String& level)
{
    if (level == "info") {
...
ara::log::LogMode XzmqRcLogger::GetLogMode(const ara::core::Vector<ara::core::String>& modeVec)
{
...
LogConfig XzmqRcLogger::ParseLogConfig()
{
    ara::core::String filePath {};
    ara::log::LogMode kLogMode = ara::log::LogMode::kRemote;
    LogConfig logConfig = { "SCFI", "xzmq_rc context",
...
bool XzmqRcLogger::DoesFileExist(const ara::core::String& filePath)
{
...
bool XzmqRcLogger::IsDirType(const mode_t& fileMode)
{
    if (S_ISDIR(fileMode)) {
        return true;
    }
