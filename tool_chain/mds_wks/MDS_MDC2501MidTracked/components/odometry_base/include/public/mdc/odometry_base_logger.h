 ...
 */
#ifndef ARA_ODOMETRY_BASE_ODOMETRY_BASE_LOGGER_H
#define ARA_ODOMETRY_BASE_ODOMETRY_BASE_LOGGER_H
#include <cstdint>
#include <string>
#include <map>
#include <mutex>
...
class OdometryBaseLogger {
public:
    virtual ~OdometryBaseLogger() = default;
     ...
     * ara::odometry_base::OdometryBaseLogger::GetLoggerIns("PER")->LogError() << "*******";
...
#endif  /* ARA_ODOMETRY_BASE_ODOMETRY_BASE_LOGGER_H */