...
LogConfig OdometryBaseLogger::logConfig_ = {"OdometryBase",
    "odometry_base context", "", ara::log::LogLevel::kInfo, ara::log::LogMode::kRemote};
std::map<ara::core::String, ara::core::String> OdometryBaseLogger::ctxMap_;
std::map<ara::core::String, ara::log::Logger*> OdometryBaseLogger::loggerCtxMap_;
std::mutex OdometryBaseLogger::ctxMapMutex_;
std::mutex OdometryBaseLogger::loggerCtxMapMutex_;

void OdometryBaseLogger::SetLogConfig()
{
    logConfig_ = ParseLogConfig();
}

/* 此方法应在main函数调用 */
void OdometryBaseLogger::InitAppLogging()
{
    SetLogConfig();
...
void OdometryBaseLogger::InitLoggerCtx(const ara::core::String& ctxId = logConfig_.appId,
...
ara::log::Logger* OdometryBaseLogger::GetLogCtxInstance(const ara::core::String& ctxId,
...
ara::core::String OdometryBaseLogger::GetSpecifyLogConfig(const ara::core::String& logTraceName,
...
ara::core::Vector<ara::core::String> OdometryBaseLogger::GetSpecifyLogMode(
...
ara::log::LogLevel OdometryBaseLogger::GetLogLevel(const ara::core::String& level)
{
    if (level == "info") {
...
ara::log::LogMode OdometryBaseLogger::GetLogMode(const ara::core::Vector<ara::core::String>& modeVec)
{
...
LogConfig OdometryBaseLogger::ParseLogConfig()
{
    ara::core::String filePath {};
    ara::log::LogMode kLogMode = ara::log::LogMode::kRemote;
    LogConfig logConfig = { "SCFI", "odometry_base context",
...
bool OdometryBaseLogger::DoesFileExist(const ara::core::String& filePath)
{
...
bool OdometryBaseLogger::IsDirType(const mode_t& fileMode)
{
    if (S_ISDIR(fileMode)) {
        return true;
    }
