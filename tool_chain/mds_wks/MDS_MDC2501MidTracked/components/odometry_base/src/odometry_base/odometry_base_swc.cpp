...
OdometryBaseSwC::OdometryBaseSwC()
    : initFlag_(false),
      workFlag_(true),
...
std::shared_ptr<LocationInfoIntfServer> OdometryBaseSwC::GetLocationInfoIntfServer(const ara::core::String& portName)
{
...
std::shared_ptr<SensorWheelSpeedServiceInterfaceClient> OdometryBaseSwC::GetSensorWheelSpeedServiceInterfaceClient(const ara::core::String& portName)
{
...
std::shared_ptr<SensorImuServiceInterfaceClient> OdometryBaseSwC::GetSensorImuServiceInterfaceClient(const ara::core::String& portName)
{
...
std::shared_ptr<LocationServiceInterfaceClient> OdometryBaseSwC::GetLocationServiceInterfaceClient(const ara::core::String& portName)
{
...
std::shared_ptr<SensorGpsServiceInterfaceClient> OdometryBaseSwC::GetSensorGpsServiceInterfaceClient(const ara::core::String& portName)
{
...
bool OdometryBaseSwC::LoadConfig()
{
    /* 通过环境变量获取配置文件路径 */
...
bool OdometryBaseSwC::DoesFileExist(const ara::core::String& filePath)
{
...
bool OdometryBaseSwC::IsDirType(const mode_t& fileMode)
{
    if (S_ISDIR(fileMode)) {
        return true;
    }
...
bool OdometryBaseSwC::ParsingInstanceId(const std::unique_ptr<MdcYamlNode>& config)
{
    if (!config->HasKeyValue("odometry_base")) {
        LOG_SPACE::GetLoggerIns("SWC")->LogError() << "Cannot find odometry_base in config file!";
        return false;
    }
    auto swcConfig = (*(config.get()))["odometry_base"];
    /* server agent */
