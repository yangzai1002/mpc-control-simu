...
LogConfig LidarTerrainMapDetectionLogger::logConfig_ = {"LidarTerrainMapDetection",
    "lidar_terrain_map_detection context", "", ara::log::LogLevel::kInfo, ara::log::LogMode::kRemote};
std::map<ara::core::String, ara::core::String> LidarTerrainMapDetectionLogger::ctxMap_;
std::map<ara::core::String, ara::log::Logger*> LidarTerrainMapDetectionLogger::loggerCtxMap_;
std::mutex LidarTerrainMapDetectionLogger::ctxMapMutex_;
std::mutex LidarTerrainMapDetectionLogger::loggerCtxMapMutex_;

void LidarTerrainMapDetectionLogger::SetLogConfig()
{
    logConfig_ = ParseLogConfig();
}

/* 此方法应在main函数调用 */
void LidarTerrainMapDetectionLogger::InitAppLogging()
{
    SetLogConfig();
...
void LidarTerrainMapDetectionLogger::InitLoggerCtx(const ara::core::String& ctxId = logConfig_.appId,
...
ara::log::Logger* LidarTerrainMapDetectionLogger::GetLogCtxInstance(const ara::core::String& ctxId,
...
ara::core::String LidarTerrainMapDetectionLogger::GetSpecifyLogConfig(const ara::core::String& logTraceName,
...
ara::core::Vector<ara::core::String> LidarTerrainMapDetectionLogger::GetSpecifyLogMode(
...
ara::log::LogLevel LidarTerrainMapDetectionLogger::GetLogLevel(const ara::core::String& level)
{
    if (level == "info") {
...
ara::log::LogMode LidarTerrainMapDetectionLogger::GetLogMode(const ara::core::Vector<ara::core::String>& modeVec)
{
...
LogConfig LidarTerrainMapDetectionLogger::ParseLogConfig()
{
    ara::core::String filePath {};
    ara::log::LogMode kLogMode = ara::log::LogMode::kRemote;
    LogConfig logConfig = { "SCFI", "lidar_terrain_map_detection context",
...
bool LidarTerrainMapDetectionLogger::DoesFileExist(const ara::core::String& filePath)
{
...
bool LidarTerrainMapDetectionLogger::IsDirType(const mode_t& fileMode)
{
    if (S_ISDIR(fileMode)) {
        return true;
    }
