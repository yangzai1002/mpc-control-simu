 ...
 */
#ifndef ARA_LIDAR_TERRAIN_MAP_DETECTION_LIDAR_TERRAIN_MAP_DETECTION_LOGGER_H
#define ARA_LIDAR_TERRAIN_MAP_DETECTION_LIDAR_TERRAIN_MAP_DETECTION_LOGGER_H
#include <cstdint>
#include <string>
#include <map>
#include <mutex>
...
class LidarTerrainMapDetectionLogger {
public:
    virtual ~LidarTerrainMapDetectionLogger() = default;
     ...
     * ara::lidar_terrain_map_detection::LidarTerrainMapDetectionLogger::GetLoggerIns("PER")->LogError() << "*******";
...
private:
    LidarTerrainMapDetectionLogger() = default;
...
#endif  /* ARA_LIDAR_TERRAIN_MAP_DETECTION_LIDAR_TERRAIN_MAP_DETECTION_LOGGER_H */