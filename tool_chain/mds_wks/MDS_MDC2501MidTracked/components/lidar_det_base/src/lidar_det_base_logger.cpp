...
LogConfig LidarDetBaseLogger::logConfig_ = {"LidarDetBase",
    "lidar_det_base context", "", ara::log::LogLevel::kInfo, ara::log::LogMode::kRemote};
std::map<ara::core::String, ara::core::String> LidarDetBaseLogger::ctxMap_;
std::map<ara::core::String, ara::log::Logger*> LidarDetBaseLogger::loggerCtxMap_;
std::mutex LidarDetBaseLogger::ctxMapMutex_;
std::mutex LidarDetBaseLogger::loggerCtxMapMutex_;

void LidarDetBaseLogger::SetLogConfig()
{
    logConfig_ = ParseLogConfig();
}

/* 此方法应在main函数调用 */
void LidarDetBaseLogger::InitAppLogging()
{
    SetLogConfig();
...
void LidarDetBaseLogger::InitLoggerCtx(const ara::core::String& ctxId = logConfig_.appId,
...
ara::log::Logger* LidarDetBaseLogger::GetLogCtxInstance(const ara::core::String& ctxId,
...
ara::core::String LidarDetBaseLogger::GetSpecifyLogConfig(const ara::core::String& logTraceName,
...
ara::core::Vector<ara::core::String> LidarDetBaseLogger::GetSpecifyLogMode(
...
ara::log::LogLevel LidarDetBaseLogger::GetLogLevel(const ara::core::String& level)
{
    if (level == "info") {
...
ara::log::LogMode LidarDetBaseLogger::GetLogMode(const ara::core::Vector<ara::core::String>& modeVec)
{
...
LogConfig LidarDetBaseLogger::ParseLogConfig()
{
    ara::core::String filePath {};
    ara::log::LogMode kLogMode = ara::log::LogMode::kRemote;
    LogConfig logConfig = { "SCFI", "lidar_det_base context",
...
bool LidarDetBaseLogger::DoesFileExist(const ara::core::String& filePath)
{
...
bool LidarDetBaseLogger::IsDirType(const mode_t& fileMode)
{
    if (S_ISDIR(fileMode)) {
        return true;
    }
