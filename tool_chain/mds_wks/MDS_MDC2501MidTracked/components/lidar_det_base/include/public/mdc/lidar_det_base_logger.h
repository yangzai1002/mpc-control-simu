 ...
 */
#ifndef ARA_LIDAR_DET_BASE_LIDAR_DET_BASE_LOGGER_H
#define ARA_LIDAR_DET_BASE_LIDAR_DET_BASE_LOGGER_H
#include <cstdint>
#include <string>
#include <map>
#include <mutex>
...
class LidarDetBaseLogger {
public:
    virtual ~LidarDetBaseLogger() = default;
     ...
     * ara::lidar_det_base::LidarDetBaseLogger::GetLoggerIns("PER")->LogError() << "*******";
...
#endif  /* ARA_LIDAR_DET_BASE_LIDAR_DET_BASE_LOGGER_H */