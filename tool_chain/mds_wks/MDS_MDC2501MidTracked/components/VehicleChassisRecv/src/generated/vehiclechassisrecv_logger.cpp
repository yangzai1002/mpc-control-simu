...
LogConfig VehiclechassisrecvLogger::logConfig_ = {"Vehiclechassisrecv",
    "VehicleChassisRecv context", "", ara::log::LogLevel::kInfo, ara::log::LogMode::kRemote};
std::map<ara::core::String, ara::core::String> VehiclechassisrecvLogger::ctxMap_;
std::map<ara::core::String, ara::log::Logger*> VehiclechassisrecvLogger::loggerCtxMap_;
std::mutex VehiclechassisrecvLogger::ctxMapMutex_;
std::mutex VehiclechassisrecvLogger::loggerCtxMapMutex_;

void VehiclechassisrecvLogger::SetLogConfig()
{
    logConfig_ = ParseLogConfig();
}

/* 此方法应在main函数调用 */
void VehiclechassisrecvLogger::InitAppLogging()
{
    SetLogConfig();
...
void VehiclechassisrecvLogger::InitLoggerCtx(const ara::core::String& ctxId = logConfig_.appId,
...
ara::log::Logger* VehiclechassisrecvLogger::GetLogCtxInstance(const ara::core::String& ctxId,
...
ara::core::String VehiclechassisrecvLogger::GetSpecifyLogConfig(const ara::core::String& logTraceName,
...
ara::core::Vector<ara::core::String> VehiclechassisrecvLogger::GetSpecifyLogMode(
...
ara::log::LogLevel VehiclechassisrecvLogger::GetLogLevel(const ara::core::String& level)
{
    if (level == "info") {
...
ara::log::LogMode VehiclechassisrecvLogger::GetLogMode(const ara::core::Vector<ara::core::String>& modeVec)
{
...
LogConfig VehiclechassisrecvLogger::ParseLogConfig()
{
    ara::core::String filePath {};
    ara::log::LogMode kLogMode = ara::log::LogMode::kRemote;
    LogConfig logConfig = { "SCFI", "VehicleChassisRecv context",
...
bool VehiclechassisrecvLogger::DoesFileExist(const ara::core::String& filePath)
{
...
bool VehiclechassisrecvLogger::IsDirType(const mode_t& fileMode)
{
    if (S_ISDIR(fileMode)) {
        return true;
    }
