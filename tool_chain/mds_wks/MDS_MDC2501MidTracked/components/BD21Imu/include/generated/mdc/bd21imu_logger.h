 ...
 */
#ifndef ARA_BD21IMU_BD21IMU_LOGGER_H
#define ARA_BD21IMU_BD21IMU_LOGGER_H
#include <cstdint>
#include <string>
#include <map>
#include <mutex>
...
public:
     ...
     * ara::bd21imu::Bd21imuLogger::GetLoggerIns("PER")->LogError() << "*******";
...
#endif  /* ARA_BD21IMU_BD21IMU_LOGGER_H */