 ...
 */
#include "mdc/sensor_viualize_base_logger.h"
#include <cstring>
#include <fstream>
#include <climits>
#include <sys/stat.h>
...
LogConfig SensorViualizeBaseLogger::logConfig_ = {"SensorViualizeBase",
    "sensor_viualize_base context", "", ara::log::LogLevel::kInfo, ara::log::LogMode::kRemote};
std::map<ara::core::String, ara::core::String> SensorViualizeBaseLogger::ctxMap_;
std::map<ara::core::String, ara::log::Logger*> SensorViualizeBaseLogger::loggerCtxMap_;
std::mutex SensorViualizeBaseLogger::ctxMapMutex_;
std::mutex SensorViualizeBaseLogger::loggerCtxMapMutex_;

void SensorViualizeBaseLogger::SetLogConfig()
{
    logConfig_ = ParseLogConfig();
}

/* 此方法应在main函数调用 */
void SensorViualizeBaseLogger::InitAppLogging()
{
    SetLogConfig();
...
void SensorViualizeBaseLogger::InitLoggerCtx(const ara::core::String& ctxId = logConfig_.appId,
...
ara::log::Logger* SensorViualizeBaseLogger::GetLogCtxInstance(const ara::core::String& ctxId,
...
ara::core::String SensorViualizeBaseLogger::GetSpecifyLogConfig(const ara::core::String& logTraceName,
...
ara::core::Vector<ara::core::String> SensorViualizeBaseLogger::GetSpecifyLogMode(
...
ara::log::LogLevel SensorViualizeBaseLogger::GetLogLevel(const ara::core::String& level)
{
    if (level == "info") {
...
ara::log::LogMode SensorViualizeBaseLogger::GetLogMode(const ara::core::Vector<ara::core::String>& modeVec)
{
...
LogConfig SensorViualizeBaseLogger::ParseLogConfig()
{
    ara::core::String filePath {};
    ara::log::LogMode kLogMode = ara::log::LogMode::kRemote;
    LogConfig logConfig = { "SCFI", "sensor_viualize_base context",
...
bool SensorViualizeBaseLogger::DoesFileExist(const ara::core::String& filePath)
{
...
bool SensorViualizeBaseLogger::IsDirType(const mode_t& fileMode)
{
    if (S_ISDIR(fileMode)) {
        return true;
    }
