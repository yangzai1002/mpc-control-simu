 ...
 */
#ifndef ARA_VEHICLECHASSISSEND_VEHICLECHASSISSEND_LOGGER_H
#define ARA_VEHICLECHASSISSEND_VEHICLECHASSISSEND_LOGGER_H
#include <cstdint>
#include <string>
#include <map>
#include <mutex>
...
class VehiclechassissendLogger {
public:
    virtual ~VehiclechassissendLogger() = default;
     ...
     * ara::vehiclechassissend::VehiclechassissendLogger::GetLoggerIns("PER")->LogError() << "*******";
...
private:
    VehiclechassissendLogger() = default;
...
#endif  /* ARA_VEHICLECHASSISSEND_VEHICLECHASSISSEND_LOGGER_H */