 ...
 */
#ifndef ARA_HWFR671RADARFRONT_HWFR671RADARFRONT_LOGGER_H
#define ARA_HWFR671RADARFRONT_HWFR671RADARFRONT_LOGGER_H
#include <cstdint>
#include <string>
#include <map>
#include <mutex>
...
class Hwfr671radarfrontLogger {
public:
    virtual ~Hwfr671radarfrontLogger() = default;
     ...
     * ara::hwfr671radarfront::Hwfr671radarfrontLogger::GetLoggerIns("PER")->LogError() << "*******";
...
private:
    Hwfr671radarfrontLogger() = default;
...
#endif  /* ARA_HWFR671RADARFRONT_HWFR671RADARFRONT_LOGGER_H */