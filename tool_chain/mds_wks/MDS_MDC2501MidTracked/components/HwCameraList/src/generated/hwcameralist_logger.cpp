...
namespace mdc {
namespace hwcameralist {

LogConfig HwcameralistLogger::logConfig_ = {"Hwcameralist",
    "HwCameraList context", "", ara::log::LogLevel::kInfo, ara::log::LogMode::kRemote};
std::map<ara::core::String, ara::core::String> HwcameralistLogger::ctxMap_;
std::map<ara::core::String, ara::log::Logger*> HwcameralistLogger::loggerCtxMap_;
std::mutex HwcameralistLogger::ctxMapMutex_;
std::mutex HwcameralistLogger::loggerCtxMapMutex_;

void HwcameralistLogger::SetLogConfig()
{
    logConfig_ = ParseLogConfig();
}

/* 此方法应在main函数调用 */
void HwcameralistLogger::InitAppLogging()
{
    SetLogConfig();
...
void HwcameralistLogger::InitLoggerCtx(const ara::core::String& ctxId = logConfig_.appId,
...
ara::log::Logger* HwcameralistLogger::GetLogCtxInstance(const ara::core::String& ctxId,
...
ara::core::String HwcameralistLogger::GetSpecifyLogConfig(const ara::core::String& logTraceName,
...
ara::core::Vector<ara::core::String> HwcameralistLogger::GetSpecifyLogMode(
...
ara::log::LogLevel HwcameralistLogger::GetLogLevel(const ara::core::String& level)
{
    if (level == "info") {
...
ara::log::LogMode HwcameralistLogger::GetLogMode(const ara::core::Vector<ara::core::String>& modeVec)
{
...
LogConfig HwcameralistLogger::ParseLogConfig()
{
    ara::core::String filePath {};
    ara::log::LogMode kLogMode = ara::log::LogMode::kRemote;
    LogConfig logConfig = { "SCFI", "HwCameraList context",
...
bool HwcameralistLogger::DoesFileExist(const ara::core::String& filePath)
{
...
bool HwcameralistLogger::IsDirType(const mode_t& fileMode)
{
    if (S_ISDIR(fileMode)) {
        return true;
    }
