...
LogConfig Hwl106lidarleftLogger::logConfig_ = {"Hwl106lidarleft",
    "HwL106LidarLeft context", "", ara::log::LogLevel::kInfo, ara::log::LogMode::kRemote};
std::map<ara::core::String, ara::core::String> Hwl106lidarleftLogger::ctxMap_;
std::map<ara::core::String, ara::log::Logger*> Hwl106lidarleftLogger::loggerCtxMap_;
std::mutex Hwl106lidarleftLogger::ctxMapMutex_;
std::mutex Hwl106lidarleftLogger::loggerCtxMapMutex_;

void Hwl106lidarleftLogger::SetLogConfig()
{
    logConfig_ = ParseLogConfig();
}

/* 此方法应在main函数调用 */
void Hwl106lidarleftLogger::InitAppLogging()
{
    SetLogConfig();
...
void Hwl106lidarleftLogger::InitLoggerCtx(const ara::core::String& ctxId = logConfig_.appId,
...
ara::log::Logger* Hwl106lidarleftLogger::GetLogCtxInstance(const ara::core::String& ctxId,
...
ara::core::String Hwl106lidarleftLogger::GetSpecifyLogConfig(const ara::core::String& logTraceName,
...
ara::core::Vector<ara::core::String> Hwl106lidarleftLogger::GetSpecifyLogMode(
...
ara::log::LogLevel Hwl106lidarleftLogger::GetLogLevel(const ara::core::String& level)
{
    if (level == "info") {
...
ara::log::LogMode Hwl106lidarleftLogger::GetLogMode(const ara::core::Vector<ara::core::String>& modeVec)
{
...
LogConfig Hwl106lidarleftLogger::ParseLogConfig()
{
    ara::core::String filePath {};
    ara::log::LogMode kLogMode = ara::log::LogMode::kRemote;
    LogConfig logConfig = { "SCFI", "HwL106LidarLeft context",
...
bool Hwl106lidarleftLogger::DoesFileExist(const ara::core::String& filePath)
{
...
bool Hwl106lidarleftLogger::IsDirType(const mode_t& fileMode)
{
    if (S_ISDIR(fileMode)) {
        return true;
    }
