 ...
 */
#ifndef ARA_HWL106LIDARLEFT_HWL106LIDARLEFT_LOGGER_H
#define ARA_HWL106LIDARLEFT_HWL106LIDARLEFT_LOGGER_H
#include <cstdint>
#include <string>
#include <map>
#include <mutex>
...
class Hwl106lidarleftLogger {
public:
    virtual ~Hwl106lidarleftLogger() = default;
     ...
     * ara::hwl106lidarleft::Hwl106lidarleftLogger::GetLoggerIns("PER")->LogError() << "*******";
...
#endif  /* ARA_HWL106LIDARLEFT_HWL106LIDARLEFT_LOGGER_H */