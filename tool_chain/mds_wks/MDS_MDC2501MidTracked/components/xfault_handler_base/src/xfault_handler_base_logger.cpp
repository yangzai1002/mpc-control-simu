...
LogConfig XfaultHandlerBaseLogger::logConfig_ = {"XfaultHandlerBase",
    "xfault_handler_base context", "", ara::log::LogLevel::kInfo, ara::log::LogMode::kRemote};
std::map<ara::core::String, ara::core::String> XfaultHandlerBaseLogger::ctxMap_;
std::map<ara::core::String, ara::log::Logger*> XfaultHandlerBaseLogger::loggerCtxMap_;
std::mutex XfaultHandlerBaseLogger::ctxMapMutex_;
std::mutex XfaultHandlerBaseLogger::loggerCtxMapMutex_;

void XfaultHandlerBaseLogger::SetLogConfig()
{
    logConfig_ = ParseLogConfig();
}

/* 此方法应在main函数调用 */
void XfaultHandlerBaseLogger::InitAppLogging()
{
    SetLogConfig();
...
void XfaultHandlerBaseLogger::InitLoggerCtx(const ara::core::String& ctxId = logConfig_.appId,
...
ara::log::Logger* XfaultHandlerBaseLogger::GetLogCtxInstance(const ara::core::String& ctxId,
...
ara::core::String XfaultHandlerBaseLogger::GetSpecifyLogConfig(const ara::core::String& logTraceName,
...
ara::core::Vector<ara::core::String> XfaultHandlerBaseLogger::GetSpecifyLogMode(
...
ara::log::LogLevel XfaultHandlerBaseLogger::GetLogLevel(const ara::core::String& level)
{
    if (level == "info") {
...
ara::log::LogMode XfaultHandlerBaseLogger::GetLogMode(const ara::core::Vector<ara::core::String>& modeVec)
{
...
LogConfig XfaultHandlerBaseLogger::ParseLogConfig()
{
    ara::core::String filePath {};
    ara::log::LogMode kLogMode = ara::log::LogMode::kRemote;
    LogConfig logConfig = { "SCFI", "xfault_handler_base context",
...
bool XfaultHandlerBaseLogger::DoesFileExist(const ara::core::String& filePath)
{
...
bool XfaultHandlerBaseLogger::IsDirType(const mode_t& fileMode)
{
    if (S_ISDIR(fileMode)) {
        return true;
    }
