 ...
 */
#ifndef ARA_XFAULT_HANDLER_BASE_XFAULT_HANDLER_BASE_LOGGER_H
#define ARA_XFAULT_HANDLER_BASE_XFAULT_HANDLER_BASE_LOGGER_H
#include <cstdint>
#include <string>
#include <map>
#include <mutex>
...
class XfaultHandlerBaseLogger {
public:
    virtual ~XfaultHandlerBaseLogger() = default;
     ...
     * ara::xfault_handler_base::XfaultHandlerBaseLogger::GetLoggerIns("PER")->LogError() << "*******";
...
private:
    XfaultHandlerBaseLogger() = default;
...
#endif  /* ARA_XFAULT_HANDLER_BASE_XFAULT_HANDLER_BASE_LOGGER_H */