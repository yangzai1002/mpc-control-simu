 ...
 */
#ifndef ARA_XDATATRIGGERRECORDER_XDATATRIGGERRECORDER_LOGGER_H
#define ARA_XDATATRIGGERRECORDER_XDATATRIGGERRECORDER_LOGGER_H
#include <cstdint>
#include <string>
#include <map>
#include <mutex>
...
class XdatatriggerrecorderLogger {
public:
    virtual ~XdatatriggerrecorderLogger() = default;
     ...
     * ara::xdatatriggerrecorder::XdatatriggerrecorderLogger::GetLoggerIns("PER")->LogError() << "*******";
...
private:
    XdatatriggerrecorderLogger() = default;
...
#endif  /* ARA_XDATATRIGGERRECORDER_XDATATRIGGERRECORDER_LOGGER_H */