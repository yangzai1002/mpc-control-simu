 ...
 */
#ifndef ARA_HW_CAMERA_LIST_HW_CAMERA_LIST_LOGGER_H
#define ARA_HW_CAMERA_LIST_HW_CAMERA_LIST_LOGGER_H
#include <cstdint>
#include <string>
#include <map>
#include <mutex>
...
public:
     ...
     * ara::hw_camera_list::HwCameraListLogger::GetLoggerIns("PER")->LogError() << "*******";
...
#endif  /* ARA_HW_CAMERA_LIST_HW_CAMERA_LIST_LOGGER_H */