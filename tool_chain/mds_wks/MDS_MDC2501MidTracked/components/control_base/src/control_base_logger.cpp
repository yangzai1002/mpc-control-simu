...
LogConfig ControlBaseLogger::logConfig_ = {"ControlBase",
    "control_base context", "", ara::log::LogLevel::kInfo, ara::log::LogMode::kRemote};
std::map<ara::core::String, ara::core::String> ControlBaseLogger::ctxMap_;
std::map<ara::core::String, ara::log::Logger*> ControlBaseLogger::loggerCtxMap_;
std::mutex ControlBaseLogger::ctxMapMutex_;
std::mutex ControlBaseLogger::loggerCtxMapMutex_;

void ControlBaseLogger::SetLogConfig()
{
    logConfig_ = ParseLogConfig();
}

/* 此方法应在main函数调用 */
void ControlBaseLogger::InitAppLogging()
{
    SetLogConfig();
...
void ControlBaseLogger::InitLoggerCtx(const ara::core::String& ctxId = logConfig_.appId,
...
ara::log::Logger* ControlBaseLogger::GetLogCtxInstance(const ara::core::String& ctxId,
...
ara::core::String ControlBaseLogger::GetSpecifyLogConfig(const ara::core::String& logTraceName,
...
ara::core::Vector<ara::core::String> ControlBaseLogger::GetSpecifyLogMode(
...
ara::log::LogLevel ControlBaseLogger::GetLogLevel(const ara::core::String& level)
{
    if (level == "info") {
...
ara::log::LogMode ControlBaseLogger::GetLogMode(const ara::core::Vector<ara::core::String>& modeVec)
{
...
LogConfig ControlBaseLogger::ParseLogConfig()
{
    ara::core::String filePath {};
    ara::log::LogMode kLogMode = ara::log::LogMode::kRemote;
    LogConfig logConfig = { "SCFI", "control_base context",
...
bool ControlBaseLogger::DoesFileExist(const ara::core::String& filePath)
{
...
bool ControlBaseLogger::IsDirType(const mode_t& fileMode)
{
    if (S_ISDIR(fileMode)) {
        return true;
    }
