 ...
 */
#ifndef ARA_XFAULTHANDLER_XFAULTHANDLER_LOGGER_H
#define ARA_XFAULTHANDLER_XFAULTHANDLER_LOGGER_H
#include <cstdint>
#include <string>
#include <map>
#include <mutex>
...
class XfaulthandlerLogger {
public:
    virtual ~XfaulthandlerLogger() = default;
     ...
     * ara::xfaulthandler::XfaulthandlerLogger::GetLoggerIns("PER")->LogError() << "*******";
...
#endif  /* ARA_XFAULTHANDLER_XFAULTHANDLER_LOGGER_H */