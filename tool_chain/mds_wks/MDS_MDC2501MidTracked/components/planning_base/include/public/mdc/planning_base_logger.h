 ...
 */
#ifndef ARA_PLANNING_BASE_PLANNING_BASE_LOGGER_H
#define ARA_PLANNING_BASE_PLANNING_BASE_LOGGER_H
#include <cstdint>
#include <string>
#include <map>
#include <mutex>
...
class PlanningBaseLogger {
public:
    virtual ~PlanningBaseLogger() = default;
     ...
     * ara::planning_base::PlanningBaseLogger::GetLoggerIns("PER")->LogError() << "*******";
...
#endif  /* ARA_PLANNING_BASE_PLANNING_BASE_LOGGER_H */