 ...
 */
#ifndef ARA_PLANNING_PLANNING_LOGGER_H
#define ARA_PLANNING_PLANNING_LOGGER_H
#include <cstdint>
#include <string>
#include <map>
#include <mutex>
...
public:
    virtual ~PlanningLogger() = default;
     ...
     * ara::planning::PlanningLogger::GetLoggerIns("PER")->LogError() << "*******";
...
#endif  /* ARA_PLANNING_PLANNING_LOGGER_H */