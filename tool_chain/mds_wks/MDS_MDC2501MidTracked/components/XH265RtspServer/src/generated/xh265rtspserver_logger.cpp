...
LogConfig Xh265rtspserverLogger::logConfig_ = {"Xh265rtspserver",
    "XH265RtspServer context", "", ara::log::LogLevel::kInfo, ara::log::LogMode::kRemote};
std::map<ara::core::String, ara::core::String> Xh265rtspserverLogger::ctxMap_;
std::map<ara::core::String, ara::log::Logger*> Xh265rtspserverLogger::loggerCtxMap_;
std::mutex Xh265rtspserverLogger::ctxMapMutex_;
std::mutex Xh265rtspserverLogger::loggerCtxMapMutex_;

void Xh265rtspserverLogger::SetLogConfig()
{
    logConfig_ = ParseLogConfig();
}

/* 此方法应在main函数调用 */
void Xh265rtspserverLogger::InitAppLogging()
{
    SetLogConfig();
...
void Xh265rtspserverLogger::InitLoggerCtx(const ara::core::String& ctxId = logConfig_.appId,
...
ara::log::Logger* Xh265rtspserverLogger::GetLogCtxInstance(const ara::core::String& ctxId,
...
ara::core::String Xh265rtspserverLogger::GetSpecifyLogConfig(const ara::core::String& logTraceName,
...
ara::core::Vector<ara::core::String> Xh265rtspserverLogger::GetSpecifyLogMode(
...
ara::log::LogLevel Xh265rtspserverLogger::GetLogLevel(const ara::core::String& level)
{
    if (level == "info") {
...
ara::log::LogMode Xh265rtspserverLogger::GetLogMode(const ara::core::Vector<ara::core::String>& modeVec)
{
...
LogConfig Xh265rtspserverLogger::ParseLogConfig()
{
    ara::core::String filePath {};
    ara::log::LogMode kLogMode = ara::log::LogMode::kRemote;
    LogConfig logConfig = { "SCFI", "XH265RtspServer context",
...
bool Xh265rtspserverLogger::DoesFileExist(const ara::core::String& filePath)
{
...
bool Xh265rtspserverLogger::IsDirType(const mode_t& fileMode)
{
    if (S_ISDIR(fileMode)) {
        return true;
    }
