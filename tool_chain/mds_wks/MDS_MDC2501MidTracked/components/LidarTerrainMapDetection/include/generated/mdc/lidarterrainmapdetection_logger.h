 ...
 */
#ifndef ARA_LIDARTERRAINMAPDETECTION_LIDARTERRAINMAPDETECTION_LOGGER_H
#define ARA_LIDARTERRAINMAPDETECTION_LIDARTERRAINMAPDETECTION_LOGGER_H
#include <cstdint>
#include <string>
#include <map>
#include <mutex>
...
public:
     ...
     * ara::lidarterrainmapdetection::LidarterrainmapdetectionLogger::GetLoggerIns("PER")->LogError() << "*******";
...
#endif  /* ARA_LIDARTERRAINMAPDETECTION_LIDARTERRAINMAPDETECTION_LOGGER_H */