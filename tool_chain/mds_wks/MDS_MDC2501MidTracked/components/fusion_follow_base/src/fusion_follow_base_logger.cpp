...
LogConfig FusionFollowBaseLogger::logConfig_ = {"FusionFollowBase",
    "fusion_follow_base context", "", ara::log::LogLevel::kInfo, ara::log::LogMode::kRemote};
std::map<ara::core::String, ara::core::String> FusionFollowBaseLogger::ctxMap_;
std::map<ara::core::String, ara::log::Logger*> FusionFollowBaseLogger::loggerCtxMap_;
std::mutex FusionFollowBaseLogger::ctxMapMutex_;
std::mutex FusionFollowBaseLogger::loggerCtxMapMutex_;

void FusionFollowBaseLogger::SetLogConfig()
{
    logConfig_ = ParseLogConfig();
}

/* 此方法应在main函数调用 */
void FusionFollowBaseLogger::InitAppLogging()
{
    SetLogConfig();
...
void FusionFollowBaseLogger::InitLoggerCtx(const ara::core::String& ctxId = logConfig_.appId,
...
ara::log::Logger* FusionFollowBaseLogger::GetLogCtxInstance(const ara::core::String& ctxId,
...
ara::core::String FusionFollowBaseLogger::GetSpecifyLogConfig(const ara::core::String& logTraceName,
...
ara::core::Vector<ara::core::String> FusionFollowBaseLogger::GetSpecifyLogMode(
...
ara::log::LogLevel FusionFollowBaseLogger::GetLogLevel(const ara::core::String& level)
{
    if (level == "info") {
...
ara::log::LogMode FusionFollowBaseLogger::GetLogMode(const ara::core::Vector<ara::core::String>& modeVec)
{
...
LogConfig FusionFollowBaseLogger::ParseLogConfig()
{
    ara::core::String filePath {};
    ara::log::LogMode kLogMode = ara::log::LogMode::kRemote;
    LogConfig logConfig = { "SCFI", "fusion_follow_base context",
...
bool FusionFollowBaseLogger::DoesFileExist(const ara::core::String& filePath)
{
...
bool FusionFollowBaseLogger::IsDirType(const mode_t& fileMode)
{
    if (S_ISDIR(fileMode)) {
        return true;
    }
