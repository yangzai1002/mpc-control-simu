 ...
 */
#ifndef ARA_XH265ENCODER_XH265ENCODER_LOGGER_H
#define ARA_XH265ENCODER_XH265ENCODER_LOGGER_H
#include <cstdint>
#include <string>
#include <map>
#include <mutex>
...
public:
     ...
     * ara::xh265encoder::Xh265encoderLogger::GetLoggerIns("PER")->LogError() << "*******";
...
#endif  /* ARA_XH265ENCODER_XH265ENCODER_LOGGER_H */