...
LogConfig LidarslamLogger::logConfig_ = {"Lidarslam",
    "LidarSlam context", "", ara::log::LogLevel::kInfo, ara::log::LogMode::kRemote};
std::map<ara::core::String, ara::core::String> LidarslamLogger::ctxMap_;
std::map<ara::core::String, ara::log::Logger*> LidarslamLogger::loggerCtxMap_;
std::mutex LidarslamLogger::ctxMapMutex_;
std::mutex LidarslamLogger::loggerCtxMapMutex_;

void LidarslamLogger::SetLogConfig()
{
    logConfig_ = ParseLogConfig();
}

/* 此方法应在main函数调用 */
void LidarslamLogger::InitAppLogging()
{
    SetLogConfig();
...
void LidarslamLogger::InitLoggerCtx(const ara::core::String& ctxId = logConfig_.appId,
...
ara::log::Logger* LidarslamLogger::GetLogCtxInstance(const ara::core::String& ctxId,
...
ara::core::String LidarslamLogger::GetSpecifyLogConfig(const ara::core::String& logTraceName,
...
ara::core::Vector<ara::core::String> LidarslamLogger::GetSpecifyLogMode(
...
ara::log::LogLevel LidarslamLogger::GetLogLevel(const ara::core::String& level)
{
    if (level == "info") {
...
ara::log::LogMode LidarslamLogger::GetLogMode(const ara::core::Vector<ara::core::String>& modeVec)
{
...
LogConfig LidarslamLogger::ParseLogConfig()
{
    ara::core::String filePath {};
    ara::log::LogMode kLogMode = ara::log::LogMode::kRemote;
    LogConfig logConfig = { "SCFI", "LidarSlam context",
...
bool LidarslamLogger::DoesFileExist(const ara::core::String& filePath)
{
...
bool LidarslamLogger::IsDirType(const mode_t& fileMode)
{
    if (S_ISDIR(fileMode)) {
        return true;
    }
