 ...
 */
#ifndef ARA_XH265_RTP_PUSHER_XH265_RTP_PUSHER_LOGGER_H
#define ARA_XH265_RTP_PUSHER_XH265_RTP_PUSHER_LOGGER_H
#include <cstdint>
#include <string>
#include <map>
#include <mutex>
...
class Xh265RtpPusherLogger {
public:
    virtual ~Xh265RtpPusherLogger() = default;
     ...
     * ara::xh265_rtp_pusher::Xh265RtpPusherLogger::GetLoggerIns("PER")->LogError() << "*******";
...
#endif  /* ARA_XH265_RTP_PUSHER_XH265_RTP_PUSHER_LOGGER_H */