 ...
 */
#ifndef ARA_FUSION_LOCATION_BASE_FUSION_LOCATION_BASE_LOGGER_H
#define ARA_FUSION_LOCATION_BASE_FUSION_LOCATION_BASE_LOGGER_H
#include <cstdint>
#include <string>
#include <map>
#include <mutex>
...
class FusionLocationBaseLogger {
public:
    virtual ~FusionLocationBaseLogger() = default;
     ...
     * ara::fusion_location_base::FusionLocationBaseLogger::GetLoggerIns("PER")->LogError() << "*******";
...
private:
    FusionLocationBaseLogger() = default;
...
#endif  /* ARA_FUSION_LOCATION_BASE_FUSION_LOCATION_BASE_LOGGER_H */