...
LogConfig DriverDevNullLogger::logConfig_ = {"DriverDevNull",
    "driver_dev_null context", "", ara::log::LogLevel::kInfo, ara::log::LogMode::kRemote};
std::map<ara::core::String, ara::core::String> DriverDevNullLogger::ctxMap_;
std::map<ara::core::String, ara::log::Logger*> DriverDevNullLogger::loggerCtxMap_;
std::mutex DriverDevNullLogger::ctxMapMutex_;
std::mutex DriverDevNullLogger::loggerCtxMapMutex_;

void DriverDevNullLogger::SetLogConfig()
{
    logConfig_ = ParseLogConfig();
}

/* 此方法应在main函数调用 */
void DriverDevNullLogger::InitAppLogging()
{
    SetLogConfig();
...
void DriverDevNullLogger::InitLoggerCtx(const ara::core::String& ctxId = logConfig_.appId,
...
ara::log::Logger* DriverDevNullLogger::GetLogCtxInstance(const ara::core::String& ctxId,
...
ara::core::String DriverDevNullLogger::GetSpecifyLogConfig(const ara::core::String& logTraceName,
...
ara::core::Vector<ara::core::String> DriverDevNullLogger::GetSpecifyLogMode(
...
ara::log::LogLevel DriverDevNullLogger::GetLogLevel(const ara::core::String& level)
{
    if (level == "info") {
...
ara::log::LogMode DriverDevNullLogger::GetLogMode(const ara::core::Vector<ara::core::String>& modeVec)
{
...
LogConfig DriverDevNullLogger::ParseLogConfig()
{
    ara::core::String filePath {};
    ara::log::LogMode kLogMode = ara::log::LogMode::kRemote;
    LogConfig logConfig = { "SCFI", "driver_dev_null context",
...
bool DriverDevNullLogger::DoesFileExist(const ara::core::String& filePath)
{
...
bool DriverDevNullLogger::IsDirType(const mode_t& fileMode)
{
    if (S_ISDIR(fileMode)) {
        return true;
    }
