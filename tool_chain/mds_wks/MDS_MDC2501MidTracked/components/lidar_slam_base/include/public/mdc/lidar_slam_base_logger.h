 ...
 */
#ifndef ARA_LIDAR_SLAM_BASE_LIDAR_SLAM_BASE_LOGGER_H
#define ARA_LIDAR_SLAM_BASE_LIDAR_SLAM_BASE_LOGGER_H
#include <cstdint>
#include <string>
#include <map>
#include <mutex>
...
class LidarSlamBaseLogger {
public:
    virtual ~LidarSlamBaseLogger() = default;
     ...
     * ara::lidar_slam_base::LidarSlamBaseLogger::GetLoggerIns("PER")->LogError() << "*******";
...
#endif  /* ARA_LIDAR_SLAM_BASE_LIDAR_SLAM_BASE_LOGGER_H */