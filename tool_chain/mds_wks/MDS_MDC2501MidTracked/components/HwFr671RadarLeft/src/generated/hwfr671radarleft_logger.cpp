...
LogConfig Hwfr671radarleftLogger::logConfig_ = {"Hwfr671radarleft",
    "HwFr671RadarLeft context", "", ara::log::LogLevel::kInfo, ara::log::LogMode::kRemote};
std::map<ara::core::String, ara::core::String> Hwfr671radarleftLogger::ctxMap_;
std::map<ara::core::String, ara::log::Logger*> Hwfr671radarleftLogger::loggerCtxMap_;
std::mutex Hwfr671radarleftLogger::ctxMapMutex_;
std::mutex Hwfr671radarleftLogger::loggerCtxMapMutex_;

void Hwfr671radarleftLogger::SetLogConfig()
{
    logConfig_ = ParseLogConfig();
}

/* 此方法应在main函数调用 */
void Hwfr671radarleftLogger::InitAppLogging()
{
    SetLogConfig();
...
void Hwfr671radarleftLogger::InitLoggerCtx(const ara::core::String& ctxId = logConfig_.appId,
...
ara::log::Logger* Hwfr671radarleftLogger::GetLogCtxInstance(const ara::core::String& ctxId,
...
ara::core::String Hwfr671radarleftLogger::GetSpecifyLogConfig(const ara::core::String& logTraceName,
...
ara::core::Vector<ara::core::String> Hwfr671radarleftLogger::GetSpecifyLogMode(
...
ara::log::LogLevel Hwfr671radarleftLogger::GetLogLevel(const ara::core::String& level)
{
    if (level == "info") {
...
ara::log::LogMode Hwfr671radarleftLogger::GetLogMode(const ara::core::Vector<ara::core::String>& modeVec)
{
...
LogConfig Hwfr671radarleftLogger::ParseLogConfig()
{
    ara::core::String filePath {};
    ara::log::LogMode kLogMode = ara::log::LogMode::kRemote;
    LogConfig logConfig = { "SCFI", "HwFr671RadarLeft context",
...
bool Hwfr671radarleftLogger::DoesFileExist(const ara::core::String& filePath)
{
...
bool Hwfr671radarleftLogger::IsDirType(const mode_t& fileMode)
{
    if (S_ISDIR(fileMode)) {
        return true;
    }
