 ...
 */
#ifndef ARA_HWFR671RADARLEFT_HWFR671RADARLEFT_LOGGER_H
#define ARA_HWFR671RADARLEFT_HWFR671RADARLEFT_LOGGER_H
#include <cstdint>
#include <string>
#include <map>
#include <mutex>
...
class Hwfr671radarleftLogger {
public:
    virtual ~Hwfr671radarleftLogger() = default;
     ...
     * ara::hwfr671radarleft::Hwfr671radarleftLogger::GetLoggerIns("PER")->LogError() << "*******";
...
private:
    Hwfr671radarleftLogger() = default;
...
#endif  /* ARA_HWFR671RADARLEFT_HWFR671RADARLEFT_LOGGER_H */