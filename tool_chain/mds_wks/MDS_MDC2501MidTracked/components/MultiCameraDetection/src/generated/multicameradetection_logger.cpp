...
LogConfig MulticameradetectionLogger::logConfig_ = {"Multicameradetection",
    "MultiCameraDetection context", "", ara::log::LogLevel::kInfo, ara::log::LogMode::kRemote};
std::map<ara::core::String, ara::core::String> MulticameradetectionLogger::ctxMap_;
std::map<ara::core::String, ara::log::Logger*> MulticameradetectionLogger::loggerCtxMap_;
std::mutex MulticameradetectionLogger::ctxMapMutex_;
std::mutex MulticameradetectionLogger::loggerCtxMapMutex_;

void MulticameradetectionLogger::SetLogConfig()
{
    logConfig_ = ParseLogConfig();
}

/* 此方法应在main函数调用 */
void MulticameradetectionLogger::InitAppLogging()
{
    SetLogConfig();
...
void MulticameradetectionLogger::InitLoggerCtx(const ara::core::String& ctxId = logConfig_.appId,
...
ara::log::Logger* MulticameradetectionLogger::GetLogCtxInstance(const ara::core::String& ctxId,
...
ara::core::String MulticameradetectionLogger::GetSpecifyLogConfig(const ara::core::String& logTraceName,
...
ara::core::Vector<ara::core::String> MulticameradetectionLogger::GetSpecifyLogMode(
...
ara::log::LogLevel MulticameradetectionLogger::GetLogLevel(const ara::core::String& level)
{
    if (level == "info") {
...
ara::log::LogMode MulticameradetectionLogger::GetLogMode(const ara::core::Vector<ara::core::String>& modeVec)
{
...
LogConfig MulticameradetectionLogger::ParseLogConfig()
{
    ara::core::String filePath {};
    ara::log::LogMode kLogMode = ara::log::LogMode::kRemote;
    LogConfig logConfig = { "SCFI", "MultiCameraDetection context",
...
bool MulticameradetectionLogger::DoesFileExist(const ara::core::String& filePath)
{
...
bool MulticameradetectionLogger::IsDirType(const mode_t& fileMode)
{
    if (S_ISDIR(fileMode)) {
        return true;
    }
