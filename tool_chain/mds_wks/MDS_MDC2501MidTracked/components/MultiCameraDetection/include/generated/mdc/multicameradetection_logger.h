 ...
 */
#ifndef ARA_MULTICAMERADETECTION_MULTICAMERADETECTION_LOGGER_H
#define ARA_MULTICAMERADETECTION_MULTICAMERADETECTION_LOGGER_H
#include <cstdint>
#include <string>
#include <map>
#include <mutex>
...
class MulticameradetectionLogger {
public:
    virtual ~MulticameradetectionLogger() = default;
     ...
     * ara::multicameradetection::MulticameradetectionLogger::GetLoggerIns("PER")->LogError() << "*******";
...
private:
    MulticameradetectionLogger() = default;
...
#endif  /* ARA_MULTICAMERADETECTION_MULTICAMERADETECTION_LOGGER_H */