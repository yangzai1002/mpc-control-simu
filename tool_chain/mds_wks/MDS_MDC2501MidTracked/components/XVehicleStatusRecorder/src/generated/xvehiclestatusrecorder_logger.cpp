...
LogConfig XvehiclestatusrecorderLogger::logConfig_ = {"Xvehiclestatusrecorder",
    "XVehicleStatusRecorder context", "", ara::log::LogLevel::kInfo, ara::log::LogMode::kRemote};
std::map<ara::core::String, ara::core::String> XvehiclestatusrecorderLogger::ctxMap_;
std::map<ara::core::String, ara::log::Logger*> XvehiclestatusrecorderLogger::loggerCtxMap_;
std::mutex XvehiclestatusrecorderLogger::ctxMapMutex_;
std::mutex XvehiclestatusrecorderLogger::loggerCtxMapMutex_;

void XvehiclestatusrecorderLogger::SetLogConfig()
{
    logConfig_ = ParseLogConfig();
}

/* 此方法应在main函数调用 */
void XvehiclestatusrecorderLogger::InitAppLogging()
{
    SetLogConfig();
...
void XvehiclestatusrecorderLogger::InitLoggerCtx(const ara::core::String& ctxId = logConfig_.appId,
...
ara::log::Logger* XvehiclestatusrecorderLogger::GetLogCtxInstance(const ara::core::String& ctxId,
...
ara::core::String XvehiclestatusrecorderLogger::GetSpecifyLogConfig(const ara::core::String& logTraceName,
...
ara::core::Vector<ara::core::String> XvehiclestatusrecorderLogger::GetSpecifyLogMode(
...
ara::log::LogLevel XvehiclestatusrecorderLogger::GetLogLevel(const ara::core::String& level)
{
    if (level == "info") {
...
ara::log::LogMode XvehiclestatusrecorderLogger::GetLogMode(const ara::core::Vector<ara::core::String>& modeVec)
{
...
LogConfig XvehiclestatusrecorderLogger::ParseLogConfig()
{
    ara::core::String filePath {};
    ara::log::LogMode kLogMode = ara::log::LogMode::kRemote;
    LogConfig logConfig = { "SCFI", "XVehicleStatusRecorder context",
...
bool XvehiclestatusrecorderLogger::DoesFileExist(const ara::core::String& filePath)
{
...
bool XvehiclestatusrecorderLogger::IsDirType(const mode_t& fileMode)
{
    if (S_ISDIR(fileMode)) {
        return true;
    }
