# ===================================================================================
#  The xh265_encoder CMake configuration file
#
...
#
#    find_package(xh265_encoder REQUIRED)
#    target_include_directories(MY_TARGET_NAME ${xh265_encoder_INCLUDE_DIRS})
#    target_link_libraries(MY_TARGET_NAME ${xh265_encoder_LIBRARIES})
#
#    This file will define the following variables:
#      - xh265_encoder_LIBRARIES                : The list of all imported targets for xh265_encoder modules.
#      - xh265_encoder_INCLUDE_DIRS             : The xh265_encoder include directories.
#      - xh265_encoder_VERSION                  : The version of this xh265_encoder build.
#      - xh265_encoder_SHARE                    : The configuration files of this xh265_encoder.
#
#  The xh265_encoder CMake configuration file only was used in SCFI user repo.
# ===================================================================================
...
foreach(dependency MANUALLY_ADDED_DEPENDENCIES-NOTFOUND)
    ...
    message(STATUS "Finding xh265_encoder dependency: ${dependency}")
    find_package(${dependency} PATHS ${PACKAGE_PREFIX_DIR}/lib/cmake/${dependency})
endforeach()

foreach(dependency  xh265_encoder_scfi_intf;-Wl,--as-needed)
...
foreach(dependency  SCFI_DEP-NOTFOUND)
    ...
    if(NOT ${dependency}_FOUND)
        set(xh265_encoder_FOUND False)
        message(WARNING "Finding xh265_encoder dependency ${dependency} fail.")
    endif()
endforeach()
...
include("${CMAKE_CURRENT_LIST_DIR}/xh265_encoder-targets.cmake")

set(xh265_encoder_LIBRARIES xh265_encoder)
set(xh265_encoder_INCLUDE_DIRS ${PACKAGE_PREFIX_DIR}/include/xh265_encoder)
set(xh265_encoder_SHARE ${PACKAGE_PREFIX_DIR}/share/xh265_encoder)
