...
set(scfi_SOURCES
    ${scfi_SOURCES}
    ${CMAKE_SOURCE_DIR}/generated/src/ara/adsfi/sensorimageserviceinterface_common.cpp
)
...
list(APPEND SCFI_DEP xh265_rtp_pusher)
message(STATUS "Found package dependency xh265_rtp_pusher")
target_include_directories(${scfi_LIBRARIES} INTERFACE ${CMAKE_SOURCE_DIR}/components/xh265_rtp_pusher/include)
target_include_directories(${scfi_LIBRARIES} INTERFACE ${CMAKE_SOURCE_DIR}/components/xh265_rtp_pusher/include/public)
target_include_directories(${scfi_LIBRARIES} INTERFACE ${CMAKE_SOURCE_DIR}/components/xh265_rtp_pusher/include/private)
target_link_libraries(${scfi_LIBRARIES} INTERFACE xh265_rtp_pusher)
