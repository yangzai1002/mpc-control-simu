# ===================================================================================
#  The xzmq_rc CMake configuration file
#
...
#
#    find_package(xzmq_rc REQUIRED)
#    target_include_directories(MY_TARGET_NAME ${xzmq_rc_INCLUDE_DIRS})
#    target_link_libraries(MY_TARGET_NAME ${xzmq_rc_LIBRARIES})
#
#    This file will define the following variables:
#      - xzmq_rc_LIBRARIES                : The list of all imported targets for xzmq_rc modules.
#      - xzmq_rc_INCLUDE_DIRS             : The xzmq_rc include directories.
#      - xzmq_rc_VERSION                  : The version of this xzmq_rc build.
#      - xzmq_rc_SHARE                    : The configuration files of this xzmq_rc.
#
#  The xzmq_rc CMake configuration file only was used in SCFI user repo.
# ===================================================================================
...
foreach(dependency MANUALLY_ADDED_DEPENDENCIES-NOTFOUND)
    ...
    message(STATUS "Finding xzmq_rc dependency: ${dependency}")
    find_package(${dependency} PATHS ${PACKAGE_PREFIX_DIR}/lib/cmake/${dependency})
endforeach()

foreach(dependency  xzmq_rc_scfi_intf;-Wl,--as-needed)
...
foreach(dependency  SCFI_DEP-NOTFOUND)
    ...
    if(NOT ${dependency}_FOUND)
        set(xzmq_rc_FOUND False)
        message(WARNING "Finding xzmq_rc dependency ${dependency} fail.")
    endif()
endforeach()
...
include("${CMAKE_CURRENT_LIST_DIR}/xzmq_rc-targets.cmake")

set(xzmq_rc_LIBRARIES xzmq_rc)
set(xzmq_rc_INCLUDE_DIRS ${PACKAGE_PREFIX_DIR}/include/xzmq_rc)
set(xzmq_rc_SHARE ${PACKAGE_PREFIX_DIR}/share/xzmq_rc)
