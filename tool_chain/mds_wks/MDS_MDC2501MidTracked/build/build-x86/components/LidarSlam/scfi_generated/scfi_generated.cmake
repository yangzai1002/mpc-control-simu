...
list(APPEND SCFI_DEP lidar_slam_base)
message(STATUS "Found package dependency lidar_slam_base")
target_include_directories(${scfi_LIBRARIES} INTERFACE ${CMAKE_SOURCE_DIR}/components/lidar_slam_base/include)
target_include_directories(${scfi_LIBRARIES} INTERFACE ${CMAKE_SOURCE_DIR}/components/lidar_slam_base/include/public)
target_include_directories(${scfi_LIBRARIES} INTERFACE ${CMAKE_SOURCE_DIR}/components/lidar_slam_base/include/private)
target_link_libraries(${scfi_LIBRARIES} INTERFACE lidar_slam_base)
