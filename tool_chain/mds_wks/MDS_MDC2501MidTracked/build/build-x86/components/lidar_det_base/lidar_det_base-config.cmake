# ===================================================================================
#  The lidar_det_base CMake configuration file
#
...
#
#    find_package(lidar_det_base REQUIRED)
#    target_include_directories(MY_TARGET_NAME ${lidar_det_base_INCLUDE_DIRS})
#    target_link_libraries(MY_TARGET_NAME ${lidar_det_base_LIBRARIES})
#
#    This file will define the following variables:
#      - lidar_det_base_LIBRARIES                : The list of all imported targets for lidar_det_base modules.
#      - lidar_det_base_INCLUDE_DIRS             : The lidar_det_base include directories.
#      - lidar_det_base_VERSION                  : The version of this lidar_det_base build.
#      - lidar_det_base_SHARE                    : The configuration files of this lidar_det_base.
#
#  The lidar_det_base CMake configuration file only was used in SCFI user repo.
# ===================================================================================
...
foreach(dependency MANUALLY_ADDED_DEPENDENCIES-NOTFOUND)
    ...
    message(STATUS "Finding lidar_det_base dependency: ${dependency}")
    find_package(${dependency} PATHS ${PACKAGE_PREFIX_DIR}/lib/cmake/${dependency})
endforeach()

foreach(dependency  lidar_det_base_scfi_intf;-Wl,--as-needed)
...
foreach(dependency  SCFI_DEP-NOTFOUND)
    ...
    if(NOT ${dependency}_FOUND)
        set(lidar_det_base_FOUND False)
        message(WARNING "Finding lidar_det_base dependency ${dependency} fail.")
    endif()
endforeach()
...
include("${CMAKE_CURRENT_LIST_DIR}/lidar_det_base-targets.cmake")

set(lidar_det_base_LIBRARIES lidar_det_base)
set(lidar_det_base_INCLUDE_DIRS ${PACKAGE_PREFIX_DIR}/include/lidar_det_base)
set(lidar_det_base_SHARE ${PACKAGE_PREFIX_DIR}/share/lidar_det_base)
