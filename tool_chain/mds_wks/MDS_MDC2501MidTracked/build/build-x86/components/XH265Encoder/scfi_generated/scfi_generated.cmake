...
list(APPEND SCFI_DEP xh265_encoder)
message(STATUS "Found package dependency xh265_encoder")
target_include_directories(${scfi_LIBRARIES} INTERFACE ${CMAKE_SOURCE_DIR}/components/xh265_encoder/include)
target_include_directories(${scfi_LIBRARIES} INTERFACE ${CMAKE_SOURCE_DIR}/components/xh265_encoder/include/public)
target_include_directories(${scfi_LIBRARIES} INTERFACE ${CMAKE_SOURCE_DIR}/components/xh265_encoder/include/private)
target_link_libraries(${scfi_LIBRARIES} INTERFACE xh265_encoder)
