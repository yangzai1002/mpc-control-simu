...
list(APPEND SCFI_DEP hw_l106_lidar)
message(STATUS "Found package dependency hw_l106_lidar")
target_include_directories(${scfi_LIBRARIES} INTERFACE ${CMAKE_SOURCE_DIR}/components/hw_l106_lidar/include)
target_include_directories(${scfi_LIBRARIES} INTERFACE ${CMAKE_SOURCE_DIR}/components/hw_l106_lidar/include/public)
target_include_directories(${scfi_LIBRARIES} INTERFACE ${CMAKE_SOURCE_DIR}/components/hw_l106_lidar/include/private)
target_link_libraries(${scfi_LIBRARIES} INTERFACE hw_l106_lidar)
