# ===================================================================================
#  The hw_l106_lidar CMake configuration file
#
...
#
#    find_package(hw_l106_lidar REQUIRED)
#    target_include_directories(MY_TARGET_NAME ${hw_l106_lidar_INCLUDE_DIRS})
#    target_link_libraries(MY_TARGET_NAME ${hw_l106_lidar_LIBRARIES})
#
#    This file will define the following variables:
#      - hw_l106_lidar_LIBRARIES                : The list of all imported targets for hw_l106_lidar modules.
#      - hw_l106_lidar_INCLUDE_DIRS             : The hw_l106_lidar include directories.
#      - hw_l106_lidar_VERSION                  : The version of this hw_l106_lidar build.
#      - hw_l106_lidar_SHARE                    : The configuration files of this hw_l106_lidar.
#
#  The hw_l106_lidar CMake configuration file only was used in SCFI user repo.
# ===================================================================================
...
foreach(dependency MANUALLY_ADDED_DEPENDENCIES-NOTFOUND)
    ...
    message(STATUS "Finding hw_l106_lidar dependency: ${dependency}")
    find_package(${dependency} PATHS ${PACKAGE_PREFIX_DIR}/lib/cmake/${dependency})
endforeach()

foreach(dependency  hw_l106_lidar_scfi_intf;-Wl,--as-needed)
...
foreach(dependency  SCFI_DEP-NOTFOUND)
    ...
    if(NOT ${dependency}_FOUND)
        set(hw_l106_lidar_FOUND False)
        message(WARNING "Finding hw_l106_lidar dependency ${dependency} fail.")
    endif()
endforeach()
...
include("${CMAKE_CURRENT_LIST_DIR}/hw_l106_lidar-targets.cmake")

set(hw_l106_lidar_LIBRARIES hw_l106_lidar)
set(hw_l106_lidar_INCLUDE_DIRS ${PACKAGE_PREFIX_DIR}/include/hw_l106_lidar)
set(hw_l106_lidar_SHARE ${PACKAGE_PREFIX_DIR}/share/hw_l106_lidar)
