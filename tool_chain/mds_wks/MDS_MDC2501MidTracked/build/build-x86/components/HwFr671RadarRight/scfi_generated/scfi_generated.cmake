...
list(APPEND SCFI_DEP hw_fr671_radar)
message(STATUS "Found package dependency hw_fr671_radar")
target_include_directories(${scfi_LIBRARIES} INTERFACE ${CMAKE_SOURCE_DIR}/components/hw_fr671_radar/include)
target_include_directories(${scfi_LIBRARIES} INTERFACE ${CMAKE_SOURCE_DIR}/components/hw_fr671_radar/include/public)
target_include_directories(${scfi_LIBRARIES} INTERFACE ${CMAKE_SOURCE_DIR}/components/hw_fr671_radar/include/private)
target_link_libraries(${scfi_LIBRARIES} INTERFACE hw_fr671_radar)
