...
# 校验组件名称
scfi_check(XDataTriggerRecorder)
...
set(scfi_SOURCES
    ${scfi_SOURCES}
    ${CMAKE_SOURCE_DIR}/generated/src/ara/adsfi/bagstatusserviceinterface_common.cpp
...
list(APPEND SCFI_DEP xdata_trigger_recorder_base)
message(STATUS "Found package dependency xdata_trigger_recorder_base")
target_include_directories(${scfi_LIBRARIES} INTERFACE ${CMAKE_SOURCE_DIR}/components/xdata_trigger_recorder_base/include)
target_include_directories(${scfi_LIBRARIES} INTERFACE ${CMAKE_SOURCE_DIR}/components/xdata_trigger_recorder_base/include/public)
target_include_directories(${scfi_LIBRARIES} INTERFACE ${CMAKE_SOURCE_DIR}/components/xdata_trigger_recorder_base/include/private)
target_link_libraries(${scfi_LIBRARIES} INTERFACE xdata_trigger_recorder_base)
