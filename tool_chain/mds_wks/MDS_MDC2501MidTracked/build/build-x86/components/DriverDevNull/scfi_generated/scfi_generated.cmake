...
set(scfi_SOURCES
    ${scfi_SOURCES}
    ${CMAKE_SOURCE_DIR}/generated/src/ara/adsfi/sensorcompressedimagelistserviceinterface_common.cpp

    ${CMAKE_SOURCE_DIR}/generated/src/ara/adsfi/sensorradarpacketserviceinterface_common.cpp

    ${CMAKE_SOURCE_DIR}/generated/src/ara/adsfi/sensorlidarpacketserviceinterface_common.cpp
)
...
list(APPEND SCFI_DEP driver_dev_null)
message(STATUS "Found package dependency driver_dev_null")
target_include_directories(${scfi_LIBRARIES} INTERFACE ${CMAKE_SOURCE_DIR}/components/driver_dev_null/include)
target_include_directories(${scfi_LIBRARIES} INTERFACE ${CMAKE_SOURCE_DIR}/components/driver_dev_null/include/public)
target_include_directories(${scfi_LIBRARIES} INTERFACE ${CMAKE_SOURCE_DIR}/components/driver_dev_null/include/private)
target_link_libraries(${scfi_LIBRARIES} INTERFACE driver_dev_null)
