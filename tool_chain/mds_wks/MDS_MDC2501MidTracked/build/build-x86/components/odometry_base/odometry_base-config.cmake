# ===================================================================================
#  The odometry_base CMake configuration file
#
...
#
#    find_package(odometry_base REQUIRED)
#    target_include_directories(MY_TARGET_NAME ${odometry_base_INCLUDE_DIRS})
#    target_link_libraries(MY_TARGET_NAME ${odometry_base_LIBRARIES})
#
#    This file will define the following variables:
#      - odometry_base_LIBRARIES                : The list of all imported targets for odometry_base modules.
#      - odometry_base_INCLUDE_DIRS             : The odometry_base include directories.
#      - odometry_base_VERSION                  : The version of this odometry_base build.
#      - odometry_base_SHARE                    : The configuration files of this odometry_base.
#
#  The odometry_base CMake configuration file only was used in SCFI user repo.
# ===================================================================================
...
foreach(dependency MANUALLY_ADDED_DEPENDENCIES-NOTFOUND)
    ...
    message(STATUS "Finding odometry_base dependency: ${dependency}")
    find_package(${dependency} PATHS ${PACKAGE_PREFIX_DIR}/lib/cmake/${dependency})
endforeach()

foreach(dependency  odometry_base_scfi_intf;-Wl,--as-needed)
...
foreach(dependency  SCFI_DEP-NOTFOUND)
    ...
    if(NOT ${dependency}_FOUND)
        set(odometry_base_FOUND False)
        message(WARNING "Finding odometry_base dependency ${dependency} fail.")
    endif()
endforeach()
...
include("${CMAKE_CURRENT_LIST_DIR}/odometry_base-targets.cmake")

set(odometry_base_LIBRARIES odometry_base)
set(odometry_base_INCLUDE_DIRS ${PACKAGE_PREFIX_DIR}/include/odometry_base)
set(odometry_base_SHARE ${PACKAGE_PREFIX_DIR}/share/odometry_base)
