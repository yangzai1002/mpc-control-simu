# ===================================================================================
#  The hw_fr671_radar CMake configuration file
#
...
#
#    find_package(hw_fr671_radar REQUIRED)
#    target_include_directories(MY_TARGET_NAME ${hw_fr671_radar_INCLUDE_DIRS})
#    target_link_libraries(MY_TARGET_NAME ${hw_fr671_radar_LIBRARIES})
#
#    This file will define the following variables:
#      - hw_fr671_radar_LIBRARIES                : The list of all imported targets for hw_fr671_radar modules.
#      - hw_fr671_radar_INCLUDE_DIRS             : The hw_fr671_radar include directories.
#      - hw_fr671_radar_VERSION                  : The version of this hw_fr671_radar build.
#      - hw_fr671_radar_SHARE                    : The configuration files of this hw_fr671_radar.
#
#  The hw_fr671_radar CMake configuration file only was used in SCFI user repo.
# ===================================================================================
...
foreach(dependency MANUALLY_ADDED_DEPENDENCIES-NOTFOUND)
    ...
    message(STATUS "Finding hw_fr671_radar dependency: ${dependency}")
    find_package(${dependency} PATHS ${PACKAGE_PREFIX_DIR}/lib/cmake/${dependency})
endforeach()

foreach(dependency  hw_fr671_radar_scfi_intf;-Wl,--as-needed)
...
foreach(dependency  SCFI_DEP-NOTFOUND)
    ...
    if(NOT ${dependency}_FOUND)
        set(hw_fr671_radar_FOUND False)
        message(WARNING "Finding hw_fr671_radar dependency ${dependency} fail.")
    endif()
endforeach()
...
include("${CMAKE_CURRENT_LIST_DIR}/hw_fr671_radar-targets.cmake")

set(hw_fr671_radar_LIBRARIES hw_fr671_radar)
set(hw_fr671_radar_INCLUDE_DIRS ${PACKAGE_PREFIX_DIR}/include/hw_fr671_radar)
set(hw_fr671_radar_SHARE ${PACKAGE_PREFIX_DIR}/share/hw_fr671_radar)
