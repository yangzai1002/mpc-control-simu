...
set(scfi_SOURCES
    ...
    ${CMAKE_SOURCE_DIR}/generated/src/ara/adsfi/sensorimuserviceinterface_common.cpp

    ${CMAKE_SOURCE_DIR}/generated/src/mdc/location/locationserviceinterface_common.cpp

    ${CMAKE_SOURCE_DIR}/generated/src/ara/adsfi/sensorwheelspeedserviceinterface_common.cpp
)
...
list(APPEND SCFI_DEP fusion_location_base)
message(STATUS "Found package dependency fusion_location_base")
target_include_directories(${scfi_LIBRARIES} INTERFACE ${CMAKE_SOURCE_DIR}/components/fusion_location_base/include)
target_include_directories(${scfi_LIBRARIES} INTERFACE ${CMAKE_SOURCE_DIR}/components/fusion_location_base/include/public)
target_include_directories(${scfi_LIBRARIES} INTERFACE ${CMAKE_SOURCE_DIR}/components/fusion_location_base/include/private)
target_link_libraries(${scfi_LIBRARIES} INTERFACE fusion_location_base)
