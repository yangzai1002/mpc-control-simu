# ===================================================================================
#  The xh265_recorder CMake configuration file
#
...
#
#    find_package(xh265_recorder REQUIRED)
#    target_include_directories(MY_TARGET_NAME ${xh265_recorder_INCLUDE_DIRS})
#    target_link_libraries(MY_TARGET_NAME ${xh265_recorder_LIBRARIES})
#
#    This file will define the following variables:
#      - xh265_recorder_LIBRARIES                : The list of all imported targets for xh265_recorder modules.
#      - xh265_recorder_INCLUDE_DIRS             : The xh265_recorder include directories.
#      - xh265_recorder_VERSION                  : The version of this xh265_recorder build.
#      - xh265_recorder_SHARE                    : The configuration files of this xh265_recorder.
#
#  The xh265_recorder CMake configuration file only was used in SCFI user repo.
# ===================================================================================
...
foreach(dependency MANUALLY_ADDED_DEPENDENCIES-NOTFOUND)
    ...
    message(STATUS "Finding xh265_recorder dependency: ${dependency}")
    find_package(${dependency} PATHS ${PACKAGE_PREFIX_DIR}/lib/cmake/${dependency})
endforeach()

foreach(dependency  xh265_recorder_scfi_intf;-Wl,--as-needed)
...
foreach(dependency  SCFI_DEP-NOTFOUND)
    ...
    if(NOT ${dependency}_FOUND)
        set(xh265_recorder_FOUND False)
        message(WARNING "Finding xh265_recorder dependency ${dependency} fail.")
    endif()
endforeach()
...
include("${CMAKE_CURRENT_LIST_DIR}/xh265_recorder-targets.cmake")

set(xh265_recorder_LIBRARIES xh265_recorder)
set(xh265_recorder_INCLUDE_DIRS ${PACKAGE_PREFIX_DIR}/include/xh265_recorder)
set(xh265_recorder_SHARE ${PACKAGE_PREFIX_DIR}/share/xh265_recorder)
