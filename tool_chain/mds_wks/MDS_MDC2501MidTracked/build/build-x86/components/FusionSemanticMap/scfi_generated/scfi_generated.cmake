...
list(APPEND SCFI_DEP fusion_semantic_map_base)
message(STATUS "Found package dependency fusion_semantic_map_base")
target_include_directories(${scfi_LIBRARIES} INTERFACE ${CMAKE_SOURCE_DIR}/components/fusion_semantic_map_base/include)
target_include_directories(${scfi_LIBRARIES} INTERFACE ${CMAKE_SOURCE_DIR}/components/fusion_semantic_map_base/include/public)
target_include_directories(${scfi_LIBRARIES} INTERFACE ${CMAKE_SOURCE_DIR}/components/fusion_semantic_map_base/include/private)
target_link_libraries(${scfi_LIBRARIES} INTERFACE fusion_semantic_map_base)
