# ===================================================================================
#  The rtspserverswc CMake configuration file
#
...
#
#    find_package(rtspserverswc REQUIRED)
#    target_include_directories(MY_TARGET_NAME ${rtspserverswc_INCLUDE_DIRS})
#    target_link_libraries(MY_TARGET_NAME ${rtspserverswc_LIBRARIES})
#
#    This file will define the following variables:
#      - rtspserverswc_LIBRARIES                : The list of all imported targets for rtspserverswc modules.
#      - rtspserverswc_INCLUDE_DIRS             : The rtspserverswc include directories.
#      - rtspserverswc_VERSION                  : The version of this rtspserverswc build.
#      - rtspserverswc_SHARE                    : The configuration files of this rtspserverswc.
#
#  The rtspserverswc CMake configuration file only was used in SCFI user repo.
# ===================================================================================
...
foreach(dependency MANUALLY_ADDED_DEPENDENCIES-NOTFOUND)
    ...
    message(STATUS "Finding rtspserverswc dependency: ${dependency}")
    find_package(${dependency} PATHS ${PACKAGE_PREFIX_DIR}/lib/cmake/${dependency})
endforeach()

foreach(dependency  rtspserverswc_scfi_intf;-Wl,--as-needed)
...
foreach(dependency  SCFI_DEP-NOTFOUND)
    ...
    if(NOT ${dependency}_FOUND)
        set(rtspserverswc_FOUND False)
        message(WARNING "Finding rtspserverswc dependency ${dependency} fail.")
    endif()
endforeach()
...
include("${CMAKE_CURRENT_LIST_DIR}/rtspserverswc-targets.cmake")

set(rtspserverswc_LIBRARIES rtspserverswc)
set(rtspserverswc_INCLUDE_DIRS ${PACKAGE_PREFIX_DIR}/include/rtspserverswc)
set(rtspserverswc_SHARE ${PACKAGE_PREFIX_DIR}/share/rtspserverswc)
