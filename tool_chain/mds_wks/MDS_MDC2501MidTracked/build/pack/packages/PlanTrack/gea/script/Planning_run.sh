...
parent_path="${current_parent_path}""/runtime_service/Planning/etc/"
completion_txt=""
...
export CM_CONFIG_FILE_PATH=${current_parent_path}/runtime_service/Planning/etc/${var}
# 日志控制台输出开关, 可选
...
arch=$(uname -m)
if [ $arch == "x86_64" ]; then
    ${current_parent_path}/runtime_service/Planning/bin/Planning
else
    pmupload ${current_parent_path}/runtime_service/Planning/bin/Planning --allocGroup=default_dm
fi