...
list(APPEND SCFI_DEP bd21_imu)
message(STATUS "Found package dependency bd21_imu")
target_include_directories(${scfi_LIBRARIES} INTERFACE ${CMAKE_SOURCE_DIR}/components/bd21_imu/include)
target_include_directories(${scfi_LIBRARIES} INTERFACE ${CMAKE_SOURCE_DIR}/components/bd21_imu/include/public)
target_include_directories(${scfi_LIBRARIES} INTERFACE ${CMAKE_SOURCE_DIR}/components/bd21_imu/include/private)
target_link_libraries(${scfi_LIBRARIES} INTERFACE bd21_imu)
