...
# 校验组件名称
scfi_check(MultiCameraDetection)
...
list(APPEND SCFI_DEP multy_camera_det_base)
message(STATUS "Found package dependency multy_camera_det_base")
target_include_directories(${scfi_LIBRARIES} INTERFACE ${CMAKE_SOURCE_DIR}/components/multy_camera_det_base/include)
target_include_directories(${scfi_LIBRARIES} INTERFACE ${CMAKE_SOURCE_DIR}/components/multy_camera_det_base/include/public)
target_include_directories(${scfi_LIBRARIES} INTERFACE ${CMAKE_SOURCE_DIR}/components/multy_camera_det_base/include/private)
target_link_libraries(${scfi_LIBRARIES} INTERFACE multy_camera_det_base)
