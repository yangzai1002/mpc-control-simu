...
list(APPEND SCFI_DEP xh265_recorder)
message(STATUS "Found package dependency xh265_recorder")
target_include_directories(${scfi_LIBRARIES} INTERFACE ${CMAKE_SOURCE_DIR}/components/xh265_recorder/include)
target_include_directories(${scfi_LIBRARIES} INTERFACE ${CMAKE_SOURCE_DIR}/components/xh265_recorder/include/public)
target_include_directories(${scfi_LIBRARIES} INTERFACE ${CMAKE_SOURCE_DIR}/components/xh265_recorder/include/private)
target_link_libraries(${scfi_LIBRARIES} INTERFACE xh265_recorder)
