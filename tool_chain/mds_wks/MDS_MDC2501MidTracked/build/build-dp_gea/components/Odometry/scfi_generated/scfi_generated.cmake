...
list(APPEND SCFI_DEP odometry_base)
message(STATUS "Found package dependency odometry_base")
target_include_directories(${scfi_LIBRARIES} INTERFACE ${CMAKE_SOURCE_DIR}/components/odometry_base/include)
target_include_directories(${scfi_LIBRARIES} INTERFACE ${CMAKE_SOURCE_DIR}/components/odometry_base/include/public)
target_include_directories(${scfi_LIBRARIES} INTERFACE ${CMAKE_SOURCE_DIR}/components/odometry_base/include/private)
target_link_libraries(${scfi_LIBRARIES} INTERFACE odometry_base)
