...
list(APPEND SCFI_DEP sensor_viualize_base)
message(STATUS "Found package dependency sensor_viualize_base")
target_include_directories(${scfi_LIBRARIES} INTERFACE ${CMAKE_SOURCE_DIR}/components/sensor_viualize_base/include)
target_include_directories(${scfi_LIBRARIES} INTERFACE ${CMAKE_SOURCE_DIR}/components/sensor_viualize_base/include/public)
target_include_directories(${scfi_LIBRARIES} INTERFACE ${CMAKE_SOURCE_DIR}/components/sensor_viualize_base/include/private)
target_link_libraries(${scfi_LIBRARIES} INTERFACE sensor_viualize_base)
