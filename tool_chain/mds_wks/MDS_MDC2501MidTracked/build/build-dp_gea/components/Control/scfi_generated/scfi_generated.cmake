...
list(APPEND SCFI_DEP control_base)
message(STATUS "Found package dependency control_base")
target_include_directories(${scfi_LIBRARIES} INTERFACE ${CMAKE_SOURCE_DIR}/components/control_base/include)
target_include_directories(${scfi_LIBRARIES} INTERFACE ${CMAKE_SOURCE_DIR}/components/control_base/include/public)
target_include_directories(${scfi_LIBRARIES} INTERFACE ${CMAKE_SOURCE_DIR}/components/control_base/include/private)
target_link_libraries(${scfi_LIBRARIES} INTERFACE control_base)
