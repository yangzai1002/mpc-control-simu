# ===================================================================================
#  The control_base CMake configuration file
#
...
#
#    find_package(control_base REQUIRED)
#    target_include_directories(MY_TARGET_NAME ${control_base_INCLUDE_DIRS})
#    target_link_libraries(MY_TARGET_NAME ${control_base_LIBRARIES})
#
#    This file will define the following variables:
#      - control_base_LIBRARIES                : The list of all imported targets for control_base modules.
#      - control_base_INCLUDE_DIRS             : The control_base include directories.
#      - control_base_VERSION                  : The version of this control_base build.
#      - control_base_SHARE                    : The configuration files of this control_base.
#
#  The control_base CMake configuration file only was used in SCFI user repo.
# ===================================================================================
...
foreach(dependency MANUALLY_ADDED_DEPENDENCIES-NOTFOUND)
    ...
    message(STATUS "Finding control_base dependency: ${dependency}")
    find_package(${dependency} PATHS ${PACKAGE_PREFIX_DIR}/lib/cmake/${dependency})
endforeach()

foreach(dependency  control_base_scfi_intf;-Wl,--as-needed)
...
foreach(dependency  SCFI_DEP-NOTFOUND)
    ...
    if(NOT ${dependency}_FOUND)
        set(control_base_FOUND False)
        message(WARNING "Finding control_base dependency ${dependency} fail.")
    endif()
endforeach()
...
include("${CMAKE_CURRENT_LIST_DIR}/control_base-targets.cmake")

set(control_base_LIBRARIES control_base)
set(control_base_INCLUDE_DIRS ${PACKAGE_PREFIX_DIR}/include/control_base)
set(control_base_SHARE ${PACKAGE_PREFIX_DIR}/share/control_base)
