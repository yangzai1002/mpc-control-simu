...
list(APPEND SCFI_DEP rtspserverswc)
message(STATUS "Found package dependency rtspserverswc")
target_include_directories(${scfi_LIBRARIES} INTERFACE ${CMAKE_SOURCE_DIR}/components/rtspserverswc/include)
target_include_directories(${scfi_LIBRARIES} INTERFACE ${CMAKE_SOURCE_DIR}/components/rtspserverswc/include/public)
target_include_directories(${scfi_LIBRARIES} INTERFACE ${CMAKE_SOURCE_DIR}/components/rtspserverswc/include/private)
target_link_libraries(${scfi_LIBRARIES} INTERFACE rtspserverswc)
