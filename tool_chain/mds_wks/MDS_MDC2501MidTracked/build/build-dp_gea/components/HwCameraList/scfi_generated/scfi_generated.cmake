...
list(APPEND SCFI_DEP hw_camera_list)
message(STATUS "Found package dependency hw_camera_list")
target_include_directories(${scfi_LIBRARIES} INTERFACE ${CMAKE_SOURCE_DIR}/components/hw_camera_list/include)
target_include_directories(${scfi_LIBRARIES} INTERFACE ${CMAKE_SOURCE_DIR}/components/hw_camera_list/include/public)
target_include_directories(${scfi_LIBRARIES} INTERFACE ${CMAKE_SOURCE_DIR}/components/hw_camera_list/include/private)
target_link_libraries(${scfi_LIBRARIES} INTERFACE hw_camera_list)
