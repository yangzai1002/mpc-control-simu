...
list(APPEND SCFI_DEP lidar_det_base)
message(STATUS "Found package dependency lidar_det_base")
target_include_directories(${scfi_LIBRARIES} INTERFACE ${CMAKE_SOURCE_DIR}/components/lidar_det_base/include)
target_include_directories(${scfi_LIBRARIES} INTERFACE ${CMAKE_SOURCE_DIR}/components/lidar_det_base/include/public)
target_include_directories(${scfi_LIBRARIES} INTERFACE ${CMAKE_SOURCE_DIR}/components/lidar_det_base/include/private)
target_link_libraries(${scfi_LIBRARIES} INTERFACE lidar_det_base)
