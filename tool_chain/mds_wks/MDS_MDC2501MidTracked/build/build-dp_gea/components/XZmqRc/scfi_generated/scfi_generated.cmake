...
list(APPEND SCFI_DEP xzmq_rc)
message(STATUS "Found package dependency xzmq_rc")
target_include_directories(${scfi_LIBRARIES} INTERFACE ${CMAKE_SOURCE_DIR}/components/xzmq_rc/include)
target_include_directories(${scfi_LIBRARIES} INTERFACE ${CMAKE_SOURCE_DIR}/components/xzmq_rc/include/public)
target_include_directories(${scfi_LIBRARIES} INTERFACE ${CMAKE_SOURCE_DIR}/components/xzmq_rc/include/private)
target_link_libraries(${scfi_LIBRARIES} INTERFACE xzmq_rc)
