...
# 校验组件名称
scfi_check(XVehicleStatusRecorder)
...
set(scfi_SOURCES
    ${scfi_SOURCES}
    ${CMAKE_SOURCE_DIR}/generated/src/ara/adsfi/remotecontrolserviceinterface_common.cpp
    ...
    ${CMAKE_SOURCE_DIR}/generated/src/ara/adsfi/sensorgpsserviceinterface_common.cpp
    ...
    ${CMAKE_SOURCE_DIR}/generated/src/ara/adsfi/msgimagedatalistserviceinterface_common.cpp
)
...
list(APPEND SCFI_DEP xvehicle_status_recorder_base)
message(STATUS "Found package dependency xvehicle_status_recorder_base")
target_include_directories(${scfi_LIBRARIES} INTERFACE ${CMAKE_SOURCE_DIR}/components/xvehicle_status_recorder_base/include)
target_include_directories(${scfi_LIBRARIES} INTERFACE ${CMAKE_SOURCE_DIR}/components/xvehicle_status_recorder_base/include/public)
target_include_directories(${scfi_LIBRARIES} INTERFACE ${CMAKE_SOURCE_DIR}/components/xvehicle_status_recorder_base/include/private)
target_link_libraries(${scfi_LIBRARIES} INTERFACE xvehicle_status_recorder_base)
