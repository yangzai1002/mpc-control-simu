...
list(APPEND SCFI_DEP xfault_handler_base)
message(STATUS "Found package dependency xfault_handler_base")
target_include_directories(${scfi_LIBRARIES} INTERFACE ${CMAKE_SOURCE_DIR}/components/xfault_handler_base/include)
target_include_directories(${scfi_LIBRARIES} INTERFACE ${CMAKE_SOURCE_DIR}/components/xfault_handler_base/include/public)
target_include_directories(${scfi_LIBRARIES} INTERFACE ${CMAKE_SOURCE_DIR}/components/xfault_handler_base/include/private)
target_link_libraries(${scfi_LIBRARIES} INTERFACE xfault_handler_base)
