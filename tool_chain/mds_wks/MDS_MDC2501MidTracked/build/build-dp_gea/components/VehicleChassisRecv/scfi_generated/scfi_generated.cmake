...
list(APPEND SCFI_DEP mid_track_chassis_recv)
message(STATUS "Found package dependency mid_track_chassis_recv")
target_include_directories(${scfi_LIBRARIES} INTERFACE ${CMAKE_SOURCE_DIR}/components/mid_track_chassis_recv/include)
target_include_directories(${scfi_LIBRARIES} INTERFACE ${CMAKE_SOURCE_DIR}/components/mid_track_chassis_recv/include/public)
target_include_directories(${scfi_LIBRARIES} INTERFACE ${CMAKE_SOURCE_DIR}/components/mid_track_chassis_recv/include/private)
target_link_libraries(${scfi_LIBRARIES} INTERFACE mid_track_chassis_recv)
