...
list(APPEND SCFI_DEP mid_track_chassis_send)
message(STATUS "Found package dependency mid_track_chassis_send")
target_include_directories(${scfi_LIBRARIES} INTERFACE ${CMAKE_SOURCE_DIR}/components/mid_track_chassis_send/include)
target_include_directories(${scfi_LIBRARIES} INTERFACE ${CMAKE_SOURCE_DIR}/components/mid_track_chassis_send/include/public)
target_include_directories(${scfi_LIBRARIES} INTERFACE ${CMAKE_SOURCE_DIR}/components/mid_track_chassis_send/include/private)
target_link_libraries(${scfi_LIBRARIES} INTERFACE mid_track_chassis_send)
