...
set(scfi_SOURCES
    ${scfi_SOURCES}
    ${CMAKE_SOURCE_DIR}/generated/src/adsfi/fusionobjectarrayintf_common.cpp

    ${CMAKE_SOURCE_DIR}/generated/src/ara/adsfi/sensorlidarpointcloudserviceinterface_common.cpp

    ${CMAKE_SOURCE_DIR}/generated/src/ara/adsfi/radarpointcloudserviceinterface_common.cpp

    ${CMAKE_SOURCE_DIR}/generated/src/adsfi/locationinfointf_common.cpp

    ${CMAKE_SOURCE_DIR}/generated/src/adsfi/object3darrayintf_common.cpp

    ${CMAKE_SOURCE_DIR}/generated/src/ara/adsfi/visionsegmentserviceinterface_common.cpp
)
...
list(APPEND SCFI_DEP fusion_follow_base)
message(STATUS "Found package dependency fusion_follow_base")
target_include_directories(${scfi_LIBRARIES} INTERFACE ${CMAKE_SOURCE_DIR}/components/fusion_follow_base/include)
target_include_directories(${scfi_LIBRARIES} INTERFACE ${CMAKE_SOURCE_DIR}/components/fusion_follow_base/include/public)
target_include_directories(${scfi_LIBRARIES} INTERFACE ${CMAKE_SOURCE_DIR}/components/fusion_follow_base/include/private)
target_link_libraries(${scfi_LIBRARIES} INTERFACE fusion_follow_base)
...
list(APPEND MDC_SDK_DEP ara-exec)

find_package(ara-exec QUIET CMAKE_FIND_ROOT_PATH_BOTH)
if(ara-exec_FOUND)
    message(STATUS "Found package dependency ara-exec: ${ara-exec_DIR}")
    scfi_get_lib(ara-exec_LIBRARIES LIST "${ara-exec_LIBRARIES}")
    include_directories(${ara-exec_INCLUDE_DIRS})
    target_link_libraries(${scfi_LIBRARIES} INTERFACE ${ara-exec_LIBRARIES})
else()
    message(WARNING "Dependency package ara-exec was not found! \nCheck whether the SDK contains the ara-exec package.")
    if(ara-exec_NOT_FOUND_MESSAGE)
        message(FATAL_ERROR "The following imported targets are referenced, but are missing: ${ara-exec_NOT_FOUND_MESSAGE}")
    endif()
endif()
