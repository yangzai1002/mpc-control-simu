...
list(APPEND SCFI_DEP planning_base)
message(STATUS "Found package dependency planning_base")
target_include_directories(${scfi_LIBRARIES} INTERFACE ${CMAKE_SOURCE_DIR}/components/planning_base/include)
target_include_directories(${scfi_LIBRARIES} INTERFACE ${CMAKE_SOURCE_DIR}/components/planning_base/include/public)
target_include_directories(${scfi_LIBRARIES} INTERFACE ${CMAKE_SOURCE_DIR}/components/planning_base/include/private)
target_link_libraries(${scfi_LIBRARIES} INTERFACE planning_base)
