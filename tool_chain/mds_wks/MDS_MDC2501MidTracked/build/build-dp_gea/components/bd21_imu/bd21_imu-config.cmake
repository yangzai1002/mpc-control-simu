# ===================================================================================
#  The bd21_imu CMake configuration file
#
...
#
#    find_package(bd21_imu REQUIRED)
#    target_include_directories(MY_TARGET_NAME ${bd21_imu_INCLUDE_DIRS})
#    target_link_libraries(MY_TARGET_NAME ${bd21_imu_LIBRARIES})
#
#    This file will define the following variables:
#      - bd21_imu_LIBRARIES                : The list of all imported targets for bd21_imu modules.
#      - bd21_imu_INCLUDE_DIRS             : The bd21_imu include directories.
#      - bd21_imu_VERSION                  : The version of this bd21_imu build.
#      - bd21_imu_SHARE                    : The configuration files of this bd21_imu.
#
#  The bd21_imu CMake configuration file only was used in SCFI user repo.
# ===================================================================================
...
foreach(dependency MANUALLY_ADDED_DEPENDENCIES-NOTFOUND)
    ...
    message(STATUS "Finding bd21_imu dependency: ${dependency}")
    find_package(${dependency} PATHS ${PACKAGE_PREFIX_DIR}/lib/cmake/${dependency})
endforeach()

foreach(dependency  bd21_imu_scfi_intf;-Wl,--as-needed)
...
foreach(dependency  SCFI_DEP-NOTFOUND)
    ...
    if(NOT ${dependency}_FOUND)
        set(bd21_imu_FOUND False)
        message(WARNING "Finding bd21_imu dependency ${dependency} fail.")
    endif()
endforeach()
...
include("${CMAKE_CURRENT_LIST_DIR}/bd21_imu-targets.cmake")

set(bd21_imu_LIBRARIES bd21_imu)
set(bd21_imu_INCLUDE_DIRS ${PACKAGE_PREFIX_DIR}/include/bd21_imu)
set(bd21_imu_SHARE ${PACKAGE_PREFIX_DIR}/share/bd21_imu)
