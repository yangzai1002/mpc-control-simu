...
# 校验组件名称
scfi_check(LidarTerrainMapDetection)
...
set(scfi_SOURCES
    ${scfi_SOURCES}
    ${CMAKE_SOURCE_DIR}/generated/src/ara/adsfi/perceptionstaticenvserviceinterface_common.cpp
...
list(APPEND SCFI_DEP lidar_terrain_map_detection)
message(STATUS "Found package dependency lidar_terrain_map_detection")
target_include_directories(${scfi_LIBRARIES} INTERFACE ${CMAKE_SOURCE_DIR}/components/lidar_terrain_map_detection/include)
target_include_directories(${scfi_LIBRARIES} INTERFACE ${CMAKE_SOURCE_DIR}/components/lidar_terrain_map_detection/include/public)
target_include_directories(${scfi_LIBRARIES} INTERFACE ${CMAKE_SOURCE_DIR}/components/lidar_terrain_map_detection/include/private)
target_link_libraries(${scfi_LIBRARIES} INTERFACE lidar_terrain_map_detection)
