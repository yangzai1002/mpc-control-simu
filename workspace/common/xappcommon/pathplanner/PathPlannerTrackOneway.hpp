...
namespace app_common {
    class PathPlannerTrackOneway : public PathPlanner {
    public:
        PathPlannerTrackOneway(const std::string& file_track, const std::string& dest,
        ...
        virtual ~PathPlannerTrackOneway() = default;
