...
namespace app_common {
    class PathPlannerGlobalOnewayTaskPoints : public PathPlanner {
    public:
        PathPlannerGlobalOnewayTaskPoints(const GpxFileHandler&         gpx_file_handler,
                                          const std::vector<TaskPoint>& task_points)
            : PathPlanner(), _dest("z"), _task_points(task_points) {
        ...
        virtual ~PathPlannerGlobalOnewayTaskPoints() = default;
