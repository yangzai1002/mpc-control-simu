...
*
* FileName: geometry_tools.h
*
* Description: fool AVOS geometry_tools API like USB
...
struct GeoPointGCCS {
    ...
    GeoPointGCCS(double _xg, double _yg, double _angle) : xg(_xg), yg(_yg), angle(_angle) {
    }

    GeoPointGCCS(double _xg, double _yg) : GeoPointGCCS(_xg, _yg, 0.0) {
    }

    GeoPointGCCS() : GeoPointGCCS(0.0, 0.0, 0.0) {
    }
};
struct GeoPointVCS {
    double x;
    ...
    GeoPointVCS(double _x, double _y, double _angle) : x(_x), y(_y), angle(_angle) {
    }

    GeoPointVCS(double _x, double _y) : GeoPointVCS(_x, _y, 0.0) {
    }

    GeoPointVCS() : GeoPointVCS(0.0, 0.0, 0.0) {
    }
};
...
struct GeoPointGPS {
    ...
    GeoPointGPS(double _lon, double _lat, double _heading) : lon(_lon), lat(_lat), heading(_heading) {
    }

    GeoPointGPS(double _lon, double _lat) : GeoPointGPS(_lon, _lat, 0.0) {
    }

    GeoPointGPS() : GeoPointGPS(0.0, 0.0, 0.0) {
    }
};
