...
#include "ara/adsfi/impl_type_idpbusinesstaskpoint.h"
...
namespace app_common {
    ...
    public:
        explicit TaskPointController(const std::string& base_dir)
            : filetransmit(base_dir, ".gpx"), kDefaultTaskPointFilePath("default_taskpoints.txt") {
        ...
        void FileGetDefault(const nlohmann::json& req, nlohmann::json& res) {
            ...
            std::filesystem::ifstream is(kDefaultTaskPointFilePath);
        ...
        void Update(const adsf::LocationInfo& location, const nlohmann::json& req, nlohmann::json& res) {
            std::int32_t req_id;
            std::string  req_name;
            bool         req_update;
