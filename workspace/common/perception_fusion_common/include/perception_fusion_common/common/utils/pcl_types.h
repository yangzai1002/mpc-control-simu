...
#ifndef PERCEPTION_PERCEPTION_LIB_PCL_TYPES_H_
#define PERCEPTION_PERCEPTION_LIB_PCL_TYPES_H_
...
POINT_CLOUD_REGISTER_POINT_STRUCT(avos::perception::pcl_util::PointD,
                                  (double, x, x)
                                  (double, y, y)
                                  (double, z, z)
                                  (std::uint8_t, intensity, intensity))

POINT_CLOUD_REGISTER_POINT_STRUCT(avos::perception::pcl_util::PointXYZIH,
                                  (float, x, x)
                                  (float, y, y)
                                  (float, z, z)
...
POINT_CLOUD_REGISTER_POINT_STRUCT(avos::perception::pcl_util::PointXYZIT,
                                  (float, x, x)
                                  (float, y, y)
                                  (float, z, z)
                                  (std::uint8_t, intensity, intensity)
                                  (double, timestamp, timestamp))
POINT_CLOUD_REGISTER_POINT_STRUCT(avos::perception::pcl_util::RawPointXYZIT,
                                  (float, x, x)
                                  (float, y, y)
                                  (float, z, z)
                                  (std::uint8_t, intensity, intensity)
...
POINT_CLOUD_REGISTER_POINT_STRUCT(avos::perception::pcl_util::PointXYZIRT,
                                  (float, x, x)
                                  (float, y, y)
                                  (float, z, z)
                                  (std::uint8_t, intensity, intensity)
...
POINT_CLOUD_REGISTER_POINT_STRUCT(avos::perception::pcl_util::PointXYZIART,
                                  (float, x, x)
                                  (float, y, y)
                                  (float, z, z)
                                  (std::uint8_t, intensity, intensity)
...
POINT_CLOUD_REGISTER_POINT_STRUCT(avos::perception::pcl_util::PointXYZITd,
                                  (double, x, x)
                                  (double, y, y)
                                  (double, z, z)
                                  (std::uint8_t, intensity, intensity)
...
POINT_CLOUD_REGISTER_POINT_STRUCT(avos::perception::pcl_util::PointXYZIRTd,
                                  (double, x, x)
                                  (double, y, y)
                                  (double, z, z)
                                  (std::uint8_t, intensity, intensity)
...
POINT_CLOUD_REGISTER_POINT_STRUCT(avos::perception::pcl_util::PointXYZRGBRCG,
                                  (float, x, x)
                                  (float, y, y)
                                  (float, z, z)
                                  (float, rgb, rgb)
...
#endif  // PERCEPTION_PERCEPTION_LIB_PCL_TYPES_H_
