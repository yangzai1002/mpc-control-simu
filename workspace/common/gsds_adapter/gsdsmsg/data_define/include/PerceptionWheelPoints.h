...
typedef struct PerceptionWheelPoints{
...
void Clear(){
	...
	MSGHANDLE_DEFINE(key_hash_list,obj_id,prob,x,y,offset_x,offset_y);
	MSGHANDLE_PARAKLIST_DEFINE("key_hash_list","obj_id","prob","x","y","offset_x","offset_y");
	MSGHANDLE_PARAVLIST_DEFINE(key_hash_list,obj_id,prob,x,y,offset_x,offset_y);
} PerceptionWheelPoints;
REGISTER(PerceptionWheelPoints,PerceptionWheelPoints_Func);
