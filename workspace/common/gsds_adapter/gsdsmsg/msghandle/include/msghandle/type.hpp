...
#include "adaptor/msghandle_tuple.hpp"
...
#if MSGHANDLE_HAS_INCLUDE(<optional>)
#include "adaptor/cpp17/optional.hpp"
#endif // MSGHANDLE_HAS_INCLUDE(<optional>)

#if MSGHANDLE_HAS_INCLUDE(<string_view>)
#include "adaptor/cpp17/string_view.hpp"
#endif // MSGHANDLE_HAS_INCLUDE(<string_view>)
...
#if MSGHANDLE_HAS_INCLUDE(<variant>)
#include "adaptor/cpp17/variant.hpp"
#endif // MSGHANDLE_HAS_INCLUDE(<variant>)

#if MSGHANDLE_HAS_INCLUDE(<span>)
#include "adaptor/cpp20/span.hpp"
#endif // MSGHANDLE_HAS_INCLUDE(<span>)

#endif // defined(MSGHANDLE_USE_CPP03)

#if !defined(MSGHANDLE_NO_BOOST)
#include "adaptor/boost/fusion.hpp"
#include "adaptor/boost/msghandle_variant.hpp"
