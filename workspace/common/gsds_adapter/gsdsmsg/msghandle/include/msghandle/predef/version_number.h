...
#ifndef MSGHANDLE_PREDEF_VERSION_NUMBER_H
#define MSGHANDLE_PREDEF_VERSION_NUMBER_H

/*`
[heading `MSGHANDLE_VERSION_NUMBER`]

``
MSGHANDLE_VERSION_NUMBER(major,minor,patch)
``
...
*/
#define MSGHANDLE_VERSION_NUMBER(major,minor,patch) \
    ( (((major)%100)*10000000) + (((minor)%100)*100000) + ((patch)%100000) )

#define MSGHANDLE_VERSION_NUMBER_MAX \
    MSGHANDLE_VERSION_NUMBER(99,99,99999)

#define MSGHANDLE_VERSION_NUMBER_ZERO \
    MSGHANDLE_VERSION_NUMBER(0,0,0)

#define MSGHANDLE_VERSION_NUMBER_MIN \
    MSGHANDLE_VERSION_NUMBER(0,0,1)

#define MSGHANDLE_VERSION_NUMBER_AVAILABLE \
    MSGHANDLE_VERSION_NUMBER_MIN

#define MSGHANDLE_VERSION_NUMBER_NOT_AVAILABLE \
    MSGHANDLE_VERSION_NUMBER_ZERO

/*`
``
MSGHANDLE_VERSION_NUMBER_MAJOR(N), MSGHANDLE_VERSION_NUMBER_MINOR(N), MSGHANDLE_VERSION_NUMBER_PATCH(N)
``
...
respectively.
*/
#define MSGHANDLE_VERSION_NUMBER_MAJOR(N) \
    ( ((N)/10000000)%100 )

#define MSGHANDLE_VERSION_NUMBER_MINOR(N) \
    ( ((N)/100000)%100 )

#define MSGHANDLE_VERSION_NUMBER_PATCH(N) \
    ( (N)%100000 )
