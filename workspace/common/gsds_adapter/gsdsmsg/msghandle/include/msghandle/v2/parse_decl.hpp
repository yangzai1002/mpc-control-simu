...
//
#ifndef MSGHANDLE_V2_PARSE_DECL_HPP
#define MSGHANDLE_V2_PARSE_DECL_HPP
...
/// Unpack msghandle formatted data via a visitor
/**
 * @param data The pointer to the buffer.
 * @param len The length of the buffer.
 * @param off The offset position of the buffer. It is read and overwritten.
 * @param v The visitor that satisfies visitor concept. https://github.com/msghandle/msghandle-c/wiki/v2_0_cpp_visitor#visitor-concept
 *
...
#endif // MSGHANDLE_V2_PARSE_DECL_HPP
