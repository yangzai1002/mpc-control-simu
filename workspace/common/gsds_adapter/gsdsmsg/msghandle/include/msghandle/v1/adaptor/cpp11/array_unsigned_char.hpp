...
//
#ifndef MSGHANDLE_V1_TYPE_CPP11_ARRAY_UNSIGNED_CHAR_HPP
#define MSGHANDLE_V1_TYPE_CPP11_ARRAY_UNSIGNED_CHAR_HPP
...
struct convert<std::array<unsigned char, N>> {
    msghandle::object const& operator()(msghandle::object const& o, std::array<unsigned char, N>& v) const {
        switch (o.type) {
...
struct convert<std::array<unsigned char, 0>> {
    msghandle::object const& operator()(msghandle::object const& o, std::array<unsigned char, 0>&) const {
        return o;
    }
};
...
struct pack<std::array<unsigned char, N>> {
    ...
    msghandle::packer<Stream>& operator()(msghandle::packer<Stream>& o, const std::array<unsigned char, N>& v) const {
...
struct object<std::array<unsigned char, N>> {
    void operator()(msghandle::object& o, const std::array<unsigned char, N>& v) const {
        uint32_t size = checked_get_container_size(v.size());
...
struct object_with_zone<std::array<unsigned char, N>> {
    void operator()(msghandle::object::with_zone& o, const std::array<unsigned char, N>& v) const {
        uint32_t size = checked_get_container_size(v.size());
        o.type = msghandle::type::BIN;
...
#endif // MSGHANDLE_V1_TYPE_CPP11_ARRAY_UNSIGNED_CHAR_HPP
