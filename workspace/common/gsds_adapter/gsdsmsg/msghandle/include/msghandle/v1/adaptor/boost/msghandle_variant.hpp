...
//
#ifndef MSGHANDLE_V1_TYPE_BOOST_MSGHANDLE_VARIANT_HPP
#define MSGHANDLE_V1_TYPE_BOOST_MSGHANDLE_VARIANT_HPP
...
#include "msghandle/adaptor/nil.hpp"
#include "msghandle/adaptor/bool.hpp"
#include "msghandle/adaptor/int.hpp"
#include "msghandle/adaptor/float.hpp"
#include "msghandle/adaptor/string.hpp"
#include "msghandle/adaptor/vector_char.hpp"
#include "msghandle/adaptor/raw.hpp"
#include "msghandle/adaptor/ext.hpp"
#include "msghandle/adaptor/vector.hpp"
#include "msghandle/adaptor/map.hpp"
...
struct basic_variant :
    boost::variant<
        ...
        std::vector<char>, // BIN
        msghandle::type::raw_ref, // BIN
        msghandle::type::ext,               // EXT
        msghandle::type::ext_ref,           // EXT
    ...
    bool is_nil() const {
        return boost::get<msghandle::type::nil_t>(this) != MSGHANDLE_NULLPTR;
    }
    bool is_bool() const {
        return boost::get<bool>(this) != MSGHANDLE_NULLPTR;
    }
    bool is_int64_t() const {
        return boost::get<int64_t>(this) != MSGHANDLE_NULLPTR;
    }
    bool is_uint64_t() const {
        return boost::get<uint64_t>(this) != MSGHANDLE_NULLPTR;
    }
    bool is_double() const {
        return boost::get<double>(this) != MSGHANDLE_NULLPTR;
    }
    bool is_string() const {
        return boost::get<std::string>(this) != MSGHANDLE_NULLPTR;
    }
#if (BOOST_VERSION / 100000) >= 1 && ((BOOST_VERSION / 100) % 1000) >= 53
    bool is_boost_string_ref() const {
        return boost::get<boost::string_ref>(this) != MSGHANDLE_NULLPTR;
    }
#endif // (BOOST_VERSION / 100000) >= 1 && ((BOOST_VERSION / 100) % 1000) >= 53
    bool is_vector_char() const {
        return boost::get<std::vector<char> >(this) != MSGHANDLE_NULLPTR;
    }
    bool is_vector_char() {
        return boost::get<std::vector<char> >(this) != MSGHANDLE_NULLPTR;
    }
    bool is_raw_ref() const {
        return boost::get<raw_ref>(this) != MSGHANDLE_NULLPTR;
    }
    bool is_ext() const {
        return boost::get<ext>(this) != MSGHANDLE_NULLPTR;
    }
    bool is_ext_ref() const {
        return boost::get<ext_ref>(this) != MSGHANDLE_NULLPTR;
    }
    bool is_vector() const {
        return boost::get<std::vector<basic_variant<STR, BIN, EXT> > >(this) != MSGHANDLE_NULLPTR;
    }
    bool is_map() const {
        return boost::get<std::map<basic_variant<STR, BIN, EXT>, basic_variant<STR, BIN, EXT> > >(this) != MSGHANDLE_NULLPTR;
    }
    bool is_multimap() const {
        return boost::get<std::multimap<basic_variant<STR, BIN, EXT>, basic_variant<STR, BIN, EXT> > >(this) != MSGHANDLE_NULLPTR;
    }
...
struct as<type::basic_variant<STR, BIN, EXT> > {
    type::basic_variant<STR, BIN, EXT> operator()(msghandle::object const& o) const {
        switch(o.type) {
        case type::NIL:
            return o.as<msghandle::type::nil_t>();
        case type::BOOLEAN:
            return o.as<bool>();
...
struct pack<type::basic_variant<STR, BIN, EXT> > {
    template <typename Stream>
    msghandle::packer<Stream>& operator()(msghandle::packer<Stream>& o, const type::basic_variant<STR, BIN, EXT>& v) const {
...
struct object_imp : boost::static_visitor<void> {
    void operator()(msghandle::type::nil_t const& v) const {
        object<msghandle::type::nil_t>()(o_, v);
    }
    ...
    object_imp(msghandle::object& o):o_(o) {}
    msghandle::object& o_;
};
...
struct object<type::basic_variant<STR, BIN, EXT> > {
    void operator()(msghandle::object& o, const type::basic_variant<STR, BIN, EXT>& v) const {
...
struct object_with_zone_imp : boost::static_visitor<void> {
    ...
    object_with_zone_imp(msghandle::object::with_zone& o):o_(o) {}
    msghandle::object::with_zone& o_;
};
...
struct object_with_zone<type::basic_variant<STR, BIN, EXT> > {
    void operator()(msghandle::object::with_zone& o, const type::basic_variant<STR, BIN, EXT>& v) const {
...
#endif // MSGHANDLE_V1_TYPE_BOOST_MSGHANDLE_VARIANT_HPP
