...
//
#ifndef MSGHANDLE_V1_UNPACK_HPP
#define MSGHANDLE_V1_UNPACK_HPP
...
class unpack_user {
public:
    unpack_user(unpack_reference_func f = MSGHANDLE_NULLPTR,
...
inline void unpack_uint8(uint8_t d, msghandle::object& o)
{ o.type = msghandle::type::POSITIVE_INTEGER; o.via.u64 = d; }

inline void unpack_uint16(uint16_t d, msghandle::object& o)
{ o.type = msghandle::type::POSITIVE_INTEGER; o.via.u64 = d; }

inline void unpack_uint32(uint32_t d, msghandle::object& o)
{ o.type = msghandle::type::POSITIVE_INTEGER; o.via.u64 = d; }

inline void unpack_uint64(uint64_t d, msghandle::object& o)
{ o.type = msghandle::type::POSITIVE_INTEGER; o.via.u64 = d; }

inline void unpack_int8(int8_t d, msghandle::object& o)
{ if(d >= 0) { o.type = msghandle::type::POSITIVE_INTEGER; o.via.u64 = static_cast<uint64_t>(d); }
        else { o.type = msghandle::type::NEGATIVE_INTEGER; o.via.i64 = d; } }

inline void unpack_int16(int16_t d, msghandle::object& o)
{ if(d >= 0) { o.type = msghandle::type::POSITIVE_INTEGER; o.via.u64 = static_cast<uint64_t>(d); }
        else { o.type = msghandle::type::NEGATIVE_INTEGER; o.via.i64 = d; } }

inline void unpack_int32(int32_t d, msghandle::object& o)
{ if(d >= 0) { o.type = msghandle::type::POSITIVE_INTEGER; o.via.u64 = static_cast<uint64_t>(d); }
        else { o.type = msghandle::type::NEGATIVE_INTEGER; o.via.i64 = d; } }

inline void unpack_int64(int64_t d, msghandle::object& o)
{ if(d >= 0) { o.type = msghandle::type::POSITIVE_INTEGER; o.via.u64 = static_cast<uint64_t>(d); }
        else { o.type = msghandle::type::NEGATIVE_INTEGER; o.via.i64 = d; } }

inline void unpack_float(float d, msghandle::object& o)
{ o.type = msghandle::type::FLOAT32; o.via.f64 = d; }

inline void unpack_double(double d, msghandle::object& o)
{ o.type = msghandle::type::FLOAT64; o.via.f64 = d; }

inline void unpack_nil(msghandle::object& o)
{ o.type = msghandle::type::NIL; }

inline void unpack_true(msghandle::object& o)
{ o.type = msghandle::type::BOOLEAN; o.via.boolean = true; }

inline void unpack_false(msghandle::object& o)
{ o.type = msghandle::type::BOOLEAN; o.via.boolean = false; }

struct unpack_array {
    void operator()(unpack_user& u, uint32_t n, msghandle::object& o) const {
        if (n > u.limit().array()) throw msghandle::array_size_overflow("array size overflow");
        o.type = msghandle::type::ARRAY;
        o.via.array.size = 0;

#if SIZE_MAX == UINT_MAX
        if (n > SIZE_MAX/sizeof(msghandle::object))
            throw msghandle::array_size_overflow("array size overflow");
#endif // SIZE_MAX == UINT_MAX

        size_t size = n*sizeof(msghandle::object);
        o.via.array.ptr = static_cast<msghandle::object*>(u.zone().allocate_align(size, MSGHANDLE_ZONE_ALIGNOF(msghandle::object)));
    }
};

inline void unpack_array_item(msghandle::object& c, msghandle::object const& o)
{
#if defined(__GNUC__) && !defined(__clang__)
    std::memcpy(&c.via.array.ptr[c.via.array.size++], &o, sizeof(msghandle::object));
...
struct unpack_map {
    void operator()(unpack_user& u, uint32_t n, msghandle::object& o) const {
        if (n > u.limit().map()) throw msghandle::map_size_overflow("map size overflow");
        o.type = msghandle::type::MAP;
        o.via.map.size = 0;

#if SIZE_MAX == UINT_MAX
        if (n > SIZE_MAX/sizeof(msghandle::object_kv))
            throw msghandle::map_size_overflow("map size overflow");
#endif // SIZE_MAX == UINT_MAX

        size_t size = n*sizeof(msghandle::object_kv);
        o.via.map.ptr = static_cast<msghandle::object_kv*>(u.zone().allocate_align(size, MSGHANDLE_ZONE_ALIGNOF(msghandle::object_kv)));
    }
};

inline void unpack_map_item(msghandle::object& c, msghandle::object const& k, msghandle::object const& v)
{
#if defined(__GNUC__) && !defined(__clang__)
    std::memcpy(&c.via.map.ptr[c.via.map.size].key, &k, sizeof(msghandle::object));
    std::memcpy(&c.via.map.ptr[c.via.map.size].val, &v, sizeof(msghandle::object));
#else  /* __GNUC__ && !__clang__ */
...
inline void unpack_str(unpack_user& u, const char* p, uint32_t l, msghandle::object& o)
{
    ...
    if (u.reference_func() && u.reference_func()(o.type, l, u.user_data())) {
        ...
        if (l > u.limit().str()) throw msghandle::str_size_overflow("str size overflow");
        char* tmp = static_cast<char*>(u.zone().allocate_align(l, MSGHANDLE_ZONE_ALIGNOF(char)));
        std::memcpy(tmp, p, l);
        o.via.str.ptr = tmp;
    }
    else {
        o.via.str.ptr = MSGHANDLE_NULLPTR;
    }
    o.via.str.size = l;
}

inline void unpack_bin(unpack_user& u, const char* p, uint32_t l, msghandle::object& o)
{
    ...
    if (u.reference_func() && u.reference_func()(o.type, l, u.user_data())) {
        ...
        if (l > u.limit().bin()) throw msghandle::bin_size_overflow("bin size overflow");
        char* tmp = static_cast<char*>(u.zone().allocate_align(l, MSGHANDLE_ZONE_ALIGNOF(char)));
        std::memcpy(tmp, p, l);
        o.via.bin.ptr = tmp;
    }
    else {
        o.via.bin.ptr = MSGHANDLE_NULLPTR;
    }
    o.via.bin.size = l;
}

inline void unpack_ext(unpack_user& u, const char* p, std::size_t l, msghandle::object& o)
{
    ...
    if (u.reference_func() && u.reference_func()(o.type, l, u.user_data())) {
        ...
        if (l > u.limit().ext()) throw msghandle::ext_size_overflow("ext size overflow");
        char* tmp = static_cast<char*>(u.zone().allocate_align(l, MSGHANDLE_ZONE_ALIGNOF(char)));
        std::memcpy(tmp, p, l);
        o.via.ext.ptr = tmp;
    }
...
class unpack_stack {
public:
    msghandle::object const& obj() const { return m_obj; }
    msghandle::object& obj() { return m_obj; }
    void set_obj(msghandle::object const& obj) { m_obj = obj; }
    ...
    msghandle::object const& map_key() const { return m_map_key; }
    void set_map_key(msghandle::object const& map_key) { m_map_key = map_key; }
private:
    msghandle::object m_obj;
    std::size_t m_count;
    uint32_t m_container_type;
    msghandle::object m_map_key;
};

inline void init_count(void* buffer)
{
#if defined(MSGHANDLE_USE_CPP03)
    *reinterpret_cast<volatile _msghandle_atomic_counter_t*>(buffer) = 1;
...
{
#if defined(MSGHANDLE_USE_CPP03)
    if(_msghandle_sync_decr_and_fetch(reinterpret_cast<volatile _msghandle_atomic_counter_t*>(buffer)) == 0) {
        free(buffer);
    }
#else  // defined(MSGHANDLE_USE_CPP03)
...
{
#if defined(MSGHANDLE_USE_CPP03)
    _msghandle_sync_incr_and_fetch(reinterpret_cast<volatile _msghandle_atomic_counter_t*>(buffer));
#else  // defined(MSGHANDLE_USE_CPP03)
...
#if defined(MSGHANDLE_USE_CPP03)
inline _msghandle_atomic_counter_t get_count(void* buffer)
{
    return *reinterpret_cast<volatile _msghandle_atomic_counter_t*>(buffer);
}
#else  // defined(MSGHANDLE_USE_CPP03)
...
template <typename T>
inline typename msghandle::enable_if<sizeof(T) == sizeof(fix_tag)>::type load(uint32_t& dst, const char* n) {
    dst = static_cast<uint32_t>(*reinterpret_cast<const uint8_t*>(n)) & 0x0f;
}

template <typename T>
inline typename msghandle::enable_if<sizeof(T) == 1>::type load(T& dst, const char* n) {
    dst = static_cast<T>(*reinterpret_cast<const uint8_t*>(n));
}

template <typename T>
inline typename msghandle::enable_if<sizeof(T) == 2>::type load(T& dst, const char* n) {
    _msghandle_load16(T, n, &dst);
}

template <typename T>
inline typename msghandle::enable_if<sizeof(T) == 4>::type load(T& dst, const char* n) {
    _msghandle_load32(T, n, &dst);
}

template <typename T>
inline typename msghandle::enable_if<sizeof(T) == 8>::type load(T& dst, const char* n) {
    _msghandle_load64(T, n, &dst);
}

class context {
public:
    context(unpack_reference_func f, void* user_data, unpack_limit const& limit)
        :m_trail(0), m_user(f, user_data, limit), m_cs(MSGHANDLE_CS_HEADER)
    {
    ...
    void init()
    {
        m_cs = MSGHANDLE_CS_HEADER;
        m_trail = 0;
        m_stack.resize(1);
        m_stack[0].set_obj(msghandle::object());
    }
...
private:
    ...
    int push_aggregate(
        ...
        if(tmp == 0) {
            ...
            if (m_stack.size() <= m_user.limit().depth()) {
                ...
                throw msghandle::depth_size_overflow("depth size overflow");
            }
            m_cs = MSGHANDLE_CS_HEADER;
            ++m_current;
        }
    ...
    int push_item(msghandle::object& obj) {
        bool finish = false;
        while (!finish) {
            if(m_stack.size() == 1) {
                return 1;
            ...
            case MSGHANDLE_CT_ARRAY_ITEM:
                ...
                break;
            case MSGHANDLE_CT_MAP_KEY:
                sp.set_map_key(obj);
                sp.set_container_type(MSGHANDLE_CT_MAP_VALUE);
                finish = true;
                break;
            case MSGHANDLE_CT_MAP_VALUE:
                ...
                if(sp.decr_count() == 0) {
                    ...
                    sp.set_container_type(MSGHANDLE_CT_MAP_KEY);
                    finish = true;
                }
                break;
            default:
    ...
    int push_proc(msghandle::object& obj, std::size_t& off) {
...
inline void context::check_ext_size<4>(std::size_t size) {
    if (size == 0xffffffff) throw msghandle::ext_size_overflow("ext size overflow");
}

inline int context::execute(const char* data, std::size_t len, std::size_t& off)
{
    MSGHANDLE_ASSERT(len >= off);

    m_start = data;
    m_current = data + off;
    const char* const pe = data + len;
    const char* n = MSGHANDLE_NULLPTR;
        ...
        if (m_cs == MSGHANDLE_CS_HEADER) {
            ...
            if (0x00 <= selector && selector <= 0x7f) { // Positive Fixnum
                ...
                if(m_trail == 0) {
                    ...
                    m_cs = MSGHANDLE_ACS_STR_VALUE;
                    fixed_trail_again = true;
                }

            } else if(0x90 <= selector && selector <= 0x9f) { // FixArray
                int ret = push_aggregate<fix_tag>(
                    unpack_array(), MSGHANDLE_CT_ARRAY_ITEM, obj, m_current, off);
                if (ret != 0) return ret;
            } else if(0x80 <= selector && selector <= 0x8f) { // FixMap
                int ret = push_aggregate<fix_tag>(
                    unpack_map(), MSGHANDLE_CT_MAP_KEY, obj, m_current, off);
                if (ret != 0) return ret;
            ...
            // end MSGHANDLE_CS_HEADER
        }
        if (m_cs != MSGHANDLE_CS_HEADER || fixed_trail_again) {
            ...
            case MSGHANDLE_CS_DOUBLE: {
                union { uint64_t i; double f; } mem;
                load<uint64_t>(mem.i, n);
#if defined(TARGET_OS_IPHONE)
                // ok
#elif defined(__arm__) && !(__ARM_EABI__) // arm-oabi
                // https://github.com/msghandle/msghandle-perl/pull/1
            ...
            case MSGHANDLE_CS_FIXEXT_1: {
                unpack_ext(m_user, n, 1+1, obj);
                int ret = push_proc(obj, off);
                if (ret != 0) return ret;
            } break;
            case MSGHANDLE_CS_FIXEXT_2: {
                unpack_ext(m_user, n, 2+1, obj);
                int ret = push_proc(obj, off);
                if (ret != 0) return ret;
            } break;
            case MSGHANDLE_CS_FIXEXT_4: {
                unpack_ext(m_user, n, 4+1, obj);
                int ret = push_proc(obj, off);
                if (ret != 0) return ret;
            } break;
            case MSGHANDLE_CS_FIXEXT_8: {
                unpack_ext(m_user, n, 8+1, obj);
                int ret = push_proc(obj, off);
                if (ret != 0) return ret;
            } break;
            case MSGHANDLE_CS_FIXEXT_16: {
                unpack_ext(m_user, n, 16+1, obj);
                int ret = push_proc(obj, off);
                if (ret != 0) return ret;
            } break;
            case MSGHANDLE_CS_STR_8: {
                uint8_t tmp;
                load<uint8_t>(tmp, n);
                m_trail = tmp;
                if(m_trail == 0) {
            ...
            case MSGHANDLE_CS_BIN_8: {
                ...
                if(m_trail == 0) {
                    ...
                    m_cs = MSGHANDLE_ACS_BIN_VALUE;
                    fixed_trail_again = true;
                }
            } break;
            case MSGHANDLE_CS_EXT_8: {
                uint8_t tmp;
                load<uint8_t>(tmp, n);
                m_trail = tmp + 1;
                if(m_trail == 0) {
                    ...
                    m_cs = MSGHANDLE_ACS_EXT_VALUE;
                    fixed_trail_again = true;
                }
            } break;
            case MSGHANDLE_CS_STR_16: {
                uint16_t tmp;
                load<uint16_t>(tmp, n);
                m_trail = tmp;
                if(m_trail == 0) {
            ...
            case MSGHANDLE_ACS_STR_VALUE: {
                unpack_str(m_user, n, static_cast<uint32_t>(m_trail), obj);
                int ret = push_proc(obj, off);
                if (ret != 0) return ret;
            } break;
            case MSGHANDLE_ACS_BIN_VALUE: {
                unpack_bin(m_user, n, static_cast<uint32_t>(m_trail), obj);
                int ret = push_proc(obj, off);
                if (ret != 0) return ret;
            } break;
            case MSGHANDLE_ACS_EXT_VALUE: {
                unpack_ext(m_user, n, m_trail, obj);
                int ret = push_proc(obj, off);
                if (ret != 0) return ret;
            } break;
            case MSGHANDLE_CS_ARRAY_16: {
                int ret = push_aggregate<uint16_t>(
                    unpack_array(), MSGHANDLE_CT_ARRAY_ITEM, obj, n, off);
                if (ret != 0) return ret;
            } break;
            case MSGHANDLE_CS_ARRAY_32: {
                /* FIXME security guard */
                int ret = push_aggregate<uint32_t>(
                    unpack_array(), MSGHANDLE_CT_ARRAY_ITEM, obj, n, off);
                if (ret != 0) return ret;
            } break;
            case MSGHANDLE_CS_MAP_16: {
                int ret = push_aggregate<uint16_t>(
                    unpack_map(), MSGHANDLE_CT_MAP_KEY, obj, n, off);
                if (ret != 0) return ret;
            } break;
            case MSGHANDLE_CS_MAP_32: {
                /* FIXME security guard */
                int ret = push_aggregate<uint32_t>(
                    unpack_map(), MSGHANDLE_CT_MAP_KEY, obj, n, off);
                if (ret != 0) return ret;
...
public:
     ...
     */
    void reserve_buffer(std::size_t size = MSGHANDLE_UNPACKER_RESERVE_SIZE);
    ...
    /// Notify a buffer consumed information to msghandle::unpacker.
    /**
    ...
    /// Unpack one msghandle::object. [obsolete]
    /**
     *
...
inline unpacker::unpacker(unpack_reference_func f,
    ...
    :m_z(new msghandle::zone), m_ctx(f, user_data, limit)
{
    if(initial_buffer_size < YF_COUNTER_SIZE) {
        initial_buffer_size = YF_COUNTER_SIZE;
    }
    ...
    m_buffer = buffer;
    m_used = YF_COUNTER_SIZE;
    m_free = initial_buffer_size - m_used;
    m_off = YF_COUNTER_SIZE;
    m_parsed = 0;
...
inline unpacker::unpacker(unpacker&& other)
    :m_buffer(other.m_buffer),
     ...
     m_ctx(other.m_ctx) {
    other.m_buffer = MSGHANDLE_NULLPTR;
}
...
inline void unpacker::expand_buffer(std::size_t size)
{
    ...
    if(m_off == YF_COUNTER_SIZE) {
        std::size_t next_size = (m_used + m_free) * 2;    // include YF_COUNTER_SIZE
        ...
        std::size_t next_size = m_initial_buffer_size;  // include YF_COUNTER_SIZE
        std::size_t not_parsed = m_used - m_off;
        while(next_size < size + not_parsed + YF_COUNTER_SIZE) {
            std::size_t tmp_next_size = next_size * 2;
            if (tmp_next_size <= next_size) {
                next_size = size + not_parsed + YF_COUNTER_SIZE;
                break;
            }
            next_size = tmp_next_size;
        }
        ...
        std::memcpy(tmp+YF_COUNTER_SIZE, m_buffer + m_off, not_parsed);
        ...
        m_buffer = tmp;
        m_used  = not_parsed + YF_COUNTER_SIZE;
        m_free  = next_size - m_used;
        m_off   = YF_COUNTER_SIZE;
    }
}
...
inline msghandle::object const& unpacker::data()
{
    return m_ctx.data();
}
...
inline bool unpacker::default_reference_func(msghandle::type::object_type /*type*/, std::size_t /*len*/, void*)
{
    return true;
}
