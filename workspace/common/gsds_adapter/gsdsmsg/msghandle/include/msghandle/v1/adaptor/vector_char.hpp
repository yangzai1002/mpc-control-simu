...
//
#ifndef MSGHANDLE_V1_TYPE_VECTOR_CHAR_HPP
#define MSGHANDLE_V1_TYPE_VECTOR_CHAR_HPP
...
struct convert<std::vector<char, Alloc> > {
    msghandle::object const& operator()(msghandle::object const& o, std::vector<char, Alloc>& v) const {
        switch (o.type) {
...
struct pack<std::vector<char, Alloc> > {
    ...
    msghandle::packer<Stream>& operator()(msghandle::packer<Stream>& o, const std::vector<char, Alloc>& v,SMsgHandleInfo& msghandle_info) const {
...
struct object<std::vector<char, Alloc> > {
    void operator()(msghandle::object& o, const std::vector<char, Alloc>& v) const {
        uint32_t size = checked_get_container_size(v.size());
...
struct object_with_zone<std::vector<char, Alloc> > {
    void operator()(msghandle::object::with_zone& o, const std::vector<char, Alloc>& v) const {
        uint32_t size = checked_get_container_size(v.size());
        o.type = msghandle::type::BIN;
        o.via.bin.size = size;
        if (size != 0) {
...
#endif // MSGHANDLE_V1_TYPE_VECTOR_CHAR_HPP
