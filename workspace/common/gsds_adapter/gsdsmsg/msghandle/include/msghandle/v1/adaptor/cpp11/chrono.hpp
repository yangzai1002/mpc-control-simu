...
#ifndef MSGHANDLE_V1_TYPE_CPP11_CHRONO_HPP
#define MSGHANDLE_V1_TYPE_CPP11_CHRONO_HPP
...
struct as<std::chrono::time_point<Clock, Duration>> {
    typename std::chrono::time_point<Clock, Duration> operator()(msghandle::object const& o) const {
...
struct convert<std::chrono::time_point<Clock, Duration>> {
    msghandle::object const& operator()(msghandle::object const& o, std::chrono::time_point<Clock, Duration>& v) const {
        if(o.type != msghandle::type::EXT) { throw msghandle::type_error(); }
        if(o.via.ext.type() != -1) { throw msghandle::type_error(); }
        std::chrono::time_point<Clock, Duration> tp;
        switch(o.via.ext.size) {
...
struct pack<std::chrono::time_point<Clock, Duration>> {
    ...
    msghandle::packer<Stream>& operator()(msghandle::packer<Stream>& o, std::chrono::time_point<Clock, Duration> const& v) const {
        ...
        if ((sec >> 34) == 0) {
            ...
            _msghandle_store32(&buf[0], detail::integral_cast<uint32_t>(nanosec));
            _msghandle_store64(&buf[4], sec);
...
struct object_with_zone<std::chrono::time_point<Clock, Duration>> {
    void operator()(msghandle::object::with_zone& o, const std::chrono::time_point<Clock, Duration>& v) const {
        int64_t count = detail::integral_cast<int64_t>(v.time_since_epoch().count());
        ...
        if ((sec >> 34) == 0) {
            ...
            char* p = static_cast<char*>(o.zone.allocate_no_align(o.via.ext.size + 1));
            p[0] = static_cast<char>(-1);
            _msghandle_store32(&p[1], detail::integral_cast<uint32_t>(nanosec));
            _msghandle_store64(&p[1 + 4], sec);
            o.via.ext.ptr = p;
        }
    }
};
...
#endif // MSGHANDLE_V1_TYPE_CPP11_CHRONO_HPP
