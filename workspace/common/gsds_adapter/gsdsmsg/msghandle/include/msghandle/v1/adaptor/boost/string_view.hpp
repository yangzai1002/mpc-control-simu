...
//
#ifndef MSGHANDLE_V1_TYPE_BOOST_STRING_VIEW_HPP
#define MSGHANDLE_V1_TYPE_BOOST_STRING_VIEW_HPP
...
struct convert<boost::string_view> {
    msghandle::object const& operator()(msghandle::object const& o, boost::string_view& v) const {
        switch (o.type) {
...
struct pack<boost::string_view> {
    ...
    msghandle::packer<Stream>& operator()(msghandle::packer<Stream>& o, const boost::string_view& v) const {
...
struct object<boost::string_view> {
    void operator()(msghandle::object& o, const boost::string_view& v) const {
        uint32_t size = checked_get_container_size(v.size());
...
struct object_with_zone<boost::string_view> {
    void operator()(msghandle::object::with_zone& o, const boost::string_view& v) const {
...
#endif // MSGHANDLE_V1_TYPE_BOOST_STRING_VIEW_HPP
