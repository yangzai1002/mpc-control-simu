...
//
#ifndef MSGHANDLE_V1_SBUFFER_HPP
#define MSGHANDLE_V1_SBUFFER_HPP

#include "msghandle/v1/cpp_config_decl.hpp"
#include "msghandle/v1/sbuffer_decl.hpp"
...
class sbuffer {
public:
    sbuffer(size_t initsz = MSGHANDLE_SBUFFER_INIT_SIZE):m_size(0), m_alloc(initsz)
    {
        if(initsz == 0) {
            m_data = MSGHANDLE_NULLPTR;
        } else {
        ...
        m_size(other.m_size), m_data(other.m_data), m_alloc(other.m_alloc)
    {
        ...
        other.m_data = MSGHANDLE_NULLPTR;
    }
...
private:
    void expand_buffer(size_t len)
    {
        size_t nsize = (m_alloc > 0) ?
                m_alloc * 2 : MSGHANDLE_SBUFFER_INIT_SIZE;
...
#endif // MSGHANDLE_V1_SBUFFER_HPP
