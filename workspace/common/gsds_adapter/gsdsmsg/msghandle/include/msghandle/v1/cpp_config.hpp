...
//
#ifndef MSGHANDLE_V1_CPP_CONFIG_HPP
#define MSGHANDLE_V1_CPP_CONFIG_HPP

#include "msghandle/cpp_config_decl.hpp"
...
template<class T>
struct remove_cv {
    typedef typename msghandle::remove_volatile<
        typename msghandle::remove_const<T>::type
    >::type type;
};
...
#if MSGHANDLE_CPP_VERSION >= 201402L
#if defined(_MSC_VER)
#define MSGHANDLE_DEPRECATED(msg) __declspec(deprecated(msg))
#else
#define MSGHANDLE_DEPRECATED(msg) [[deprecated(msg)]]
#endif
#else  // MSGHANDLE_CPP_VERSION >= 201402L
#define MSGHANDLE_DEPRECATED(msg)
#endif // MSGHANDLE_CPP_VERSION >= 201402L

#endif // MSGHANDLE_V1_CPP_CONFIG_HPP
