        ...
        public:
            static std::shared_ptr<CUserMdc610FuncInterface> Instance() {
                ...
                if (!instance) {
                    ...
                    std::cout<<"xxxxxxxxxxxxx2\n";

                    std::call_once(flag, [&] { instance.reset(new (std::nothrow) CUserMdc610FuncInterface()); });
                }
                std::cout<<"xxxxxxxxxxxxx\n";
            ...
            // imgprocess
            void idpInitUserParam(avos::idpware::SImgProcess& img_usr_param, int width, int height,
                                  avos::idpware::EIdpImgBufType buftype) {
