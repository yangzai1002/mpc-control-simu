...
public:
    ...
    bool GetData(std::vector<ObjectInfo>& detections, timeval& time);
...
private:
	...
	std::unique_ptr<BYTETracker> byte_tracker_person_;

    // ThreadSafeQueue<ara::adsfi::Object2dArray> cam_tracks_cache;
    mdc::visual::Publisher trackResultPub {};
	std::string node_name;

    timeval camera_timestamp;
