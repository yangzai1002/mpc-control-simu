...
namespace byte_kalman
{
	...
	KAL_DATA KalmanFilter::initiate(const DETECTBOX &measurement)
	{
		...
		std(0) = 2 * _std_weight_position * measurement[2];
		std(1) = 2 * _std_weight_position * measurement[3];
		std(2) = 2 * _std_weight_position * measurement[2];
		std(3) = 2 * _std_weight_position * measurement[3];
		std(4) = 10 * _std_weight_velocity * measurement[2];
		std(5) = 10 * _std_weight_velocity * measurement[3];
	...
	KAL_HDATA KalmanFilter::project(const KAL_MEAN &mean, const KAL_COVA &covariance)
	{
		...
		std << _std_weight_position * mean(2), _std_weight_position * mean(3), 
				_std_weight_position * mean(2), _std_weight_position * mean(3);
