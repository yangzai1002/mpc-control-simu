...
public:
	...
	// void SendVehicleMsg() ;
	// void SendRadarConfigMsg(int phase_lock) ;
	// void UpdateVehicleInfo(const VehicleInformation &vehicle_info, float reduce_ratio=16.5, float wheel_base_length=2.9);
