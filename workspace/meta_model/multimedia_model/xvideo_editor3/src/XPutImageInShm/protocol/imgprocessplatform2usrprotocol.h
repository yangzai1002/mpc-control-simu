...
namespace avos {
    namespace idpware {
        ...
        typedef struct SVpcCropRegion {
            u_int32_t top_offset = 0;
            u_int32_t left_offset = 0;
            u_int32_t crop_width = 0;
            u_int32_t crop_height = 0;
        ...
        typedef struct SVpcResizeInfo {
            u_int32_t resize_width = 0;
            u_int32_t resize_height = 0;
            u_int32_t interpolation = 0;
            SVpcResizeInfo() {
            }
        } SVpcResizeInfo;
        ...
        struct SImgProcessInfo {
            void *            m_buf = nullptr;
            size_t            m_buf_len = 0;
            EIdpImgBufType    m_buf_memtype = BUF_DVPP_TYPE;
            EIdpMdc610ImgType m_buf_imgtype = IMG_FORMAT_YUV_SEMIPLANAR_420;
            u_int32_t         m_img_width = 0;
            u_int32_t         m_img_height = 0;
        ...
        typedef struct SVpcCropResizePasteRegion {
            ...
            u_int32_t       dest_top_offset = 0;
            u_int32_t       dest_left_offset = 0;
        ...
        struct SImgProcess {
            ...
            SImgProcess() : m_process_name{}, m_process_name_len(0) {
            }
