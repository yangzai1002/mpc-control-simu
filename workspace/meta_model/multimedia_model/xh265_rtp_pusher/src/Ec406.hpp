...
static const constexpr char* _ERRORCODE_CONFIG = "4062001";          // 配置参数读取失败
static const constexpr char* _ERRORCODE_NO_DATA = "4062002";         // 无数据输入
static const constexpr char* _ERRORCODE_FREQ = "4062003";            // 数据频率异常
static const constexpr char* _ERRORCODE_FORMAT = "4062004";          // 数据格式错误
static const constexpr char* _ERRORCODE_SEND = "4062005";            // 数据发送失败
static const constexpr char* _ERRORCODE_SRTP_INIT = "4062006";       // SRTP初始化失败
static const constexpr char* _ERRORCODE_ADDRESS_RESOLVE = "4062007"; // 地址解析失败
static const constexpr char* _ERRORCODE_ADDRESS_BIND = "4062008";    // 地址绑定失败
