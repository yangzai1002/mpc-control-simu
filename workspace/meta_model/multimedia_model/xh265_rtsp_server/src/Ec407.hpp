...
#define _ERRORCODE_CONFIG "4072001"          // 配置参数读取失败
#define _ERRORCODE_NO_DATA "4072002"         // 无数据输入
#define _ERRORCODE_FREQ "4072003"            // 数据频率异常
#define _ERRORCODE_FORMAT "4072004"          // 数据格式错误
#define _ERRORCODE_SEND "4072005"            // 数据发送失败
#define _ERRORCODE_SRTP_INIT "4072006"       // SRTP初始化失败
#define _ERRORCODE_ADDRESS_RESOLVE "4072007" // 地址解析失败
#define _ERRORCODE_ADDRESS_BIND "4072008"    // 地址绑定失败
